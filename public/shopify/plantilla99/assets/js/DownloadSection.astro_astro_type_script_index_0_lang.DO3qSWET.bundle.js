...
(() => {
  ...
  var ge = function(e20) {
    ...
    for (r4 = e20.length; r4--; ) e20[r4] && (e20[r4]._gsap || (e20[r4]._gsap = new en(e20[r4], n3))) || e20.splice(r4, 1);
    return e20;
  };
  var _e = function(e20) {
  ...
  var ye = function(e20, t4) {
    var n3 = t4.charAt(0), r4 = parseFloat(t4.substr(2));
    return e20 = parseFloat(e20), n3 === `+` ? e20 + r4 : n3 === `-` ? e20 - r4 : n3 === `*` ? e20 * r4 : e20 / r4;
  };
  var be = function(e20, t4) {
    for (var n3 = t4.length, r4 = 0; e20.indexOf(t4[r4]) < 0 && ++r4 < n3; ) ;
    return r4 < n3;
  };
  var xe = function() {
    var e20 = le.length, t4 = le.slice(0), n3, r4;
    for (ue = {}, le.length = 0, n3 = 0; n3 < e20; n3++) r4 = t4[n3], r4 && r4._lazy && (r4.render(r4._lazy[0], r4._lazy[1], true)._lazy = 0);
  };
  var Se = function(e20) {
    return !!(e20._initted || e20._startAt || e20.add);
  };
  var Ce = function(e20, t4, n3, r4) {
    le.length && !a && xe(), e20.render(t4, n3, r4 || !!(a && t4 < 0 && Se(e20))), le.length && !a && xe();
  };
  var we = function(e20) {
  ...
  var De = function(e20) {
    return function(t4, n3) {
      for (var r4 in n3) r4 in t4 || r4 === `duration` && e20 || r4 === `ease` || (t4[r4] = n3[r4]);
    };
  };
  ...
  var ke = function e2(t4, n3) {
    for (var r4 in n3) r4 !== `__proto__` && r4 !== `constructor` && r4 !== `prototype` && (t4[r4] = y(n3[r4]) ? e2(t4[r4] || (t4[r4] = {}), n3[r4]) : n3[r4]);
    return t4;
  };
  var Ae = function(e20, t4) {
    var n3 = {}, r4;
    for (r4 in e20) r4 in t4 || (n3[r4] = e20[r4]);
    return n3;
  };
  var je = function(e20) {
  ...
  var Me = function(e20, t4) {
    for (var n3 = e20.length, r4 = n3 === t4.length; r4 && n3-- && e20[n3] === t4[n3]; ) ;
    return n3 < 0;
  };
  var Ne = function(e20, t4, n3, r4, i3) {
    n3 === void 0 && (n3 = `_first`), r4 === void 0 && (r4 = `_last`);
    var a3 = e20[r4], o3;
    if (i3) for (o3 = t4[i3]; a3 && a3[i3] > o3; ) a3 = a3._prev;
    return a3 ? (t4._next = a3._next, a3._next = t4) : (t4._next = e20[n3], e20[n3] = t4), t4._next ? t4._next._prev = t4 : e20[r4] = t4, t4._prev = a3, t4.parent = t4._dp = e20, t4;
  };
  var Pe = function(e20, t4, n3, r4) {
    n3 === void 0 && (n3 = `_first`), r4 === void 0 && (r4 = `_last`);
    var i3 = t4._prev, a3 = t4._next;
    i3 ? i3._next = a3 : e20[n3] === t4 && (e20[n3] = a3), a3 ? a3._prev = i3 : e20[r4] === t4 && (e20[r4] = i3), t4._next = t4._prev = t4.parent = null;
  };
  ...
  var Ke = function(e20, t4, n3, r4) {
    return t4.parent && Fe(t4), t4._start = W((_(n3) ? n3 : n3 || e20 !== P ? nt(e20, n3, t4) : e20._time) + t4._delay), t4._end = W(t4._start + (t4.totalDuration() / Math.abs(t4.timeScale()) || 0)), Ne(e20, t4, `_first`, `_last`, e20._sort ? `_start` : 0), Xe(t4) || (e20._recent = t4), r4 || Ge(e20, t4), e20._ts < 0 && We(e20, e20._tTime), e20;
  };
  var qe = function(e20, t4) {
    return (R.ScrollTrigger || te(`scrollTrigger`, t4)) && R.ScrollTrigger.create(t4, e20);
  };
  var Je = function(e20, t4, n3, r4, i3) {
    if (ln(e20, t4, i3), !e20._initted) return 1;
    if (!n3 && e20._pt && !a && (e20._dur && e20.vars.lazy !== false || !e20._dur && e20.vars.lazy) && de !== Vt.frame) return le.push(e20), e20._lazy = [i3, r4], 1;
  };
  ...
  var Ze = function(e20, t4, n3, r4) {
    ...
    if (s3 && e20._repeat && (l3 = at(0, e20._tDur, t4), d3 = Ve(l3, s3), e20._yoyo && d3 & 1 && (o3 = 1 - o3), d3 !== Ve(e20._tTime, s3) && (i3 = 1 - o3, e20.vars.repeatRefresh && e20._initted && e20.invalidate())), o3 !== i3 || a || r4 || e20._zTime === c || !t4 && e20._zTime) {
      if (!e20._initted && Je(e20, t4, r4, n3, l3)) return;
  ...
  var Qe = function(e20, t4, n3) {
    var r4;
    if (n3 > t4) for (r4 = e20._first; r4 && r4._start <= n3; ) {
      if (r4.data === `isPause` && r4._start > t4) return r4;
      r4 = r4._next;
    }
    else for (r4 = e20._last; r4 && r4._start >= n3; ) {
      if (r4.data === `isPause` && r4._start < t4) return r4;
      r4 = r4._prev;
    }
  };
  var $e = function(e20, t4, n3, r4) {
    var i3 = e20._repeat, a3 = W(t4) || 0, o3 = e20._tTime / e20._tDur;
    return o3 && !r4 && (e20._time *= a3 / e20._dur), e20._dur = a3, e20._tDur = i3 ? i3 < 0 ? 1e10 : W(a3 * (i3 + 1) + e20._rDelay * i3) : a3, o3 > 0 && !r4 && We(e20, e20._tTime = e20._tDur * o3), e20.parent && Ue(e20), n3 || Ie(e20.parent, e20), e20;
  };
  var et = function(e20) {
    return e20 instanceof J ? Ie(e20) : $e(e20, e20._dur);
  };
  var tt = { _start: 0, endTime: ie, totalDuration: ie };
  var nt = function e5(t4, n3, r4) {
    var i3 = t4.labels, a3 = t4._recent || tt, o3 = t4.duration() >= s ? a3.endTime(false) : t4._dur, c3, l3, u3;
    return h(n3) && (isNaN(n3) || n3 in i3) ? (l3 = n3.charAt(0), u3 = n3.substr(-1) === `%`, c3 = n3.indexOf(`=`), l3 === `<` || l3 === `>` ? (c3 >= 0 && (n3 = n3.replace(/=/, ``)), (l3 === `<` ? a3._start : a3.endTime(a3._repeat >= 0)) + (parseFloat(n3.substr(1)) || 0) * (u3 ? (c3 < 0 ? a3 : r4).totalDuration() / 100 : 1)) : c3 < 0 ? (n3 in i3 || (i3[n3] = o3), i3[n3]) : (l3 = parseFloat(n3.charAt(c3 - 1) + n3.substr(c3 + 1)), u3 && r4 && (l3 = l3 / 100 * (w(r4) ? r4[0] : r4).totalDuration()), c3 > 1 ? e5(t4, n3.substr(0, c3 - 1), r4) + l3 : o3 + l3)) : n3 == null ? o3 : +n3;
  };
  var rt = function(e20, t4, n3) {
    var r4 = _(t4[1]), i3 = (r4 ? 2 : 1) + (e20 < 2 ? 0 : 1), a3 = t4[i3], o3, s3;
    if (r4 && (a3.duration = t4[1]), a3.parent = n3, e20) {
  ...
  var lt = function(e20, t4, n3) {
    return n3 === void 0 && (n3 = []), e20.forEach(function(e21) {
      var r4;
      return h(e21) && !t4 || ct(e21, 1) ? (r4 = n3).push.apply(r4, ut(e21)) : n3.push(e21);
    }) || n3;
  };
  ...
  var pt = function(e20) {
    if (g(e20)) return e20;
    var t4 = y(e20) ? e20 : { each: e20 }, n3 = Yt(t4.ease), r4 = t4.from || 0, i3 = parseFloat(t4.base) || 0, a3 = {}, o3 = r4 > 0 && r4 < 1, c3 = isNaN(r4) || o3, l3 = t4.axis, u3 = r4, d3 = r4;
    return h(r4) ? u3 = d3 = { center: 0.5, edges: 0.5, end: 1 }[r4] || 0 : !o3 && c3 && (u3 = r4[0], d3 = r4[1]), function(e21, o4, p3) {
      ...
      if (!h3) {
        ...
        for (h3 = a3[m3] = [], g3 = c3 ? Math.min(w3, m3) * u3 - 0.5 : r4 % w3, _3 = w3 === s ? 0 : c3 ? m3 * d3 / w3 - 0.5 : r4 / w3 | 0, S3 = 0, C3 = s, x3 = 0; x3 < m3; x3++) v3 = x3 % w3 - g3, y3 = _3 - (x3 / w3 | 0), h3[x3] = b3 = l3 ? Math.abs(l3 === `y` ? y3 : v3) : f(v3 * v3 + y3 * y3), b3 > S3 && (S3 = b3), b3 < C3 && (C3 = b3);
        r4 === `random` && ft(h3), h3.max = S3 - C3, h3.min = C3, h3.v = m3 = (parseFloat(t4.amount) || parseFloat(t4.each) * (w3 > m3 ? m3 - 1 : l3 ? l3 === `y` ? m3 / w3 : w3 : Math.max(w3, m3 / w3)) || 0) * (r4 === `edges` ? -1 : 1), h3.b = m3 < 0 ? i3 - m3 : i3, h3.u = G(t4.amount || t4.each) || 0, n3 = n3 && m3 < 0 ? Jt(n3) : n3;
      }
  ...
  var mt = function(e20) {
    ...
    return function(n3) {
      var r4 = W(Math.round(parseFloat(n3) / e20) * e20 * t4);
      return (r4 - r4 % 1) / t4 + (_(n3) ? 0 : G(n3));
    };
  };
  var ht = function(e20, t4) {
    var n3 = w(e20), r4, i3;
    return !n3 && y(e20) && (r4 = n3 = e20.radius || s, e20.values ? (e20 = ut(e20.values), (i3 = !_(e20[0])) && (r4 *= r4)) : e20 = mt(e20.increment)), it(t4, n3 ? g(e20) ? function(t5) {
      return i3 = e20(t5), Math.abs(i3 - t5) <= r4 ? i3 : t5;
    } : function(t5) {
      ...
      return c3 = !r4 || o3 <= r4 ? e20[c3] : t5, i3 || c3 === t5 || _(t5) ? c3 : c3 + G(t5);
    } : mt(e20));
  };
  var gt = function(e20, t4, n3, r4) {
    return it(w(e20) ? !t4 : n3 === true ? !!(n3 = 0) : !r4, function() {
      return w(e20) ? e20[~~(Math.random() * e20.length)] : (n3 || (n3 = 1e-5)) && (r4 = n3 < 1 ? 10 ** ((n3 + ``).length - 2) : 1) && Math.floor(Math.round((e20 - n3 / 2 + Math.random() * (t4 - e20 + n3 * 0.99)) / n3) * n3 * r4) / r4;
    });
  };
  var _t = function() {
    var e20 = [...arguments];
  ...
  var xt = function e6(t4, n3, r4) {
    var i3 = n3 - t4;
    return w(t4) ? bt(t4, e6(0, t4.length), n3) : it(r4, function(e20) {
      return (i3 + (e20 - t4) % i3) % i3 + t4;
    });
  };
  var St = function e7(t4, n3, r4) {
    var i3 = n3 - t4, a3 = i3 * 2;
    return w(t4) ? bt(t4, e7(0, t4.length - 1), n3) : it(r4, function(e20) {
  ...
  var Et = function(e20, t4, n3) {
    var r4 = e20.labels, i3 = s, a3, o3, c3;
    for (a3 in r4) o3 = r4[a3] - t4, o3 < 0 == !!n3 && o3 && i3 > (o3 = Math.abs(o3)) && (c3 = a3, i3 = o3);
    return c3;
  };
  var Dt = function(e20, t4, n3) {
    var r4 = e20.vars, i3 = r4[t4], a3 = o, s3 = e20._ctx, c3, l3, u3;
    if (i3) return c3 = r4[t4 + `Params`], l3 = r4.callbackScope || e20, n3 && le.length && xe(), s3 && (o = s3), u3 = c3 ? i3.apply(l3, c3) : i3.call(l3), o = a3, u3;
  };
  var Ot = function(e20) {
  ...
  var jt = function(e20) {
    if (e20) if (e20 = !e20.name && e20.default || e20, x() || e20.headless) {
      var t4 = e20.name, n3 = g(e20), r4 = t4 && !n3 && e20.init ? function() {
        this._props = [];
      } : e20, i3 = { init: ie, render: wn, add: rn, kill: En, modifier: Tn, rawVars: 0 }, a3 = { targetTest: 0, get: 0, getSetter: bn, aliases: {}, register: 0 };
      if (Ht(), e20 !== r4) {
        if (V[t4]) return;
        Ee(r4, Ee(Ae(e20, i3), a3)), Oe(r4.prototype, Oe(i3, Ae(e20, a3))), V[r4.prop = t4] = r4, e20.targetTest && (me.push(r4), ce[t4] = 1), t4 = (t4 === `css` ? `CSS` : t4.charAt(0).toUpperCase() + t4.substr(1)) + `Plugin`;
      }
  ...
  var Pt = function(e20, t4, n3) {
    var r4 = e20 ? _(e20) ? [e20 >> 16, e20 >> 8 & K, e20 & K] : 0 : Mt.black, i3, a3, o3, s3, c3, l3, u3, d3, f3, p3;
    if (!r4) {
      if (e20.substr(-1) === `,` && (e20 = e20.substr(0, e20.length - 1)), Mt[e20]) r4 = Mt[e20];
      else if (e20.charAt(0) === `#`) {
        if (e20.length < 6 && (i3 = e20.charAt(1), a3 = e20.charAt(2), o3 = e20.charAt(3), e20 = `#` + i3 + i3 + a3 + a3 + o3 + o3 + (e20.length === 5 ? e20.charAt(4) + e20.charAt(4) : ``)), e20.length === 9) return r4 = parseInt(e20.substr(1, 6), 16), [r4 >> 16, r4 >> 8 & K, r4 & K, parseInt(e20.substr(7), 16) / 255];
        e20 = parseInt(e20.substr(1), 16), r4 = [e20 >> 16, e20 >> 8 & K, e20 & K];
      } else if (e20.substr(0, 3) === `hsl`) {
        if (r4 = p3 = e20.match(D), !t4) s3 = r4[0] % 360 / 360, c3 = r4[1] / 100, l3 = r4[2] / 100, a3 = l3 <= 0.5 ? l3 * (c3 + 1) : l3 + c3 - l3 * c3, i3 = l3 * 2 - a3, r4.length > 3 && (r4[3] *= 1), r4[0] = Nt(s3 + 1 / 3, i3, a3), r4[1] = Nt(s3, i3, a3), r4[2] = Nt(s3 - 1 / 3, i3, a3);
        else if (~e20.indexOf(`=`)) return r4 = e20.match(O), n3 && r4.length < 4 && (r4[3] = 1), r4;
      } else r4 = e20.match(D) || Mt.transparent;
      r4 = r4.map(Number);
    }
    return t4 && !p3 && (i3 = r4[0] / K, a3 = r4[1] / K, o3 = r4[2] / K, u3 = Math.max(i3, a3, o3), d3 = Math.min(i3, a3, o3), l3 = (u3 + d3) / 2, u3 === d3 ? s3 = c3 = 0 : (f3 = u3 - d3, c3 = l3 > 0.5 ? f3 / (2 - u3 - d3) : f3 / (u3 + d3), s3 = u3 === i3 ? (a3 - o3) / f3 + (a3 < o3 ? 6 : 0) : u3 === a3 ? (o3 - i3) / f3 + 2 : (i3 - a3) / f3 + 4, s3 *= 60), r4[0] = ~~(s3 + 0.5), r4[1] = ~~(c3 * 100 + 0.5), r4[2] = ~~(l3 * 100 + 0.5)), n3 && r4.length < 4 && (r4[3] = 1), r4;
  };
  var Ft = function(e20) {
    var t4 = [], n3 = [], r4 = -1;
    return e20.split(Lt).forEach(function(e21) {
      var i3 = e21.match(k) || [];
      t4.push.apply(t4, i3), n3.push(r4 += i3.length + 1);
    }), t4.c = n3, t4;
  };
  var It = function(e20, t4, n3) {
    var r4 = ``, i3 = (e20 + r4).match(Lt), a3 = t4 ? `hsla(` : `rgba(`, o3 = 0, s3, c3, l3, u3;
    if (!i3) return e20;
    if (i3 = i3.map(function(e21) {
      return (e21 = Pt(e21, t4, 1)) && a3 + (t4 ? e21[0] + `,` + e21[1] + `%,` + e21[2] + `%,` + e21[3] : e21.join(`,`)) + `)`;
    }), n3 && (l3 = Ft(e20), s3 = n3.c, s3.join(r4) !== l3.c.join(r4))) for (c3 = e20.replace(Lt, `1`).split(k), u3 = c3.length - 1; o3 < u3; o3++) r4 += c3[o3] + (~s3.indexOf(o3) ? i3.shift() || a3 + `0,0,0,0)` : (l3.length ? l3 : i3.length ? i3 : n3).shift());
    if (!c3) for (c3 = e20.split(Lt), u3 = c3.length - 1; o3 < u3; o3++) r4 += c3[o3] + i3[o3];
    return r4 + c3[u3];
  };
  var Lt = (function() {
  ...
  var Bt;
  var Vt = (function() {
    var e20 = Date.now, t4 = 500, n3 = 33, r4 = e20(), i3 = r4, a3 = 1e3 / 240, o3 = a3, s3 = [], c3, l3, u3, d3, f3, p3, m3 = function u4(m4) {
      var h3 = e20() - i3, g3 = m4 === true, _3, v3, y3, b3;
      if ((h3 > t4 || h3 < 0) && (r4 += h3 - n3), i3 += h3, y3 = i3 - r4, _3 = y3 - o3, (_3 > 0 || g3) && (b3 = ++d3.frame, f3 = y3 - d3.time * 1e3, d3.time = y3 /= 1e3, o3 += _3 + (_3 >= a3 ? 4 : a3 - _3), v3 = 1), g3 || (c3 = l3(u4)), v3) for (p3 = 0; p3 < s3.length; p3++) s3[p3](y3, f3, b3, m4);
    };
    return d3 = { time: 0, frame: 0, tick: function() {
      ...
      t4 = e21 || 1 / 0, n3 = Math.min(r5 || 33, t4);
    }, fps: function(e21) {
      a3 = 1e3 / (e21 || 240), o3 = d3.time * 1e3 + a3;
    }, add: function(e21, t5, n4) {
      var r5 = t5 ? function(t6, n5, i4, a4) {
        e21(t6, n5, i4, a4), d3.remove(r5);
      } : e21;
      return d3.remove(e21), s3[n4 ? `unshift` : `push`](r5), Ht(), r5;
  ...
  var Wt = /["']/g;
  var Gt = function(e20) {
    for (var t4 = {}, n3 = e20.substr(1, e20.length - 3).split(`:`), r4 = n3[0], i3 = 1, a3 = n3.length, o3, s3, c3; i3 < a3; i3++) s3 = n3[i3], o3 = i3 === a3 - 1 ? s3.length : s3.lastIndexOf(`,`), c3 = s3.substr(0, o3), t4[r4] = isNaN(c3) ? c3.replace(Wt, ``).trim() : +c3, r4 = s3.substr(o3 + 1).trim();
    return t4;
  };
  var Kt = function(e20) {
    var t4 = e20.indexOf(`(`) + 1, n3 = e20.indexOf(`)`), r4 = e20.indexOf(`(`, t4);
    return e20.substring(t4, ~r4 && r4 < n3 ? e20.indexOf(`)`, n3 + 1) : n3);
  };
  var qt = function(e20) {
  ...
  var Qt = function e9(t4, n3, r4) {
    var i3 = n3 >= 1 ? n3 : 1, a3 = (r4 || (t4 ? 0.3 : 0.45)) / (n3 < 1 ? n3 : 1), o3 = a3 / l * (Math.asin(1 / i3) || 0), s3 = function(e20) {
      return e20 === 1 ? 1 : i3 * 2 ** (-10 * e20) * m((e20 - o3) * a3) + 1;
    }, c3 = t4 === `out` ? s3 : t4 === `in` ? function(e20) {
      return 1 - s3(1 - e20);
    } : Zt(s3);
    return a3 = l / a3, c3.config = function(n4, r5) {
      return e9(t4, n4, r5);
    }, c3;
  };
  var $t = function e10(t4, n3) {
    ...
    }, i3 = t4 === `out` ? r4 : t4 === `in` ? function(e20) {
      return 1 - r4(1 - e20);
    } : Zt(r4);
  ...
  H(`Linear,Quad,Cubic,Quart,Quint,Strong`, function(e20, t4) {
    ...
    var n3 = 1 / t4, r4 = 2 * n3, i3 = 2.5 * n3, a3 = function(a4) {
      return a4 < n3 ? e20 * a4 * a4 : a4 < r4 ? e20 * (a4 - 1.5 / t4) ** 2 + 0.75 : a4 < i3 ? e20 * (a4 -= 2.25 / t4) * a4 + 0.9375 : e20 * (a4 - 2.625 / t4) ** 2 + 0.984375;
    };
    ...
    e20 === void 0 && (e20 = 1);
    var n3 = 1 / e20, r4 = e20 + +!t4, i3 = +!!t4, a3 = 1 - c;
    return function(e21) {
      return ((r4 * at(0, a3, e21) | 0) + i3) * n3;
    };
  ...
  var tn = (function() {
    ...
    return t4.delay = function(e21) {
      ...
      var r4 = this.vars;
      return arguments.length > 1 ? (t5 ? (r4[e21] = t5, n3 && (r4[e21 + `Params`] = n3), e21 === `onUpdate` && (this._onUpdate = t5)) : delete r4[e21], this) : r4[e21];
    }, t4.then = function(e21) {
      var t5 = this, n3 = t5._prom;
      return new Promise(function(r4) {
        var i3 = g(e21) ? e21 : Te, a3 = function() {
          var e22 = t5.then;
          t5.then = null, n3 && n3(), g(i3) && (i3 = i3(t5)) && (i3.then || i3 === t5) && (t5.then = e22), r4(i3), t5.then = e22;
        };
  ...
  var J = (function(r4) {
    ...
    function i3(t4, n3) {
      var i4;
      return t4 === void 0 && (t4 = {}), i4 = r4.call(this, t4) || this, i4.labels = {}, i4.smoothChildTiming = !!t4.smoothChildTiming, i4.autoRemoveChildren = !!t4.autoRemoveChildren, i4._sort = b(t4.sortChildren), P && Ke(t4.parent || P, e(i4), n3), t4.reversed && i4.reverse(), t4.paused && i4.paused(true), t4.scrollTrigger && qe(e(i4), t4.scrollTrigger), i4;
    }
    var o3 = i3.prototype;
    return o3.to = function(e20, t4, n3) {
    ...
    }, o3.fromTo = function(e20, t4, n3, r5) {
    ...
    }, o3.staggerTo = function(e20, t4, n3, r5, i4, a3, o4) {
      return n3.duration = t4, n3.stagger = n3.stagger || r5, n3.onComplete = a3, n3.onCompleteParams = o4, n3.parent = this, new Y(e20, n3, nt(this, i4)), this;
    }, o3.staggerFrom = function(e20, t4, n3, r5, i4, a3, o4) {
      return n3.runBackwards = 1, je(n3).immediateRender = b(n3.immediateRender), this.staggerTo(e20, t4, n3, r5, i4, a3, o4);
    }, o3.staggerFromTo = function(e20, t4, n3, r5, i4, a3, o4, s3) {
      return r5.startAt = n3, je(r5).immediateRender = b(r5.immediateRender), this.staggerTo(e20, t4, r5, i4, a3, o4, s3);
    }, o3.render = function(e20, t4, n3) {
      var r5 = this._time, i4 = this._dirty ? this.totalDuration() : this._tDur, o4 = this._dur, s3 = e20 <= 0 ? 0 : W(e20), l3 = this._zTime < 0 != e20 < 0 && (this._initted || !o4), u3, d3, f3, p3, m3, h3, g3, _3, v3, y3, b3, x3;
      if (this !== P && s3 > i4 && e20 >= 0 && (s3 = i4), s3 !== this._tTime || n3 || l3) {
        if (r5 !== this._time && o4 && (s3 += this._time - r5, e20 += this._time - r5), u3 = s3, v3 = this._start, _3 = this._ts, h3 = !_3, l3 && (o4 || (r5 = this._zTime), (e20 || !t4) && (this._zTime = e20)), this._repeat) {
        ...
        if (this._hasPause && !this._forcing && this._lock < 2 && (g3 = Qe(this, W(r5), W(u3)), g3 && (s3 -= u3 - (u3 = g3._start))), this._tTime = s3, this._time = u3, this._act = !!_3, this._initted || (this._onUpdate = this.vars.onUpdate, this._initted = 1, this._zTime = e20, r5 = 0), !r5 && s3 && o4 && !t4 && !y3 && (Dt(this, `onStart`), this._tTime !== s3)) return this;
        if (u3 >= r5 && e20 >= 0) for (d3 = this._first; d3; ) {
        ...
        if (g3 && !t4 && (this.pause(), g3.render(u3 >= r5 ? 0 : -c)._zTime = u3 >= r5 ? 1 : -1, this._ts)) return this._start = v3, Ue(this), this.render(e20, t4, n3);
        this._onUpdate && !t4 && Dt(this, `onUpdate`, true), (s3 === i4 && this._tTime >= this.totalDuration() || !s3 && r5) && (v3 === this._start || Math.abs(_3) !== Math.abs(this._ts)) && (this._lock || ((e20 || !o4) && (s3 === i4 && this._ts > 0 || !s3 && this._ts < 0) && Fe(this, 1), !t4 && !(e20 < 0 && !r5) && (s3 || r5 || !i4) && (Dt(this, s3 === i4 && e20 >= 0 ? `onComplete` : `onReverseComplete`, true), this._prom && !(s3 < i4 && this.timeScale() > 0) && this._prom())));
      }
      return this;
    ...
    }, o3.getChildren = function(e20, t4, n3, r5) {
      e20 === void 0 && (e20 = true), t4 === void 0 && (t4 = true), n3 === void 0 && (n3 = true), r5 === void 0 && (r5 = -s);
      for (var i4 = [], a3 = this._first; a3; ) a3._start >= r5 && (a3 instanceof Y ? t4 && i4.push(a3) : (n3 && i4.push(a3), e20 && i4.push.apply(i4, a3.getChildren(true, t4, n3)))), a3 = a3._next;
      return i4;
      ...
      var r5 = Y.delayedCall(0, t4 || ie, n3);
      ...
      for (var r5 = this.getTweensOf(e20, n3), i4 = r5.length; i4--; ) sn !== r5[i4] && r5[i4].kill(e20, t4);
      return this;
    }, o3.getTweensOf = function(e20, t4) {
      for (var n3 = [], r5 = ut(e20), i4 = this._first, a3 = _(t4), o4; i4; ) i4 instanceof Y ? be(i4._targets, r5) && (a3 ? (!sn || i4._initted && i4._ts) && i4.globalTime(0) <= t4 && i4.globalTime(i4.totalDuration()) > t4 : !t4 || i4.isActive()) && n3.push(i4) : (o4 = i4.getTweensOf(r5, t4)).length && n3.push.apply(n3, o4), i4 = i4._next;
      return n3;
    }, o3.tweenTo = function(e20, t4) {
      t4 || (t4 = {});
      var n3 = this, r5 = nt(n3, e20), i4 = t4, a3 = i4.startAt, o4 = i4.onStart, s3 = i4.onStartParams, l3 = i4.immediateRender, u3, d3 = Y.to(n3, Ee({ ease: t4.ease || `none`, lazy: false, immediateRender: false, time: r5, overwrite: `auto`, duration: t4.duration || Math.abs((r5 - (a3 && `time` in a3 ? a3.time : n3._time)) / n3.timeScale()) || c, onStart: function() {
        if (n3.pause(), !u3) {
          var e21 = t4.duration || Math.abs((r5 - (a3 && `time` in a3 ? a3.time : n3._time)) / n3.timeScale());
      ...
      n3 === void 0 && (n3 = 0);
      var r5 = this._first, i4 = this.labels, a3;
      for (e20 = W(e20); r5; ) r5._start >= n3 && (r5._start += e20, r5._end += e20), r5 = r5._next;
      ...
      var t4 = 0, n3 = this, r5 = n3._last, i4 = s, a3, o4, c3;
      if (arguments.length) return n3.timeScale((n3._repeat < 0 ? n3.duration() : n3.totalDuration()) / (n3.reversed() ? -e20 : e20));
      if (n3._dirty) {
        for (c3 = n3.parent; r5; ) a3 = r5._prev, r5._dirty && r5.totalDuration(), o4 = r5._start, o4 > i4 && n3._sort && r5._ts && !n3._lock ? (n3._lock = 1, Ke(n3, r5, o4 - r5._delay, 1)._lock = 0) : i4 = o4, o4 < 0 && r5._ts && (t4 -= o4, (!c3 && !n3._dp || c3 && c3.smoothChildTiming) && (n3._start += W(o4 / n3._ts), n3._time -= o4, n3._tTime -= o4), n3.shiftChildren(-o4, false, -1 / 0), i4 = 0), r5._end > t4 && r5._ts && (t4 = r5._end), r5 = a3;
  ...
  var nn = function(e20, t4, n3, r4, i3, a3, o3) {
    var s3 = new X(this._pt, e20, t4, 0, 1, Cn, null, i3), c3 = 0, l3 = 0, u3, d3, f3, p3, m3, h3, g3, _3;
    for (s3.b = n3, s3.e = r4, n3 += ``, r4 += ``, (g3 = ~r4.indexOf(`random(`)) && (r4 = Ct(r4)), a3 && (_3 = [n3, r4], a3(_3, e20, t4), n3 = _3[0], r4 = _3[1]), d3 = n3.match(A) || []; u3 = A.exec(r4); ) p3 = u3[0], m3 = r4.substring(c3, u3.index), f3 ? f3 = (f3 + 1) % 5 : m3.substr(-5) === `rgba(` && (f3 = 1), p3 !== d3[l3++] && (h3 = parseFloat(d3[l3 - 1]) || 0, s3._pt = { _next: s3._pt, p: m3 || l3 === 1 ? m3 : `,`, s: h3, c: p3.charAt(1) === `=` ? ye(h3, p3) - h3 : parseFloat(p3) - h3, m: f3 && f3 < 4 ? Math.round : 0 }, c3 = A.lastIndex);
    return s3.c = c3 < r4.length ? r4.substring(c3, r4.length) : ``, s3.fp = o3, (j.test(r4) || g3) && (s3.e = 0), this._pt = s3, s3;
  };
  var rn = function(e20, t4, r4, i3, a3, o3, s3, c3, l3, u3) {
    g(i3) && (i3 = i3(a3 || 0, e20, o3));
    var d3 = e20[t4], f3 = r4 === `get` ? g(d3) ? l3 ? e20[t4.indexOf(`set`) || !g(e20[`get` + t4.substr(3)]) ? t4 : `get` + t4.substr(3)](l3) : e20[t4]() : d3 : r4, p3 = g(d3) ? l3 ? vn : _n : gn, m3;
  ...
  var an = function(e20, t4, n3, r4, i3) {
    if (g(e20) && (e20 = pn(e20, i3, t4, n3, r4)), !y(e20) || e20.style && e20.nodeType || w(e20) || C(e20)) return h(e20) ? pn(e20, i3, t4, n3, r4) : e20;
    var a3 = {}, o3;
    for (o3 in e20) a3[o3] = pn(e20[o3], i3, t4, n3, r4);
    return a3;
  };
  var on = function(e20, t4, n3, r4, i3, a3) {
    var o3, s3, c3, l3;
    if (V[e20] && (o3 = new V[e20]()).init(i3, o3.rawVars ? t4[e20] : an(t4[e20], r4, i3, a3, n3), n3, r4, a3) !== false && (n3._pt = s3 = new X(n3._pt, i3, e20, 0, 1, o3.render, o3, 0, o3.priority), n3 !== kt)) for (c3 = n3._ptLookup[n3._targets.indexOf(i3)], l3 = o3._props.length; l3--; ) c3[o3._props[l3]] = s3;
    return o3;
  };
  var sn;
  var cn;
  ...
  var un = function(e20, t4, n3, r4, i3, a3, o3, s3) {
    ...
    for (f3 = c3.length; f3--; ) u3 = c3[f3], l3 = u3._pt || u3, l3.s = (r4 || r4 === 0) && !i3 ? r4 : l3.s + (r4 || 0) + a3 * l3.c, l3.c = n3 - l3.s, u3.e && (u3.e = U(n3) + G(u3.e)), u3.b && (u3.b = l3.s + G(u3.b));
  };
  var dn = function(e20, t4) {
    var n3 = e20[0] ? _e(e20[0]).harness : 0, r4 = n3 && n3.aliases, i3, a3, o3, s3;
    if (!r4) return t4;
    for (a3 in i3 = Oe({}, t4), r4) if (a3 in i3) for (s3 = r4[a3].split(`,`), o3 = s3.length; o3--; ) i3[s3[o3]] = i3[a3];
    return i3;
  };
  var fn = function(e20, t4, n3, r4) {
    var i3 = t4.ease || r4 || `power1.inOut`, a3, o3;
  ...
  var pn = function(e20, t4, n3, r4, i3) {
    return g(e20) ? e20.call(t4, n3, r4, i3) : h(e20) && ~e20.indexOf(`random(`) ? Ct(e20) : e20;
  };
  ...
  var Y = (function(r4) {
    ...
    function o3(t4, a3, o4, s4) {
      var l3;
      typeof a3 == `number` && (o4.duration = a3, a3 = o4, o4 = null), l3 = r4.call(this, s4 ? a3 : je(a3)) || this;
    ...
    return s3.render = function(e20, t4, n3) {
      var r5 = this._time, i3 = this._tDur, a3 = this._dur, o4 = e20 < 0, s4 = e20 > i3 - c && !o4 ? i3 : e20 < c ? 0 : e20, l3, u3, d3, f3, p3, m3, h3, g3;
      if (!a3) Ze(this, e20, t4, n3);
        ...
        if (l3 = s4, g3 = this.timeline, this._repeat) {
          ...
          if (l3 = W(s4 % f3), s4 === i3 ? (d3 = this._repeat, l3 = a3) : (p3 = W(s4 / f3), d3 = ~~p3, d3 && d3 === p3 ? (l3 = a3, d3--) : l3 > a3 && (l3 = a3)), m3 = this._yoyo && d3 & 1, m3 && (l3 = a3 - l3), p3 = Ve(this._tTime, f3), l3 === r5 && !n3 && this._initted && d3 === p3) return this._tTime = s4, this;
        ...
        if (!this._initted) {
          ...
          if (r5 !== this._time && !(n3 && this.vars.repeatRefresh && d3 !== p3)) return this;
    ...
    }, s3.resetTo = function(e20, t4, n3, r5, i3) {
      Bt || Vt.wake(), this._ts || this.play();
      var a3 = Math.min(this._dur, (this._dp._time - this._start) * this._ts), o4;
      return this._initted || ln(this, a3), o4 = this._ease(a3 / this._dur), un(this, e20, t4, n3, r5, o4, a3, i3) ? this.resetTo(e20, t4, n3, r5, 1) : (We(this, 0), this.parent || Ne(this._dp, this, `_first`, `_last`, this._dp._sort ? `_start` : 0), this.render(0));
      ...
      var r5 = this._targets, i3 = e20 ? ut(e20) : r5, o4 = this._ptLookup, s4 = this._pt, c3, l3, u3, d3, f3, p3, m3;
      if ((!t4 || t4 === `all`) && Me(r5, i3)) return t4 === `all` && (this._pt = 0), Ot(this);
      for (c3 = this._op = this._op || [], t4 !== `all` && (h(t4) && (f3 = {}, H(t4, function(e21) {
        return f3[e21] = 1;
      }), t4 = f3), t4 = dn(r5, t4)), m3 = r5.length; m3--; ) if (~i3.indexOf(r5[m3])) for (f3 in l3 = o4[m3], t4 === `all` ? (c3[m3] = t4, d3 = l3, u3 = {}) : (u3 = c3[m3] = c3[m3] || {}, d3 = t4), d3) p3 = l3 && l3[f3], p3 && ((!(`kill` in p3.d) || p3.d.kill(f3) === true) && Pe(this, p3, `_pt`), delete l3[f3]), u3 !== `all` && (u3[f3] = 1);
    ...
    }, o3.delayedCall = function(e20, t4, n3, r5) {
      return new o3(t4, 0, { immediateRender: false, lazy: false, overwrite: false, delay: e20, onComplete: t4, onReverseComplete: t4, onCompleteParams: n3, onReverseCompleteParams: n3, callbackScope: r5 });
  ...
  var vn = function(e20, t4, n3, r4) {
    return e20[t4](r4.fp, n3);
  };
  ...
  var Cn = function(e20, t4) {
    ...
    if (!e20 && t4.b) r4 = t4.b;
      ...
      for (; n3; ) r4 = n3.p + (n3.m ? n3.m(n3.s + n3.c * e20) : Math.round((n3.s + n3.c * e20) * 1e4) / 1e4) + r4, n3 = n3._next;
      r4 += t4.c;
    }
  ...
  var Tn = function(e20, t4, n3, r4) {
    for (var i3 = this._pt, a3; i3; ) a3 = i3._next, i3.p === r4 && i3.modifier(e20, t4, n3), i3 = a3;
  };
  var En = function(e20) {
    for (var t4 = this._pt, n3, r4; t4; ) r4 = t4._next, t4.p === e20 && !t4.op || t4.op === e20 ? Pe(this, t4, `_pt`) : t4.dep || (n3 = 1), t4 = r4;
    return !n3;
  };
  var Dn = function(e20, t4, n3, r4) {
    r4.mSet(e20, t4, r4.m.call(r4.tween, n3, r4.mt), r4);
  };
  var On = function(e20) {
    for (var t4 = e20._pt, n3, r4, i3, a3; t4; ) {
      for (n3 = t4._next, r4 = i3; r4 && r4.pr > t4.pr; ) r4 = r4._next;
      (t4._prev = r4 ? r4._prev : a3) ? t4._prev._next = t4 : i3 = t4, (t4._next = r4) ? r4._prev = t4 : a3 = t4, t4 = n3;
    }
    e20._pt = i3;
  };
  var X = (function() {
    function e20(e21, t5, n3, r4, i3, a3, o3, s3, c3) {
      this.t = t5, this.s = r4, this.c = i3, this.p = n3, this.r = a3 || xn, this.d = o3 || this, this.set = s3 || gn, this.pr = c3 || 0, this._next = e21, e21 && (e21._prev = this);
    }
    var t4 = e20.prototype;
  ...
  var Fn = function() {
    ...
    e20 - Mn > 2 && (Pn(`matchMediaInit`), kn.forEach(function(e21) {
      var n3 = e21.queries, r4 = e21.conditions, i3, a3, o3, s3;
      for (a3 in n3) i3 = F.matchMedia(n3[a3]).matches, i3 && (o3 = 1), i3 !== r4[a3] && (r4[a3] = i3, s3 = 1);
  ...
  var In = (function() {
    ...
    return t4.add = function(e21, t5, n3) {
      ...
      var r4 = this, i3 = function() {
        var e22 = o, i4 = r4.selector, a3;
        return e22 && e22 !== r4 && e22.data.push(r4), n3 && (r4.selector = dt(n3)), o = r4, a3 = t5.apply(r4, arguments), g(a3) && r4._r.push(a3), o = e22, r4.selector = i4, r4.isReverted = false, a3;
      };
      return r4.last = i3, e21 === g ? i3(r4, function(e22) {
      ...
      var n3 = this;
      if (e21 ? (function() {
        for (var t6 = n3.getTweens(), r5 = n3.data.length, i3; r5--; ) i3 = n3.data[r5], i3.data === `isFlip` && (i3.revert(), i3.getChildren(true, true, false).forEach(function(e22) {
        ...
        }), r5 = n3.data.length; r5--; ) i3 = n3.data[r5], i3 instanceof J ? i3.data !== `nested` && (i3.scrollTrigger && i3.scrollTrigger.revert(), i3.kill()) : !(i3 instanceof Y) && i3.revert && i3.revert(e21);
  ...
  var Ln = (function() {
    ...
    return t4.add = function(e21, t5, n3) {
      ...
      var r4 = new In(0, n3 || this.scope), i3 = r4.conditions = {}, a3, s3, c3;
      for (s3 in o && !r4.selector && (r4.selector = o.selector), this.contexts.push(r4), t5 = r4.add(`onMatch`, t5), r4.queries = e21, e21) s3 === `all` ? c3 = 1 : (a3 = F.matchMedia(e21[s3]), a3 && (kn.indexOf(r4) < 0 && kn.push(r4), (i3[s3] = a3.matches) && (c3 = 1), a3.addListener ? a3.addListener(Fn) : a3.addEventListener(`change`, Fn)));
      return c3 && t5(r4, function(e22) {
        return r4.add(null, e22);
      }), this;
    }, t4.revert = function(e21) {
      this.kill(e21 || {});
  ...
  var Rn = { registerPlugin: function() {
  ...
  }, getProperty: function(e20, t4, n3, r4) {
    h(e20) && (e20 = ut(e20)[0]);
    var i3 = _e(e20 || {}).get, a3 = n3 ? Te : we;
    return n3 === `native` && (n3 = ``), e20 && (t4 ? a3((V[t4] && V[t4].get || i3)(e20, t4, n3, r4)) : function(t5, n4, r5) {
      return a3((V[t5] && V[t5].get || i3)(e20, t5, n4, r5));
    });
    ...
    if (e20 = ut(e20), e20.length > 1) {
      ...
      return function(e21) {
        for (var t5 = i3; t5--; ) r4[t5](e21);
      };
    }
    e20 = e20[0] || {};
    var a3 = V[t4], o3 = _e(e20), s3 = o3.harness && (o3.harness.aliases || {})[t4] || t4, c3 = a3 ? function(t5) {
      var r5 = new a3();
      kt._pt = 0, r5.init(e20, n3 ? t5 + n3 : t5, kt, 0, [e20]), r5.render(1, r5), kt._pt && wn(1, kt);
    } : o3.set(e20, s3);
    return a3 ? c3 : function(t5) {
      return c3(e20, s3, n3 ? t5 + n3 : t5, o3, 1);
    };
  }, quickTo: function(e20, t4, n3) {
    var r4, i3 = Z.to(e20, Ee((r4 = {}, r4[t4] = `+=0.1`, r4.paused = true, r4.stagger = 0, r4), n3 || {})), a3 = function(e21, n4, r5) {
      return i3.resetTo(t4, e21, n4, r5);
    };
    ...
    var t4 = e20.name, n3 = e20.effect, r4 = e20.plugins, i3 = e20.defaults, a3 = e20.extendTimeline;
    (r4 || ``).split(`,`).forEach(function(e21) {
      return e21 && !V[e21] && !R[e21] && ne(t4 + ` effect requires ` + e21 + ` plugin.`);
    }), fe[t4] = function(e21, t5, r5) {
      return n3(ut(e21), Ee(t5 || {}, i3), r5);
    }, a3 && (J.prototype[t4] = function(e21, n4, r5) {
      return this.add(fe[t4](e21, y(n4) ? n4 : (r5 = n4) && {}, this), r5);
    });
    ...
    e20 === void 0 && (e20 = {});
    var n3 = new J(e20), r4, i3;
    for (n3.smoothChildTiming = b(e20.smoothChildTiming), P.remove(n3), n3._dp = 0, n3._time = n3._tTime = P._time, r4 = P._first; r4; ) i3 = r4._next, (t4 || !(!r4._dur && r4 instanceof Y && r4.vars.onComplete === r4._targets[0])) && Ke(n3, r4, r4._start - r4._delay), r4 = i3;
    return Ke(P, n3, 0), n3;
    ...
    return kn.forEach(function(e20) {
      var t4 = e20.conditions, n3, r4;
      for (r4 in t4) t4[r4] && (t4[r4] = false, n3 = 1);
      n3 && e20.revert();
    }) || Fn();
    ...
    var n3 = An[e20], r4 = n3 && n3.indexOf(t4);
    r4 >= 0 && n3.splice(r4, 1);
  ...
  var Bn = function(e20, t4) {
    var n3 = e20._targets, r4, i3, a3;
    for (r4 in t4) for (i3 = n3.length; i3--; ) a3 = e20._ptLookup[i3][r4], a3 && (a3 = a3.d) && (a3._pt && (a3 = zn(a3, r4)), a3 && a3.modifier && a3.modifier(t4[r4], e20, n3[i3], r4));
  };
  var Vn = function(e20, t4) {
    return { name: e20, headless: 1, rawVars: 1, init: function(e21, n3, r4) {
      r4._onInit = function(e22) {
        var r5, i3;
        if (h(n3) && (r5 = {}, H(n3, function(e23) {
          return r5[e23] = 1;
        }), n3 = r5), t4) {
          for (i3 in r5 = {}, n3) r5[i3] = t4(n3[i3]);
          n3 = r5;
        }
        Bn(e22, n3);
      };
  ...
  var Z = Rn.registerPlugin({ name: `attr`, init: function(e20, t4, n3, r4, i3) {
    var a3, o3, s3;
    for (a3 in this.tween = n3, t4) s3 = e20.getAttribute(a3) || ``, o3 = this.add(e20, `setAttribute`, (s3 || 0) + ``, t4[a3], r4, i3, 0, 0, a3), o3.op = a3, o3.b = s3, this._props.push(a3);
  ...
  var gr = function(e20, t4, n3, r4, i3) {
    var a3 = e20._gsap;
    a3.scaleX = a3.scaleY = n3, a3.renderTransform(i3, a3);
  };
  var _r = function(e20, t4, n3, r4, i3) {
    var a3 = e20._gsap;
  ...
  var br = function() {
    var e20 = this.props, t4 = this.target, n3 = t4.style, r4 = t4._gsap, i3, a3;
    ...
    if (this.tfm) {
      for (a3 in this.tfm) r4[a3] = this.tfm[a3];
      r4.svg && (r4.renderTransform(), t4.setAttribute(`data-svg-origin`, this.svgo || ``)), i3 = Jn(), (!i3 || !i3.isStart) && !n3[Q] && (yr(n3), r4.zOrigin && n3[$] && (n3[$] += ` ` + r4.zOrigin + `px`, r4.zOrigin = 0, r4.renderTransform()), r4.uncache = 1);
    }
  };
  ...
  var wr = function e13(t4, n3, r4) {
    var i3 = getComputedStyle(t4);
    return i3[n3] || i3.getPropertyValue(n3.replace(tr, `-$1`).toLowerCase()) || i3.getPropertyValue(n3) || !r4 && e13(t4, Er(n3) || n3, 1) || ``;
  };
  var Tr = `O,Moz,ms,Ms,Webkit`.split(`,`);
  var Er = function(e20, t4, n3) {
    var r4 = (t4 || Kn).style, i3 = 5;
    if (e20 in r4 && !n3) return e20;
    for (e20 = e20.charAt(0).toUpperCase() + e20.substr(1); i3-- && !(Tr[i3] + e20 in r4); ) ;
  ...
  var Or = function(e20) {
    var t4 = e20.ownerSVGElement, n3 = Cr(`svg`, t4 && t4.getAttribute(`xmlns`) || `http://www.w3.org/2000/svg`), r4 = e20.cloneNode(true), i3;
    r4.style.display = `block`, n3.appendChild(r4), Wn.appendChild(n3);
    try {
      i3 = r4.getBBox();
    } catch {
    }
    return n3.removeChild(r4), Wn.removeChild(n3), i3;
  };
  ...
  var Mr = function(e20, t4) {
    if (t4) {
      var n3 = e20.style, r4;
      t4 in Xn && t4 !== $ && (t4 = Q), n3.removeProperty ? (r4 = t4.substr(0, 2), (r4 === `ms` || t4.substr(0, 6) === `webkit`) && (t4 = `-` + t4), n3.removeProperty(r4 === `--` ? t4 : t4.replace(tr, `-$1`).toLowerCase())) : n3.removeAttribute(t4);
    }
  };
  var Nr = function(e20, t4, n3, r4, i3, a3) {
    var o3 = new X(e20._pt, t4, n3, 0, 1, a3 ? dr : ur);
    return e20._pt = o3, o3.b = r4, o3.e = i3, e20._props.push(n3), o3;
  };
  var Pr = { deg: 1, rad: 1, turn: 1 };
  var Fr = { grid: 1, flex: 1 };
  var Ir = function e14(t4, n3, r4, i3) {
    var a3 = parseFloat(r4) || 0, o3 = (r4 + ``).trim().substr((a3 + ``).length) || `px`, s3 = Kn.style, c3 = nr.test(n3), l3 = t4.tagName.toLowerCase() === `svg`, u3 = (l3 ? `client` : `offset`) + (c3 ? `Width` : `Height`), d3 = 100, f3 = i3 === `px`, p3 = i3 === `%`, m3, h3, g3, _3;
    if (i3 === o3 || !a3 || Pr[i3] || Pr[o3]) return a3;
    if (o3 !== `px` && !f3 && (a3 = e14(t4, n3, r4, `px`)), _3 = t4.getCTM && jr(t4), (p3 || o3 === `%`) && (Xn[n3] || ~n3.indexOf(`adius`))) return m3 = _3 ? t4.getBBox()[c3 ? `width` : `height`] : t4[u3], U(p3 ? a3 / m3 * d3 : a3 / 100 * m3);
  ...
  var Lr = function(e20, t4, n3, r4) {
    var i3;
    return Gn || Dr(), t4 in ir && t4 !== `transform` && (t4 = ir[t4], ~t4.indexOf(`,`) && (t4 = t4.split(`,`)[0])), Xn[t4] && t4 !== `transform` ? (i3 = Yr(e20, r4), i3 = t4 === `transformOrigin` ? i3.svg ? i3.origin : Xr(wr(e20, $)) + ` ` + i3.zOrigin + `px` : i3[t4]) : (i3 = e20.style[t4], (!i3 || i3 === `auto` || r4 || ~(i3 + ``).indexOf(`calc(`)) && (i3 = Hr[t4] && Hr[t4](e20, t4, n3) || wr(e20, t4) || ve(e20, t4) || +(t4 === `opacity`))), n3 && !~(i3 + ``).trim().indexOf(` `) ? Ir(e20, t4, i3, n3) + n3 : i3;
  };
  var Rr = function(e20, t4, r4, i3) {
    if (!r4 || r4 === `none`) {
      var a3 = Er(t4, e20, 1), o3 = a3 && wr(e20, a3, 1);
      o3 && o3 !== r4 ? (t4 = a3, r4 = o3) : t4 === `borderColor` && (r4 = wr(e20, `borderTopColor`));
    }
    var s3 = new X(this._pt, e20.style, t4, 0, 1, Cn), c3 = 0, l3 = 0, u3, d3, f3, p3, m3, h3, g3, _3, v3, y3, b3, x3;
    if (s3.b = r4, s3.e = i3, r4 += ``, i3 += ``, i3.substring(0, 6) === `var(--` && (i3 = wr(e20, i3.substring(4, i3.indexOf(`)`)))), i3 === `auto` && (h3 = e20.style[t4], e20.style[t4] = i3, i3 = wr(e20, t4) || i3, h3 ? e20.style[t4] = h3 : Mr(e20, t4)), u3 = [r4, i3], zt(u3), r4 = u3[0], i3 = u3[1], f3 = r4.match(k) || [], x3 = i3.match(k) || [], x3.length) {
  ...
  var Br = function(e20) {
    var t4 = e20.split(` `), n3 = t4[0], r4 = t4[1] || `50%`;
    return (n3 === `top` || n3 === `bottom` || r4 === `left` || r4 === `right`) && (e20 = n3, n3 = r4, r4 = e20), t4[0] = zr[n3] || n3, t4[1] = zr[r4] || r4, t4.join(` `);
  };
  var Vr = function(e20, t4) {
    if (t4.tween && t4.tween._time === t4.tween._dur) {
      var n3 = t4.t, r4 = n3.style, i3 = t4.u, a3 = n3._gsap, o3, s3, c3;
      ...
      s3 && (Mr(n3, Q), a3 && (a3.svg && n3.removeAttribute(`transform`), r4.scale = r4.rotate = r4.translate = `none`, Yr(n3, 1), a3.uncache = 1, yr(r4)));
    }
  };
  var Hr = { clearProps: function(e20, t4, n3, r4, i3) {
    if (i3.data !== `isFromStart`) {
      var a3 = e20._pt = new X(e20._pt, t4, n3, 0, 0, Vr);
      return a3.u = r4, a3.pr = -10, a3.tween = i3, e20._props.push(n3), 1;
    }
  } };
  var Ur = [1, 0, 0, 1, 0, 0];
  var Wr = {};
  ...
  var Jr = function(e20, t4, n3, r4, i3, a3) {
    ...
    n3 ? s3 !== Ur && (S3 = f3 * h3 - p3 * m3) && (C3 = h3 / S3 * y3 + b3 * (-m3 / S3) + (m3 * _3 - h3 * g3) / S3, w3 = y3 * (-p3 / S3) + f3 / S3 * b3 - (f3 * _3 - p3 * g3) / S3, y3 = C3, b3 = w3) : (x3 = Ar(e20), y3 = x3.x + (~v3[0].indexOf(`%`) ? y3 / 100 * x3.width : y3), b3 = x3.y + (~(v3[1] || v3[0]).indexOf(`%`) ? b3 / 100 * x3.height : b3)), r4 || r4 !== false && o3.smooth ? (g3 = y3 - c3, _3 = b3 - l3, o3.xOffset = u3 + (g3 * f3 + _3 * m3) - g3, o3.yOffset = d3 + (g3 * p3 + _3 * h3) - _3) : o3.xOffset = o3.yOffset = 0, o3.xOrigin = y3, o3.yOrigin = b3, o3.smooth = !!r4, o3.origin = t4, o3.originIsAbsolute = !!n3, e20.style[$] = `0px 0px`, a3 && (Nr(a3, o3, `xOrigin`, c3, y3), Nr(a3, o3, `yOrigin`, l3, b3), Nr(a3, o3, `xOffset`, u3, o3.xOffset), Nr(a3, o3, `yOffset`, d3, o3.yOffset)), e20.setAttribute(`data-svg-origin`, y3 + ` ` + b3);
  };
  var Yr = function(e20, t4) {
    var r4 = e20._gsap || new en(e20);
    if (`x` in r4 && !t4 && !r4.uncache) return r4;
    var i3 = e20.style, a3 = r4.scaleX < 0, o3 = `px`, s3 = `deg`, c3 = getComputedStyle(e20), l3 = wr(e20, $) || `0`, u3 = d3 = f3 = h3 = g3 = _3 = v3 = y3 = b3 = 0, d3, f3, p3 = m3 = 1, m3, h3, g3, _3, v3, y3, b3, x3, S3, C3, w3, T3, E3, D3, O3, k3, A3, j3, M3, N3, P3, F3, I3, L3, R3, z3, B3, ee3;
    return r4.svg = !!(e20.getCTM && jr(e20)), c3.translate && ((c3.translate !== `none` || c3.scale !== `none` || c3.rotate !== `none`) && (i3[Q] = (c3.translate === `none` ? `` : `translate3d(` + (c3.translate + ` 0 0`).split(` `).slice(0, 3).join(`, `) + `) `) + (c3.rotate === `none` ? `` : `rotate(` + c3.rotate + `) `) + (c3.scale === `none` ? `` : `scale(` + c3.scale.split(` `).join(`,`) + `) `) + (c3[Q] === `none` ? `` : c3[Q])), i3.scale = i3.rotate = i3.translate = `none`), C3 = qr(e20, r4.svg), r4.svg && (r4.uncache ? (P3 = e20.getBBox(), l3 = r4.xOrigin - P3.x + `px ` + (r4.yOrigin - P3.y) + `px`, N3 = ``) : N3 = !t4 && e20.getAttribute(`data-svg-origin`), Jr(e20, N3 || l3, !!N3 || r4.originIsAbsolute, r4.smooth !== false, C3)), x3 = r4.xOrigin || 0, S3 = r4.yOrigin || 0, C3 !== Ur && (D3 = C3[0], O3 = C3[1], k3 = C3[2], A3 = C3[3], u3 = j3 = C3[4], d3 = M3 = C3[5], C3.length === 6 ? (p3 = Math.sqrt(D3 * D3 + O3 * O3), m3 = Math.sqrt(A3 * A3 + k3 * k3), h3 = D3 || O3 ? $n(O3, D3) * Zn : 0, v3 = k3 || A3 ? $n(k3, A3) * Zn + h3 : 0, v3 && (m3 *= Math.abs(Math.cos(v3 * Qn))), r4.svg && (u3 -= x3 - (x3 * D3 + S3 * k3), d3 -= S3 - (x3 * O3 + S3 * A3))) : (ee3 = C3[6], z3 = C3[7], I3 = C3[8], L3 = C3[9], R3 = C3[10], B3 = C3[11], u3 = C3[12], d3 = C3[13], f3 = C3[14], w3 = $n(ee3, R3), g3 = w3 * Zn, w3 && (T3 = Math.cos(-w3), E3 = Math.sin(-w3), N3 = j3 * T3 + I3 * E3, P3 = M3 * T3 + L3 * E3, F3 = ee3 * T3 + R3 * E3, I3 = j3 * -E3 + I3 * T3, L3 = M3 * -E3 + L3 * T3, R3 = ee3 * -E3 + R3 * T3, B3 = z3 * -E3 + B3 * T3, j3 = N3, M3 = P3, ee3 = F3), w3 = $n(-k3, R3), _3 = w3 * Zn, w3 && (T3 = Math.cos(-w3), E3 = Math.sin(-w3), N3 = D3 * T3 - I3 * E3, P3 = O3 * T3 - L3 * E3, F3 = k3 * T3 - R3 * E3, B3 = A3 * E3 + B3 * T3, D3 = N3, O3 = P3, k3 = F3), w3 = $n(O3, D3), h3 = w3 * Zn, w3 && (T3 = Math.cos(w3), E3 = Math.sin(w3), N3 = D3 * T3 + O3 * E3, P3 = j3 * T3 + M3 * E3, O3 = O3 * T3 - D3 * E3, M3 = M3 * T3 - j3 * E3, D3 = N3, j3 = P3), g3 && Math.abs(g3) + Math.abs(h3) > 359.9 && (g3 = h3 = 0, _3 = 180 - _3), p3 = U(Math.sqrt(D3 * D3 + O3 * O3 + k3 * k3)), m3 = U(Math.sqrt(M3 * M3 + ee3 * ee3)), w3 = $n(j3, M3), v3 = Math.abs(w3) > 2e-4 ? w3 * Zn : 0, b3 = B3 ? 1 / (B3 < 0 ? -B3 : B3) : 0), r4.svg && (N3 = e20.getAttribute(`transform`), r4.forceCSS = e20.setAttribute(`transform`, ``) || !Gr(wr(e20, Q)), N3 && e20.setAttribute(`transform`, N3))), Math.abs(v3) > 90 && Math.abs(v3) < 270 && (a3 ? (p3 *= -1, v3 += h3 <= 0 ? 180 : -180, h3 += h3 <= 0 ? 180 : -180) : (m3 *= -1, v3 += v3 <= 0 ? 180 : -180)), t4 || (t4 = r4.uncache), r4.x = u3 - ((r4.xPercent = u3 && (!t4 && r4.xPercent || (Math.round(e20.offsetWidth / 2) === Math.round(-u3) ? -50 : 0))) ? e20.offsetWidth * r4.xPercent / 100 : 0) + o3, r4.y = d3 - ((r4.yPercent = d3 && (!t4 && r4.yPercent || (Math.round(e20.offsetHeight / 2) === Math.round(-d3) ? -50 : 0))) ? e20.offsetHeight * r4.yPercent / 100 : 0) + o3, r4.z = f3 + o3, r4.scaleX = U(p3), r4.scaleY = U(m3), r4.rotation = U(h3) + s3, r4.rotationX = U(g3) + s3, r4.rotationY = U(_3) + s3, r4.skewX = v3 + s3, r4.skewY = y3 + s3, r4.transformPerspective = b3 + o3, (r4.zOrigin = parseFloat(l3.split(` `)[2]) || !t4 && r4.zOrigin || 0) && (i3[$] = Xr(l3)), r4.xOffset = r4.yOffset = 0, r4.force3D = n.force3D, r4.renderTransform = r4.svg ? ri : Sr ? ni : Qr, r4.uncache = 0, r4;
  };
  var Xr = function(e20) {
  ...
  var Zr = function(e20, t4, n3) {
    var r4 = G(t4);
    return U(parseFloat(t4) + parseFloat(Ir(e20, `x`, n3 + `px`, r4))) + r4;
  };
  var Qr = function(e20, t4) {
  ...
  var ni = function(e20, t4) {
    var n3 = t4 || this, r4 = n3.xPercent, i3 = n3.yPercent, a3 = n3.x, o3 = n3.y, s3 = n3.z, c3 = n3.rotation, l3 = n3.rotationY, u3 = n3.rotationX, d3 = n3.skewX, f3 = n3.skewY, p3 = n3.scaleX, m3 = n3.scaleY, h3 = n3.transformPerspective, g3 = n3.force3D, _3 = n3.target, v3 = n3.zOrigin, y3 = ``, b3 = g3 === `auto` && e20 && e20 !== 1 || g3 === true;
    if (v3 && (u3 !== $r || l3 !== $r)) {
    ...
    h3 !== ei && (y3 += `perspective(` + h3 + ti), (r4 || i3) && (y3 += `translate(` + r4 + `%, ` + i3 + `%) `), (b3 || a3 !== ei || o3 !== ei || s3 !== ei) && (y3 += s3 !== ei || b3 ? `translate3d(` + a3 + `, ` + o3 + `, ` + s3 + `) ` : `translate(` + a3 + `, ` + o3 + ti), c3 !== $r && (y3 += `rotate(` + c3 + ti), l3 !== $r && (y3 += `rotateY(` + l3 + ti), u3 !== $r && (y3 += `rotateX(` + u3 + ti), (d3 !== $r || f3 !== $r) && (y3 += `skew(` + d3 + `, ` + f3 + ti), (p3 !== 1 || m3 !== 1) && (y3 += `scale(` + p3 + `, ` + m3 + ti), _3.style[Q] = y3 || `translate(0, 0)`;
  };
  var ri = function(e20, t4) {
    var n3 = t4 || this, r4 = n3.xPercent, i3 = n3.yPercent, a3 = n3.x, o3 = n3.y, s3 = n3.rotation, c3 = n3.skewX, l3 = n3.skewY, u3 = n3.scaleX, d3 = n3.scaleY, f3 = n3.target, p3 = n3.xOrigin, m3 = n3.yOrigin, h3 = n3.xOffset, g3 = n3.yOffset, _3 = n3.forceCSS, v3 = parseFloat(a3), y3 = parseFloat(o3), b3, x3, S3, C3, w3;
    s3 = parseFloat(s3), c3 = parseFloat(c3), l3 = parseFloat(l3), l3 && (l3 = parseFloat(l3), c3 += l3, s3 += l3), s3 || c3 ? (s3 *= Qn, c3 *= Qn, b3 = Math.cos(s3) * u3, x3 = Math.sin(s3) * u3, S3 = Math.sin(s3 - c3) * -d3, C3 = Math.cos(s3 - c3) * d3, c3 && (l3 *= Qn, w3 = Math.tan(c3 - l3), w3 = Math.sqrt(1 + w3 * w3), S3 *= w3, C3 *= w3, l3 && (w3 = Math.tan(l3), w3 = Math.sqrt(1 + w3 * w3), b3 *= w3, x3 *= w3)), b3 = U(b3), x3 = U(x3), S3 = U(S3), C3 = U(C3)) : (b3 = u3, C3 = d3, x3 = S3 = 0), (v3 && !~(a3 + ``).indexOf(`px`) || y3 && !~(o3 + ``).indexOf(`px`)) && (v3 = Ir(f3, `x`, a3, `px`), y3 = Ir(f3, `y`, o3, `px`)), (p3 || m3 || h3 || g3) && (v3 = U(v3 + p3 - (p3 * b3 + m3 * S3) + h3), y3 = U(y3 + m3 - (p3 * x3 + m3 * C3) + g3)), (r4 || i3) && (w3 = f3.getBBox(), v3 = U(v3 + r4 / 100 * w3.width), y3 = U(y3 + i3 / 100 * w3.height)), w3 = `matrix(` + b3 + `,` + x3 + `,` + S3 + `,` + C3 + `,` + v3 + `,` + y3 + `)`, f3.setAttribute(`transform`, w3), _3 && (f3.style[Q] = w3);
  };
  var ii = function(e20, t4, n3, r4, i3) {
    var a3 = 360, o3 = h(i3), s3 = parseFloat(i3) * (o3 && ~i3.indexOf(`rad`) ? Zn : 1) - r4, c3 = r4 + s3 + `deg`, l3, u3;
    return o3 && (l3 = i3.split(`_`)[1], l3 === `short` && (s3 %= a3, s3 !== s3 % (a3 / 2) && (s3 += s3 < 0 ? a3 : -a3)), l3 === `cw` && s3 < 0 ? s3 = (s3 + a3 * er) % a3 - ~~(s3 / a3) * a3 : l3 === `ccw` && s3 > 0 && (s3 = (s3 - a3 * er) % a3 - ~~(s3 / a3) * a3)), e20._pt = u3 = new X(e20._pt, t4, n3, r4, s3, or), u3.e = c3, u3.u = `deg`, e20._props.push(n3), u3;
  };
  ...
  var oi = function(e20, t4, n3) {
    var r4 = ai({}, n3._gsap), i3 = `perspective,force3D,transformOrigin,svgOrigin`, a3 = n3.style, o3, s3, c3, l3, u3, d3, f3, p3;
    for (s3 in r4.svg ? (c3 = n3.getAttribute(`transform`), n3.setAttribute(`transform`, ``), a3[Q] = t4, o3 = Yr(n3, 1), Mr(n3, Q), n3.setAttribute(`transform`, c3)) : (c3 = getComputedStyle(n3)[Q], a3[Q] = t4, o3 = Yr(n3, 1), a3[Q] = c3), Xn) c3 = r4[s3], l3 = o3[s3], c3 !== l3 && i3.indexOf(s3) < 0 && (f3 = G(c3), p3 = G(l3), u3 = f3 === p3 ? parseFloat(c3) : Ir(n3, s3, c3, p3), d3 = parseFloat(l3), e20._pt = new X(e20._pt, o3, s3, u3, d3 - u3, ar), e20._pt.u = p3 || 0, e20._props.push(s3));
    ai(o3, r4);
  };
  H(`padding,margin,Width,Radius`, function(e20, t4) {
    var n3 = `Top`, r4 = `Right`, i3 = `Bottom`, a3 = `Left`, o3 = (t4 < 3 ? [n3, r4, i3, a3] : [n3 + a3, n3 + r4, i3 + r4, i3 + a3]).map(function(n4) {
      return t4 < 2 ? e20 + n4 : `border` + n4 + e20;
    });
    Hr[t4 > 1 ? `border` + e20 : e20] = function(e21, t5, n4, r5, i4) {
      var a4, s3;
      if (arguments.length < 4) return a4 = o3.map(function(t6) {
        return Lr(e21, t6, n4);
      }), s3 = a4.join(` `), s3.split(a4[0]).length === 5 ? a4[0] : s3;
      a4 = (r5 + ``).split(` `), s3 = {}, o3.forEach(function(e22, t6) {
  ...
  var si = { name: `css`, register: Dr, targetTest: function(e20) {
  ...
  }, init: function(e20, t4, r4, i3, a3) {
    var o3 = this._props, s3 = e20.style, c3 = r4.vars.startAt, l3, u3, d3, f3, p3, m3, g3, _3, v3, y3, b3, x3, S3, C3, w3, T3, E3;
    for (g3 in Gn || Dr(), this.styles = this.styles || xr(e20), T3 = this.styles.props, this.tween = r4, t4) if (g3 !== `autoRound` && (u3 = t4[g3], !(V[g3] && on(g3, t4, r4, i3, e20, a3)))) {
      if (p3 = typeof u3, m3 = Hr[g3], p3 === `function` && (u3 = u3.call(r4, i3, e20, a3), p3 = typeof u3), p3 === `string` && ~u3.indexOf(`random(`) && (u3 = Ct(u3)), m3) m3(this, e20, g3, u3, r4) && (w3 = 1);
    ...
    var r4 = ir[t4];
    return r4 && r4.indexOf(`,`) < 0 && (t4 = r4), t4 in Xn && t4 !== $ && (e20._gsap.x || Lr(e20, `x`)) ? n3 && qn === n3 ? t4 === `scale` ? hr : mr : (qn = n3 || {}) && (t4 === `scale` ? gr : _r) : e20.style && !v(e20.style[t4]) ? fr : ~t4.indexOf(`-`) ? pr : bn(e20, t4);
  }, core: { _removeProperty: Mr, _getMatrix: qr } };
  Z.utils.checkPrefix = Er, Z.core.getStyleSaver = xr, (function(e20, t4, r4, i3) {
    var a3 = H(e20 + `,` + t4 + `,` + r4, function(e21) {
      Xn[e21] = 1;
    });
    H(t4, function(e21) {
  ...
  function t2(t4, n3, r4) {
    return n3 && e15(t4.prototype, n3), r4 && e15(t4, r4), t4;
  }
  var n2;
  var r2;
  var i2;
  ...
  var S2 = function() {
    var e20 = u2.core, t4 = e20.bridge || {}, n3 = e20._scrollers, r4 = e20._proxies;
    n3.push.apply(n3, v2), r4.push.apply(r4, y2), v2 = n3, y2 = r4, x2 = function(e21, n4) {
      return t4[e21](n4);
    };
  };
  ...
  var T2 = function(e20, t4, n3, r4, i3) {
    return e20.addEventListener(t4, n3, { passive: r4 !== false, capture: !!i3 });
  };
  var E2 = function(e20, t4, n3, r4) {
    return e20.removeEventListener(t4, n3, !!r4);
  };
  var D2 = `scrollLeft`;
  var O2 = `scrollTop`;
  var k2 = function() {
  ...
  var A2 = function(e20, t4) {
    var n3 = function n4(r4) {
      if (r4 || r4 === 0) {
        ...
        r4 = n4.v = Math.round(r4) || (f2 && f2.iOS ? 1 : 0), e20(r4), n4.cacheID = v2.cache, a3 && x2(`ss`, r4);
  ...
  var ae2 = function(e20, t4, n3) {
    var r4 = e20, i3 = e20, a3 = b2(), o3 = a3, s3 = t4 || 50, c3 = Math.max(500, s3 * 3), l3 = function(e21, t5) {
      var c4 = b2();
      t5 || c4 - a3 > s3 ? (i3 = r4, r4 = e21, o3 = a3, a3 = c4) : n3 ? r4 += e21 : r4 = i3 + (e21 - i3) / (c4 - o3) * (a3 - o3);
    };
    return { update: l3, reset: function() {
      i3 = r4 = n3 ? 0 : r4, o3 = a3 = 0;
    }, getVelocity: function(e21) {
      var t5 = o3, s4 = i3, u3 = b2();
      return (e21 || e21 === 0) && e21 !== r4 && l3(e21), a3 === o3 || u3 - o3 > c3 ? 0 : (r4 + (n3 ? s4 : -s4)) / ((n3 ? u3 : a3) - t5) * 1e3;
    } };
  };
  ...
  var j2 = (function() {
    ...
    return d3.init = function(e21) {
      ...
      var W3, De3, Oe3, ke3, Ae3, je3, G3, K3 = this, Me3 = 0, Ne3 = 0, Pe3 = e21.passive || !x3 && e21.passive !== false, Fe3 = ie2(g3, ee2), q3 = ie2(g3, te2), Ie3 = Fe3(), Le3 = q3(), Re3 = ~h3.indexOf(`touch`) && !~h3.indexOf(`pointer`) && p2[0] === `pointerdown`, ze3 = w2(g3), J3 = g3.ownerDocument || a2, Y3 = [0, 0, 0], Be3 = [0, 0, 0], Ve3 = 0, He3 = function() {
        ...
        var e22 = K3.deltaX = se2(Y3), n3 = K3.deltaY = se2(Be3), r4 = Math.abs(e22) >= t4, i3 = Math.abs(n3) >= t4;
        he3 && (r4 || i3) && he3(K3, e22, n3, Y3, Be3), r4 && (de3 && K3.deltaX > 0 && de3(K3), F3 && K3.deltaX < 0 && F3(K3), I3 && I3(K3), ge3 && K3.deltaX < 0 != Me3 < 0 && ge3(K3), Me3 = K3.deltaX, Y3[0] = Y3[1] = Y3[2] = 0), i3 && (pe3 && K3.deltaY > 0 && pe3(K3), fe3 && K3.deltaY < 0 && fe3(K3), me3 && me3(K3), _e3 && K3.deltaY < 0 != Ne3 < 0 && _e3(K3), Ne3 = K3.deltaY, Be3[0] = Be3[1] = Be3[2] = 0), (ke3 || Oe3) && (L3 && L3(K3), Oe3 && (Oe3 = (j3 && Oe3 === 1 && j3(K3), ue3 && ue3(K3), 0)), ke3 = false), je3 && !(je3 = false) && Ee3 && Ee3(K3), Ae3 && (Ae3 = (Se3(K3), false)), W3 = 0;
        ...
        if (!Ue3(e22, 1)) {
          e22 = oe2(e22, x3);
          var t5 = e22.clientX, n3 = e22.clientY, r4 = t5 - K3.x, i3 = n3 - K3.y, a3 = K3.isDragging;
          K3.x = t5, K3.y = n3, (a3 || (r4 || i3) && (Math.abs(K3.startX - t5) >= d4 || Math.abs(K3.startY - n3) >= d4)) && (Oe3 || (Oe3 = a3 ? 2 : 1), a3 || (K3.isDragging = true), qe3(r4, i3));
        }
        ...
        if (!Ue3(e22, 1)) {
          ...
          var t5 = !isNaN(K3.y - K3.startY), r4 = K3.isDragging, a3 = r4 && (Math.abs(K3.x - K3.startX) > 3 || Math.abs(K3.y - K3.startY) > 3), o3 = oe2(e22);
          ...
          })), K3.isDragging = K3.isGesturing = K3.isPressed = false, S3 && r4 && !R3 && De3.restart(true), Oe3 && Ge3(), M3 && r4 && M3(K3), P3 && P3(K3, a3);
        }
      }, Ze3 = function(e22) {
        ...
        if (!Ue3(e22)) {
          var t5 = e22.clientX, n3 = e22.clientY, r4 = t5 - K3.x, i3 = n3 - K3.y;
          K3.x = t5, K3.y = n3, ke3 = true, S3 && De3.restart(true), (r4 || i3) && qe3(r4, i3);
        }
      }, nt3 = function(e22) {
        K3.event = e22, ve3(K3);
      }, rt3 = function(e22) {
  ...
  var Pe2 = function(e20, t4, n3) {
    ...
    return n3[`_` + t4 + `Clamp`] = r4, r4 ? e20.substr(6, e20.length - 7) : e20;
  };
  ...
  var Ge2 = function(e20, t4) {
    var n3 = t4.s, r4 = t4.d2, i3 = t4.d, a3 = t4.a;
    return Math.max(0, (n3 = `scroll` + r4) && (a3 = C2(e20, n3)) ? a3() - He2(e20)()[i3] : Be2(e20) ? (de2[n3] || F2[n3]) - Ve2(r4) : e20[n3] - e20[`offset` + r4]);
  };
  ...
  var _t2 = function(e20, t4) {
    var n3 = t4 && mt2(e20)[ye2] !== `matrix(1, 0, 0, 1, 0, 0)` && M2.to(e20, { x: 0, y: 0, xPercent: 0, yPercent: 0, rotation: 0, rotationX: 0, rotationY: 0, scale: 1, skewX: 0, skewY: 0 }).progress(1), r4 = e20.getBoundingClientRect ? e20.getBoundingClientRect() : e20.scrollingElement.getBoundingClientRect();
    return n3 && n3.progress(0).kill(), r4;
  };
  ...
  var yt2 = function(e20) {
    var t4 = [], n3 = e20.labels, r4 = e20.duration(), i3;
    for (i3 in n3) t4.push(n3[i3] / r4);
    return t4;
  };
  ...
  var xt2 = function(e20) {
    ...
    return n3 ? function(e21, r4, i3) {
      ...
      i3 === void 0 && (i3 = 1e-3);
      var a3 = t4(n4);
      return !r4 || Math.abs(a3 - n4) < i3 || a3 - n4 < 0 == r4 < 0 ? a3 : t4(r4 < 0 ? n4 - e20 : n4 + e20);
    };
  };
  ...
  var Ct2 = function(e20, t4, n3, r4) {
    return n3.split(`,`).forEach(function(n4) {
      return e20(t4, n4, r4);
    });
  };
  var wt2 = function(e20, t4, n3, r4, i3) {
    return e20.addEventListener(t4, n3, { passive: !r4, capture: !!i3 });
  };
  var Tt2 = function(e20, t4, n3, r4) {
    return e20.removeEventListener(t4, n3, !!r4);
  };
  ...
  var At2 = function(e20, t4) {
    if (qe2(e20)) {
      var n3 = e20.indexOf(`=`), r4 = ~n3 ? +(e20.charAt(n3 - 1) + 1) * parseFloat(e20.substr(n3 + 1)) : 0;
      ~n3 && (e20.indexOf(`%`) > n3 && (r4 *= t4 / 100), e20 = e20.substr(0, n3 - 1)), e20 = r4 + (e20 in kt2 ? kt2[e20] * t4 : ~e20.indexOf(`%`) ? parseFloat(e20) * t4 / 100 : parseFloat(e20) || 0);
    }
    return e20;
  };
  var jt2 = function(e20, t4, n3, r4, i3, a3, o3, s3) {
    ...
    return y3 += `position:` + ((h3 || s3) && m3 ? `fixed;` : `absolute;`), (h3 || s3 || !m3) && (y3 += (r4 === te2 ? nt2 : rt2) + `:` + (a3 + parseFloat(d3)) + `px;`), o3 && (y3 += `box-sizing:border-box;text-align:left;width:` + o3.offsetWidth + `px;`), p3._isStart = _3, p3.setAttribute(`class`, `gsap-marker-` + e20 + (t4 ? ` marker-` + t4 : ``)), p3.style.cssText = y3, p3.innerText = t4 || t4 === 0 ? e20 + `-` + t4 : e20, g3.children[0] ? g3.insertBefore(p3, g3.children[0]) : g3.appendChild(p3), p3._offset = p3[`offset` + r4.op.d2], Mt2(p3, 0, r4, _3), p3;
  };
  var Mt2 = function(e20, t4, n3, r4) {
    var i3 = { display: `block` }, a3 = n3[r4 ? `os2` : `p2`], o3 = n3[r4 ? `p2` : `os2`];
    e20._isFlipped = r4, i3[n3.a + `Percent`] = r4 ? -100 : 0, i3[n3.a] = r4 ? `1px` : 0, i3[`border` + a3 + dt2] = 1, i3[`border` + o3 + dt2] = 0, i3[n3.p] = t4 + `px`, M2.set(e20, i3);
  };
  var Z2 = [];
  var Nt2 = {};
  var Pt2;
  ...
  var $t2 = function(e20, t4) {
    ...
    xe2 && $2.sort(), t4 || Gt2(), v2.forEach(function(e21) {
      ...
      var t5 = Ge2(e21.scroller, e21._dir), n4 = e21.vars.end === `max` || e21._endClamp && e21.end > t5, r4 = e21._startClamp && e21.start >= t5;
      (n4 || r4) && e21.setPositions(r4 ? t5 - 1 : e21.start, n4 ? Math.max(r4 ? t5 : e21.start + 1, t5) : e21.end, true);
  ...
  var rn2 = function(e20) {
    if (e20 === 2 || !qt2 && !Oe2) {
      ...
      var t4 = Z2.length, n3 = G2(), r4 = n3 - K2 >= 50, i3 = t4 && Z2[0].scroll();
      if (tn2 = en2 > i3 ? -1 : 1, qt2 || (en2 = i3), r4 && (Me2 && !ve2 && n3 - Me2 > 200 && (Me2 = 0, Vt2(`scrollEnd`)), he2 = K2, K2 = n3), tn2 < 0) {
  ...
  var cn2 = function(e20, t4, n3, r4) {
    if (!e20._gsap.swappedIn) {
      for (var i3 = an2.length, a3 = t4.style, o3 = e20.style, s3; i3--; ) s3 = an2[i3], a3[s3] = n3[s3];
      a3.position = n3.position === `absolute` ? `absolute` : `relative`, n3.display === `inline` && (a3.display = `inline-block`), o3[rt2] = o3[nt2] = `auto`, a3.flexBasis = n3.flexBasis || `auto`, a3.overflow = `visible`, a3.boxSizing = `border-box`, a3[it2] = vt2(e20, ee2) + pt2, a3[at2] = vt2(e20, te2) + pt2, a3[X2] = o3[ut2] = o3[tt2] = o3[et2] = `0`, un2(r4), o3[it2] = o3[`max` + dt2] = n3[it2], o3[at2] = o3[`max` + ft2] = n3[at2], o3[X2] = n3[X2], e20.parentNode !== t4 && (e20.parentNode.insertBefore(t4, e20), t4.appendChild(e20)), e20._gsap.swappedIn = true;
    }
  };
  var ln2 = /([A-Z])/g;
  var un2 = function(e20) {
    if (e20) {
      var t4 = e20.t.style, n3 = e20.length, r4 = 0, i3, a3;
      for ((e20.t._gsap || M2.core.getCache(e20.t)).uncache = 1; r4 < n3; r4 += 2) a3 = e20[r4 + 1], i3 = e20[r4], a3 ? t4[i3] = a3 : t4[i3] && t4.removeProperty(i3.replace(ln2, `-$1`).toLowerCase());
    }
  };
  var dn2 = function(e20) {
    for (var t4 = on2.length, n3 = e20.style, r4 = [], i3 = 0; i3 < t4; i3++) r4.push(on2[i3], n3[on2[i3]]);
    return r4.t = e20, r4;
  };
  var fn2 = function(e20, t4, n3) {
    for (var r4 = [], i3 = e20.length, a3 = n3 ? 8 : 0, o3; a3 < i3; a3 += 2) o3 = e20[a3], r4.push(o3, o3 in t4 ? t4[o3] : e20[a3 + 1]);
    return r4.t = e20.t, r4;
  };
  var pn2 = { left: 0, top: 0 };
  var mn2 = function(e20, t4, n3, r4, i3, a3, o3, s3, c3, l3, u3, d3, f3, p3) {
    Je2(e20) && (e20 = e20(s3)), qe2(e20) && e20.substr(0, 3) === `max` && (e20 = d3 + (e20.charAt(4) === `=` ? At2(`0` + e20.substr(3), n3) : 0));
    var m3 = f3 ? f3.time() : 0, h3, g3, _3;
    if (f3 && f3.seek(0), isNaN(e20) || (e20 = +e20), Ye2(e20)) f3 && (e20 = M2.utils.mapRange(f3.scrollTrigger.start, f3.scrollTrigger.end, 0, d3, e20)), o3 && Mt2(o3, n3, r4, true);
    else {
      Je2(t4) && (t4 = t4(s3));
      var v3 = (e20 || `0`).split(` `), y3, b3, x3, S3;
      _3 = ne2(t4, s3) || F2, y3 = _t2(_3) || {}, (!y3 || !y3.left && !y3.top) && mt2(_3).display === `none` && (S3 = _3.style.display, _3.style.display = `block`, y3 = _t2(_3), S3 ? _3.style.display = S3 : _3.style.removeProperty(`display`)), b3 = At2(v3[0], y3[r4.d]), x3 = At2(v3[1] || `0`, n3), e20 = y3[r4.p] - c3[r4.p] - l3 + b3 + i3 - x3, o3 && Mt2(o3, x3, r4, n3 - x3 < 20 || o3._isStart && x3 > 20), n3 -= n3 - x3;
    }
    if (p3 && (s3[p3] = e20 || -1e-3, e20 < 0 && (e20 = 0)), a3) {
      var C3 = e20 + n3, w3 = a3._isStart;
      h3 = `scroll` + r4.d2, Mt2(a3, C3, r4, w3 && C3 > 20 || !w3 && (u3 ? Math.max(F2[h3], de2[h3]) : a3.parentNode[h3]) <= C3 + 1), u3 && (c3 = _t2(o3), u3 && (a3.style[r4.op.p] = c3[r4.op.p] - r4.op.m - a3._offset + pt2));
    }
    return f3 && _3 && (h3 = _t2(_3), f3.seek(d3), g3 = _t2(_3), f3._caScrollDist = h3[r4.p] - g3[r4.p], e20 = e20 / f3._caScrollDist * d3), f3 && f3.seek(m3), f3 ? e20 : Math.round(e20);
  };
  var hn2 = /(webkit|moz|length|cssText|inset)/i;
  var gn2 = function(e20, t4, n3, r4) {
  ...
  var _n2 = function(e20, t4, n3) {
    ...
    return function(t5) {
      ...
      return a3 !== r4 && a3 !== i3 && Math.abs(a3 - r4) > 3 && Math.abs(a3 - i3) > 3 && (t5 = a3, n3 && n3()), i3 = r4, r4 = Math.round(t5), r4;
    };
  };
  var vn2 = function(e20, t4, n3) {
    var r4 = {};
    r4[t4.p] = `+=` + n3, M2.set(e20, r4);
  };
  var yn2 = function(e20, t4) {
    var n3 = ie2(e20, t4), r4 = `_scroll` + t4.p2, i3 = function t5(i4, a3, o3, s3, c3) {
      var l3 = t5.tween, u3 = a3.onComplete, d3 = {};
      o3 || (o3 = n3());
      var f3 = _n2(n3, o3, function() {
        l3.kill(), t5.tween = 0;
      });
      return c3 = s3 && c3 || 0, s3 || (s3 = i4 - o3), l3 && l3.kill(), a3[r4] = i4, a3.inherit = false, a3.modifiers = d3, d3[r4] = function() {
    ...
    return e20[r4] = n3, n3.wheelHandler = function() {
  ...
  var $2 = (function() {
    ...
    return t4.init = function(t5, n3) {
      ...
      var r4 = t5, i3 = r4.onUpdate, a3 = r4.toggleClass, o3 = r4.id, s3 = r4.onToggle, c3 = r4.onRefresh, l3 = r4.scrub, u3 = r4.trigger, d3 = r4.pin, f3 = r4.pinSpacing, p3 = r4.invalidateOnRefresh, m3 = r4.anticipatePin, h3 = r4.onScrubComplete, g3 = r4.onSnapComplete, _3 = r4.once, b3 = r4.snap, x3 = r4.pinReparent, S3 = r4.pinSpacer, w3 = r4.containerAnimation, T3 = r4.fastScrollEnd, E3 = r4.preventOverlaps, D3 = t5.horizontal || t5.containerAnimation && t5.horizontal !== false ? ee2 : te2, O3 = !l3 && l3 !== 0, k3 = ne2(t5.scroller || N2), A3 = M2.core.getCache(k3), re3 = Be2(k3), ae3 = (`pinType` in t5 ? t5.pinType : C2(k3, `pinType`) || re3 && `fixed`) === `fixed`, oe3 = [t5.onEnter, t5.onLeave, t5.onEnterBack, t5.onLeaveBack], se3 = O3 && t5.toggleActions.split(` `), ce3 = `markers` in t5 ? t5.markers : Ot2.markers, le3 = re3 ? 0 : parseFloat(mt2(k3)[`border` + D3.p2 + dt2]) || 0, j3 = this, ue3 = t5.onRefreshInit && function() {
      ...
      if (j3._startClamp = j3._endClamp = false, j3._dir = D3, m3 *= 45, j3.scroller = k3, j3.scroll = w3 ? w3.time.bind(w3) : R3, Ce3 = R3(), j3.vars = t5, n3 || (n3 = t5.animation), `refreshPriority` in t5 && (xe2 = 1, t5.refreshPriority === -9999 && (nn2 = j3)), A3.tweenScroll = A3.tweenScroll || { top: yn2(k3, te2), left: yn2(k3, ee2) }, j3.tweenTo = z3 = A3.tweenScroll[D3.p], j3.scrubDuration = function(e21) {
        ...
        if ((t6 || Math.abs(j3.getVelocity()) < 10) && !r5 && !ve2 && ge3 !== e21) {
          ...
          if (l4 = V3(c4, j3), Ye2(l4) || (l4 = c4), u4 = Math.max(0, Math.round(H3 + l4 * q3)), e21 <= U3 && e21 >= H3 && u4 !== e21) {
            if (r5 && !r5._initted && r5.data <= $e2(u4 - e21)) return;
      ...
      if (j3.previous = function() {
        ...
        var r5 = e21 !== false || !j3.enabled, i4 = _e2;
        r5 !== j3.isReverted && (r5 && (Vt3 = Math.max(R3(), j3.scroll.rec || 0), be3 = j3.progress, Ht3 = n3 && n3.progress()), Te3 && [Te3, Ee3, W3, De3].forEach(function(e22) {
          return e22.style.display = r5 ? `none` : `block`;
        }), r5 && (_e2 = j3, j3.update(r5)), d3 && (!x3 || !j3.isActive) && (r5 ? sn2(d3, Y3, Ie3) : cn2(d3, Y3, mt2(d3), rt3)), r5 || j3.update(r5), _e2 = i4, j3.isReverted = r5);
      }, j3.refresh = function(r5, i4, a4, o4) {
      ...
      }, j3.setPositions = function(e21, t6, n4, r5) {
        if (w3) {
          var i4 = w3.scrollTrigger, a4 = w3.duration(), o4 = i4.end - i4.start;
          e21 = i4.start + o4 * e21 / a4, t6 = i4.start + o4 * t6 / a4;
        }
        j3.refresh(false, false, { start: Fe2(e21, n4 && !!j3._startClamp), end: Fe2(t6, n4 && !!j3._endClamp) }, r5), j3.update();
        ...
        j3.disable(e21, r5), Q3 && !r5 && Q3.kill(), o3 && delete Nt2[o3];
        var i4 = Z2.indexOf(j3);
        i4 >= 0 && Z2.splice(i4, 1), i4 === L2 && tn2 > 0 && L2--, i4 = 0, Z2.forEach(function(e22) {
          return e22.scroller === j3.scroller && (i4 = 1);
        }), i4 || qt2 || (j3.scroll.rec = 0), n3 && (n3.scrollTrigger = null, e21 && n3.revert({ kill: false }), r5 || n3.kill()), Te3 && [Te3, Ee3, W3, De3].forEach(function(e22) {
      ...
      if (N2 = window, P2 = document, de2 = P2.documentElement, F2 = P2.body, M2) if (I2 = M2.utils.toArray, me2 = M2.utils.clamp, Te2 = M2.core.context || Re2, Se2 = M2.core.suppressOverwrites || Re2, Ee2 = N2.history.scrollRestoration || `auto`, en2 = N2.pageYOffset || 0, M2.core.globals(`ScrollTrigger`, e20), F2) {
        ...
        var t5 = F2.hasAttribute(`style`), n3 = F2.style, r4 = n3.borderTopStyle, i3 = M2.core.Animation.prototype, a3, o3;
        for (i3.revert || Object.defineProperty(i3, "revert", { value: function() {
          return this.time(-0.01, true);
        } }), n3.borderTopStyle = `solid`, a3 = _t2(F2), te2.m = Math.round(a3.top + te2.sc()) || 0, ee2.m = Math.round(a3.left + ee2.sc()) || 0, r4 ? n3.borderTopStyle = r4 : n3.removeProperty(`border-top-style`), t5 || (F2.setAttribute(`style`, ``), F2.removeAttribute(`style`)), ge2 = setInterval(Q2, 250), M2.delayedCall(0.5, function() {
          return je2 = 0;
      ...
      var n3 = ne2(e21), r4 = v2.indexOf(n3), i3 = Be2(n3);
      ~r4 && v2.splice(r4, i3 ? 6 : 2), t5 && (i3 ? y2.unshift(N2, t5, F2, t5, de2, t5) : y2.unshift(n3, t5));
      ...
      var r4 = (qe2(e21) ? ne2(e21) : e21).getBoundingClientRect(), i3 = r4[n3 ? it2 : at2] * t5 || 0;
      return n3 ? r4.right - i3 > 0 && r4.left + i3 < N2.innerWidth : r4.bottom - i3 > 0 && r4.top + i3 < N2.innerHeight;
    }, e20.positionInViewport = function(e21, t5, n3) {
      qe2(e21) && (e21 = ne2(e21));
      var r4 = e21.getBoundingClientRect(), i3 = r4[n3 ? it2 : at2], a3 = t5 == null ? i3 / 2 : t5 in kt2 ? kt2[t5] * i3 : ~t5.indexOf(`%`) ? parseFloat(t5) * i3 / 100 : parseFloat(t5) || 0;
      return n3 ? (r4.left + a3) / N2.innerWidth : (r4.top + a3) / N2.innerHeight;
  ...
  $2.version = `3.15.0`, $2.saveStyles = function(e20) {
    ...
    var n3 = Rt2[e20], r4 = n3 && n3.indexOf(t4);
    r4 >= 0 && n3.splice(r4, 1);
  }, $2.batch = function(e20, t4) {
    var n3 = [], r4 = {}, i3 = t4.interval || 0.016, a3 = t4.batchMax || 1e9, o3 = function(e21, t5) {
      var n4 = [], r5 = [], o4 = M2.delayedCall(i3, function() {
        t5(n4, r5), n4 = [], r5 = [];
      }).pause();
      return function(e22) {
        n4.length || o4.restart(true), n4.push(e22.trigger), r5.push(e22), a3 <= n4.length && o4.progress(1);
      };
    }, s3;
    for (s3 in t4) r4[s3] = s3.substr(0, 2) === `on` && Je2(t4[s3]) && s3 !== `onRefreshInit` ? o3(s3, t4[s3]) : t4[s3];
    return Je2(a3) && (a3 = a3(), wt2($2, `refresh`, function() {
      return a3 = t4.batchMax();
    })), I2(e20).forEach(function(e21) {
      var t5 = {};
      for (s3 in r4) t5[s3] = r4[s3];
      t5.trigger = e21, n3.push($2.create(t5));
    }), n3;
  };
  var bn2 = function(e20, t4, n3, r4) {
    return t4 > r4 ? e20(r4) : t4 < 0 && e20(0), n3 > r4 ? (r4 - t4) / (n3 - t4) : n3 < 0 ? t4 / (t4 - n3) : 1;
  };
  ...
  var Cn2 = function(e20) {
    var t4 = e20.event, n3 = e20.target, r4 = e20.axis, i3 = (t4.changedTouches ? t4.changedTouches[0] : t4).target, a3 = i3._gsap || M2.core.getCache(i3), o3 = G2(), s3;
    ...
    (a3._isScroll || r4 === `x`) && (t4.stopPropagation(), t4._gsapAllow = true);
  };
  var wn2 = function(e20, t4, n3, r4) {
  ...
  var On2 = function(e20) {
    ...
    return d3 && M2.set(d3, { y: `+=0` }), e20.ignoreCheck = function(e21) {
      ...
      if (f3.offset && E3(), !t5) re3.restart(true);
        ...
        v2.cache++;
        var r5 = _3(), i4, o4;
        n3 && (i4 = p3(), o4 = i4 + r5 * 0.05 * -e21.velocityX / 0.227, r5 *= bn2(p3, i4, o4, Ge2(c3, ee2)), O3.vars.scrollX = C3(o4)), i4 = f3(), o4 = i4 + r5 * 0.05 * -e21.velocityY / 0.227, r5 *= bn2(f3, i4, o4, Ge2(c3, te2)), O3.vars.scrollY = w3(o4), O3.invalidate().duration(r5).play(0.01), (U2 && O3.vars.scrollY >= s3 || i4 >= s3 - 1) && M2.to({}, { onUpdate: ae3, duration: r5 });
      }
      a3 && a3(e21);
    }, e20.onWheel = function() {
      O3._ts && O3.pause(), G2() - g3 > 1e3 && (y3 = 0, g3 = G2());
    }, e20.onChange = function(e21, t5, r5, i4, a4) {
      if (Jt2 !== y3 && T3(), t5 && n3 && p3(C3(i4[2] === t5 ? k3 + (e21.startX - e21.x) : p3() + t5 - i4[1])), r5) {
        f3.offset && E3();
        var o4 = a4[2] === r5, s4 = o4 ? A3 + e21.startY - e21.y : f3() + r5 - a4[1], c4 = w3(s4);
  ...
  var t3 = { get ua() {
    ...
    if (/windows/i.test(t4)) {
      let r4 = t4.match(/Windows NT (\d+\.\d+)/i);
      return n3 = r4 && r4[1] ? e19(r4[1]) : `Unknown Version`, { name: `windows`, version: n3, buttonText: ` for Windows`, links: [{ buttonText: `Download for x64`, href: null }, { buttonText: `Download for ARM64`, href: null }] };
  ...
  // public/shopify/plantilla99/assets/js/DownloadSection.astro_astro_type_script_index_0_lang.DO3qSWET.js
  ci.registerPlugin($2);
  var r3 = () => {
    document.querySelectorAll(`[data-download-section]`).forEach((t4) => {
      if (t4._downloadSectionInitialized) return;
      t4._downloadSectionInitialized = true;
      let r4 = t4.querySelector(`[data-section-element]`), i3 = t4.querySelector(`[data-typed-header]`), a3 = t4.querySelector(`[data-cta-container]`), o3 = i3?.getAttribute(`data-os-title-placeholder`) === `true`, s3 = a3?.getAttribute(`data-button-text`);
      if (o3 && i3) {
        let e20 = `Download Google Antigravity${t3.operatingSystem.buttonText || ` for MacOS`}`, t5 = i3.querySelector(`.typed-content`), r5 = i3.querySelector(`.visually-hidden`);
        t5 && (t5.innerHTML = e20), r5 && (r5.innerHTML = e20), window.TypedHeaderHelper && (i3.helper = new window.TypedHeaderHelper(i3));
      }
      if (!s3 && a3) {
        let e20 = t3.operatingSystem.links;
        e20.length > 0 && (a3.innerHTML = ``, e20.forEach((e21, t5) => {
          let n3 = document.createElement(`a`);
          n3.className = `button button-${t5 === 0 ? `primary-inverse` : `secondary-inverse`}`, n3.href = `/download`, n3.innerHTML = `<span>${e21.buttonText}</span>`, a3.appendChild(n3);
        }));
      }
      setTimeout(() => {
        i3 && i3.helper && i3.helper.startTyping(ci.timeline()), ci.from(r4, { scale: 0.85, scrollTrigger: { trigger: r4, start: `top 75%`, end: `bottom bottom`, scrub: true, onEnter: () => {
          i3 && i3.helper && i3.helper.startTyping(ci.timeline());
        }, once: true } });
      }, 50);
    });
  };
