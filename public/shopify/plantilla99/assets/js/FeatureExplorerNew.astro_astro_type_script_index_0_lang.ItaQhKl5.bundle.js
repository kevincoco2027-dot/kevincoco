...
(() => {
  ...
  var Ne = function(e20, t4, n4, r4, i4) {
    ...
    var a5 = e20[r4], o4;
    if (i4) for (o4 = t4[i4]; a5 && a5[i4] > o4; ) a5 = a5._prev;
    return a5 ? (t4._next = a5._next, a5._next = t4) : (t4._next = e20[n4], e20[n4] = t4), t4._next ? t4._next._prev = t4 : e20[r4] = t4, t4._prev = a5, t4.parent = t4._dp = e20, t4;
  };
  var Pe = function(e20, t4, n4, r4) {
    n4 === void 0 && (n4 = `_first`), r4 === void 0 && (r4 = `_last`);
    var i4 = t4._prev, a5 = t4._next;
    i4 ? i4._next = a5 : e20[n4] === t4 && (e20[n4] = a5), a5 ? a5._prev = i4 : e20[r4] === t4 && (e20[r4] = i4), t4._next = t4._prev = t4.parent = null;
  };
  ...
  var $e = function(e20, t4, n4, r4) {
    var i4 = e20._repeat, a5 = W(t4) || 0, o4 = e20._tTime / e20._tDur;
    return o4 && !r4 && (e20._time *= a5 / e20._dur), e20._dur = a5, e20._tDur = i4 ? i4 < 0 ? 1e10 : W(a5 * (i4 + 1) + e20._rDelay * i4) : a5, o4 > 0 && !r4 && We(e20, e20._tTime = e20._tDur * o4), e20.parent && Ue(e20), n4 || Ie(e20.parent, e20), e20;
  };
  var et = function(e20) {
  ...
  var nt = function e5(t4, n4, r4) {
    var i4 = t4.labels, a5 = t4._recent || tt, o4 = t4.duration() >= s ? a5.endTime(false) : t4._dur, c4, l4, u4;
    return h(n4) && (isNaN(n4) || n4 in i4) ? (l4 = n4.charAt(0), u4 = n4.substr(-1) === `%`, c4 = n4.indexOf(`=`), l4 === `<` || l4 === `>` ? (c4 >= 0 && (n4 = n4.replace(/=/, ``)), (l4 === `<` ? a5._start : a5.endTime(a5._repeat >= 0)) + (parseFloat(n4.substr(1)) || 0) * (u4 ? (c4 < 0 ? a5 : r4).totalDuration() / 100 : 1)) : c4 < 0 ? (n4 in i4 || (i4[n4] = o4), i4[n4]) : (l4 = parseFloat(n4.charAt(c4 - 1) + n4.substr(c4 + 1)), u4 && r4 && (l4 = l4 / 100 * (w(r4) ? r4[0] : r4).totalDuration()), c4 > 1 ? e5(t4, n4.substr(0, c4 - 1), r4) + l4 : o4 + l4)) : n4 == null ? o4 : +n4;
  };
  var rt = function(e20, t4, n4) {
    var r4 = _(t4[1]), i4 = (r4 ? 2 : 1) + (e20 < 2 ? 0 : 1), a5 = t4[i4], o4, s4;
    if (r4 && (a5.duration = t4[1]), a5.parent = n4, e20) {
      for (o4 = a5, s4 = n4; s4 && !(`immediateRender` in o4); ) o4 = s4.vars.defaults || {}, s4 = b(s4.vars.inherit) && s4.parent;
      a5.immediateRender = b(o4.immediateRender), e20 < 2 ? a5.runBackwards = 1 : a5.startAt = t4[i4 - 1];
    }
    return new Y(t4[0], a5, t4[i4 + 1]);
  };
  ...
  var pt = function(e20) {
    if (g(e20)) return e20;
    var t4 = y(e20) ? e20 : { each: e20 }, n4 = Yt(t4.ease), r4 = t4.from || 0, i4 = parseFloat(t4.base) || 0, a5 = {}, o4 = r4 > 0 && r4 < 1, c4 = isNaN(r4) || o4, l4 = t4.axis, u4 = r4, d4 = r4;
    return h(r4) ? u4 = d4 = { center: 0.5, edges: 0.5, end: 1 }[r4] || 0 : !o4 && c4 && (u4 = r4[0], d4 = r4[1]), function(e21, o5, p4) {
      var m4 = (p4 || t4).length, h4 = a5[m4], g4, _4, v4, y4, b4, x4, S4, C4, w3;
      if (!h4) {
        if (w3 = t4.grid === `auto` ? 0 : (t4.grid || [1, s])[1], !w3) {
          for (S4 = -s; S4 < (S4 = p4[w3++].getBoundingClientRect().left) && w3 < m4; ) ;
          w3 < m4 && w3--;
        }
        for (h4 = a5[m4] = [], g4 = c4 ? Math.min(w3, m4) * u4 - 0.5 : r4 % w3, _4 = w3 === s ? 0 : c4 ? m4 * d4 / w3 - 0.5 : r4 / w3 | 0, S4 = 0, C4 = s, x4 = 0; x4 < m4; x4++) v4 = x4 % w3 - g4, y4 = _4 - (x4 / w3 | 0), h4[x4] = b4 = l4 ? Math.abs(l4 === `y` ? y4 : v4) : f(v4 * v4 + y4 * y4), b4 > S4 && (S4 = b4), b4 < C4 && (C4 = b4);
        r4 === `random` && ft(h4), h4.max = S4 - C4, h4.min = C4, h4.v = m4 = (parseFloat(t4.amount) || parseFloat(t4.each) * (w3 > m4 ? m4 - 1 : l4 ? l4 === `y` ? m4 / w3 : w3 : Math.max(w3, m4 / w3)) || 0) * (r4 === `edges` ? -1 : 1), h4.b = m4 < 0 ? i4 - m4 : i4, h4.u = G(t4.amount || t4.each) || 0, n4 = n4 && m4 < 0 ? Jt(n4) : n4;
      }
  ...
  var ht = function(e20, t4) {
    ...
    return !n4 && y(e20) && (r4 = n4 = e20.radius || s, e20.values ? (e20 = ut(e20.values), (i4 = !_(e20[0])) && (r4 *= r4)) : e20 = mt(e20.increment)), it(t4, n4 ? g(e20) ? function(t5) {
      ...
      for (var n5 = parseFloat(i4 ? t5.x : t5), a5 = parseFloat(i4 ? t5.y : 0), o4 = s, c4 = 0, l4 = e20.length, u4, d4; l4--; ) i4 ? (u4 = e20[l4].x - n5, d4 = e20[l4].y - a5, u4 = u4 * u4 + d4 * d4) : u4 = Math.abs(e20[l4] - n5), u4 < o4 && (o4 = u4, c4 = l4);
  ...
  var St = function e7(t4, n4, r4) {
    var i4 = n4 - t4, a5 = i4 * 2;
    return w(t4) ? bt(t4, e7(0, t4.length - 1), n4) : it(r4, function(e20) {
      return e20 = (a5 + (e20 - t4) % a5) % a5 || 0, t4 + (e20 > i4 ? a5 - e20 : e20);
    });
  };
  var Ct = function(e20) {
  ...
  var wt = function(e20, t4, n4, r4, i4) {
    var a5 = t4 - e20, o4 = r4 - n4;
    return it(i4, function(t5) {
      return n4 + ((t5 - e20) / a5 * o4 || 0);
    });
  };
  var Tt = function e8(t4, n4, r4, i4) {
    var a5 = isNaN(t4 + n4) ? 0 : function(e20) {
  ...
  var Et = function(e20, t4, n4) {
    var r4 = e20.labels, i4 = s, a5, o4, c4;
    for (a5 in r4) o4 = r4[a5] - t4, o4 < 0 == !!n4 && o4 && i4 > (o4 = Math.abs(o4)) && (c4 = a5, i4 = o4);
    return c4;
  };
  var Dt = function(e20, t4, n4) {
    var r4 = e20.vars, i4 = r4[t4], a5 = o, s4 = e20._ctx, c4, l4, u4;
    if (i4) return c4 = r4[t4 + `Params`], l4 = r4.callbackScope || e20, n4 && le.length && xe(), s4 && (o = s4), u4 = c4 ? i4.apply(l4, c4) : i4.call(l4), o = a5, u4;
  };
  var Ot = function(e20) {
  ...
  var jt = function(e20) {
    if (e20) if (e20 = !e20.name && e20.default || e20, x() || e20.headless) {
      var t4 = e20.name, n4 = g(e20), r4 = t4 && !n4 && e20.init ? function() {
        this._props = [];
      } : e20, i4 = { init: ie, render: wn, add: rn, kill: En, modifier: Tn, rawVars: 0 }, a5 = { targetTest: 0, get: 0, getSetter: bn, aliases: {}, register: 0 };
      if (Ht(), e20 !== r4) {
        if (V[t4]) return;
        Ee(r4, Ee(Ae(e20, i4), a5)), Oe(r4.prototype, Oe(i4, Ae(e20, a5))), V[r4.prop = t4] = r4, e20.targetTest && (me.push(r4), ce[t4] = 1), t4 = (t4 === `css` ? `CSS` : t4.charAt(0).toUpperCase() + t4.substr(1)) + `Plugin`;
      }
  ...
  var Pt = function(e20, t4, n4) {
    var r4 = e20 ? _(e20) ? [e20 >> 16, e20 >> 8 & K, e20 & K] : 0 : Mt.black, i4, a5, o4, s4, c4, l4, u4, d4, f4, p4;
    if (!r4) {
      if (e20.substr(-1) === `,` && (e20 = e20.substr(0, e20.length - 1)), Mt[e20]) r4 = Mt[e20];
      else if (e20.charAt(0) === `#`) {
        if (e20.length < 6 && (i4 = e20.charAt(1), a5 = e20.charAt(2), o4 = e20.charAt(3), e20 = `#` + i4 + i4 + a5 + a5 + o4 + o4 + (e20.length === 5 ? e20.charAt(4) + e20.charAt(4) : ``)), e20.length === 9) return r4 = parseInt(e20.substr(1, 6), 16), [r4 >> 16, r4 >> 8 & K, r4 & K, parseInt(e20.substr(7), 16) / 255];
        e20 = parseInt(e20.substr(1), 16), r4 = [e20 >> 16, e20 >> 8 & K, e20 & K];
      } else if (e20.substr(0, 3) === `hsl`) {
        if (r4 = p4 = e20.match(D), !t4) s4 = r4[0] % 360 / 360, c4 = r4[1] / 100, l4 = r4[2] / 100, a5 = l4 <= 0.5 ? l4 * (c4 + 1) : l4 + c4 - l4 * c4, i4 = l4 * 2 - a5, r4.length > 3 && (r4[3] *= 1), r4[0] = Nt(s4 + 1 / 3, i4, a5), r4[1] = Nt(s4, i4, a5), r4[2] = Nt(s4 - 1 / 3, i4, a5);
        else if (~e20.indexOf(`=`)) return r4 = e20.match(O), n4 && r4.length < 4 && (r4[3] = 1), r4;
      } else r4 = e20.match(D) || Mt.transparent;
      r4 = r4.map(Number);
    }
    return t4 && !p4 && (i4 = r4[0] / K, a5 = r4[1] / K, o4 = r4[2] / K, u4 = Math.max(i4, a5, o4), d4 = Math.min(i4, a5, o4), l4 = (u4 + d4) / 2, u4 === d4 ? s4 = c4 = 0 : (f4 = u4 - d4, c4 = l4 > 0.5 ? f4 / (2 - u4 - d4) : f4 / (u4 + d4), s4 = u4 === i4 ? (a5 - o4) / f4 + (a5 < o4 ? 6 : 0) : u4 === a5 ? (o4 - i4) / f4 + 2 : (i4 - a5) / f4 + 4, s4 *= 60), r4[0] = ~~(s4 + 0.5), r4[1] = ~~(c4 * 100 + 0.5), r4[2] = ~~(l4 * 100 + 0.5)), n4 && r4.length < 4 && (r4[3] = 1), r4;
  };
  var Ft = function(e20) {
    var t4 = [], n4 = [], r4 = -1;
  ...
  var It = function(e20, t4, n4) {
    var r4 = ``, i4 = (e20 + r4).match(Lt), a5 = t4 ? `hsla(` : `rgba(`, o4 = 0, s4, c4, l4, u4;
    if (!i4) return e20;
    if (i4 = i4.map(function(e21) {
      return (e21 = Pt(e21, t4, 1)) && a5 + (t4 ? e21[0] + `,` + e21[1] + `%,` + e21[2] + `%,` + e21[3] : e21.join(`,`)) + `)`;
    }), n4 && (l4 = Ft(e20), s4 = n4.c, s4.join(r4) !== l4.c.join(r4))) for (c4 = e20.replace(Lt, `1`).split(k), u4 = c4.length - 1; o4 < u4; o4++) r4 += c4[o4] + (~s4.indexOf(o4) ? i4.shift() || a5 + `0,0,0,0)` : (l4.length ? l4 : i4.length ? i4 : n4).shift());
  ...
  var Bt;
  var Vt = (function() {
    var e20 = Date.now, t4 = 500, n4 = 33, r4 = e20(), i4 = r4, a5 = 1e3 / 240, o4 = a5, s4 = [], c4, l4, u4, d4, f4, p4, m4 = function u5(m5) {
      var h4 = e20() - i4, g4 = m5 === true, _4, v4, y4, b4;
      if ((h4 > t4 || h4 < 0) && (r4 += h4 - n4), i4 += h4, y4 = i4 - r4, _4 = y4 - o4, (_4 > 0 || g4) && (b4 = ++d4.frame, f4 = y4 - d4.time * 1e3, d4.time = y4 /= 1e3, o4 += _4 + (_4 >= a5 ? 4 : a5 - _4), v4 = 1), g4 || (c4 = l4(u5)), v4) for (p4 = 0; p4 < s4.length; p4++) s4[p4](y4, f4, b4, m5);
    };
    return d4 = { time: 0, frame: 0, tick: function() {
      ...
      a5 = 1e3 / (e21 || 240), o4 = d4.time * 1e3 + a5;
    }, add: function(e21, t5, n5) {
      var r5 = t5 ? function(t6, n6, i5, a6) {
        e21(t6, n6, i5, a6), d4.remove(r5);
      } : e21;
  ...
  var Wt = /["']/g;
  var Gt = function(e20) {
    for (var t4 = {}, n4 = e20.substr(1, e20.length - 3).split(`:`), r4 = n4[0], i4 = 1, a5 = n4.length, o4, s4, c4; i4 < a5; i4++) s4 = n4[i4], o4 = i4 === a5 - 1 ? s4.length : s4.lastIndexOf(`,`), c4 = s4.substr(0, o4), t4[r4] = isNaN(c4) ? c4.replace(Wt, ``).trim() : +c4, r4 = s4.substr(o4 + 1).trim();
    return t4;
  };
  var Kt = function(e20) {
  ...
  var Xt = function(e20, t4, n4, r4) {
    ...
    var i4 = { easeIn: t4, easeOut: n4, easeInOut: r4 }, a5;
    return H(e20, function(e21) {
      for (var t5 in q[e21] = R[e21] = i4, q[a5 = e21.toLowerCase()] = n4, i4) q[a5 + (t5 === `easeIn` ? `.in` : t5 === `easeOut` ? `.out` : `.inOut`)] = q[e21 + `.` + t5] = i4[t5];
    }), i4;
  };
  var Zt = function(e20) {
    return function(t4) {
  ...
  var Qt = function e9(t4, n4, r4) {
    var i4 = n4 >= 1 ? n4 : 1, a5 = (r4 || (t4 ? 0.3 : 0.45)) / (n4 < 1 ? n4 : 1), o4 = a5 / l * (Math.asin(1 / i4) || 0), s4 = function(e20) {
      return e20 === 1 ? 1 : i4 * 2 ** (-10 * e20) * m((e20 - o4) * a5) + 1;
    }, c4 = t4 === `out` ? s4 : t4 === `in` ? function(e20) {
      return 1 - s4(1 - e20);
    } : Zt(s4);
    return a5 = l / a5, c4.config = function(n5, r5) {
      return e9(t4, n5, r5);
    }, c4;
  };
  ...
  H(`Linear,Quad,Cubic,Quart,Quint,Strong`, function(e20, t4) {
    ...
    var n4 = 1 / t4, r4 = 2 * n4, i4 = 2.5 * n4, a5 = function(a6) {
      return a6 < n4 ? e20 * a6 * a6 : a6 < r4 ? e20 * (a6 - 1.5 / t4) ** 2 + 0.75 : a6 < i4 ? e20 * (a6 -= 2.25 / t4) * a6 + 0.9375 : e20 * (a6 - 2.625 / t4) ** 2 + 0.984375;
    };
    ...
    e20 === void 0 && (e20 = 1);
    var n4 = 1 / e20, r4 = e20 + +!t4, i4 = +!!t4, a5 = 1 - c;
    return function(e21) {
      return ((r4 * at(0, a5, e21) | 0) + i4) * n4;
    };
  ...
  var tn = (function() {
    ...
    return t4.delay = function(e21) {
      ...
      return new Promise(function(r4) {
        var i4 = g(e21) ? e21 : Te, a5 = function() {
          var e22 = t5.then;
          t5.then = null, n4 && n4(), g(i4) && (i4 = i4(t5)) && (i4.then || i4 === t5) && (t5.then = e22), r4(i4), t5.then = e22;
        };
        t5._initted && t5.totalProgress() === 1 && t5._ts >= 0 || !t5._tTime && t5._ts < 0 ? a5() : t5._prom = a5;
      });
    }, t4.kill = function() {
      Ot(this);
    }, e20;
  ...
  var J = (function(r4) {
    ...
    return o4.to = function(e20, t4, n4) {
    ...
    }, o4.staggerTo = function(e20, t4, n4, r5, i5, a5, o5) {
      return n4.duration = t4, n4.stagger = n4.stagger || r5, n4.onComplete = a5, n4.onCompleteParams = o5, n4.parent = this, new Y(e20, n4, nt(this, i5)), this;
    }, o4.staggerFrom = function(e20, t4, n4, r5, i5, a5, o5) {
      return n4.runBackwards = 1, je(n4).immediateRender = b(n4.immediateRender), this.staggerTo(e20, t4, n4, r5, i5, a5, o5);
    }, o4.staggerFromTo = function(e20, t4, n4, r5, i5, a5, o5, s4) {
      return r5.startAt = n4, je(r5).immediateRender = b(r5.immediateRender), this.staggerTo(e20, t4, r5, i5, a5, o5, s4);
      ...
      if (this !== P && s4 > i5 && e20 >= 0 && (s4 = i5), s4 !== this._tTime || n4 || l4) {
        if (r5 !== this._time && o5 && (s4 += this._time - r5, e20 += this._time - r5), u4 = s4, v4 = this._start, _4 = this._ts, h4 = !_4, l4 && (o5 || (r5 = this._zTime), (e20 || !t4) && (this._zTime = e20)), this._repeat) {
          ...
          if (u4 = W(s4 % m4), s4 === i5 ? (p4 = this._repeat, u4 = o5) : (y4 = W(s4 / m4), p4 = ~~y4, p4 && p4 === y4 && (u4 = o5, p4--), u4 > o5 && (u4 = o5)), y4 = Ve(this._tTime, m4), !r5 && this._tTime && y4 !== p4 && this._tTime - y4 * m4 - this._dur <= 0 && (y4 = p4), b4 && p4 & 1 && (u4 = o5 - u4, x4 = 1), p4 !== y4 && !this._lock) {
            var S4 = b4 && y4 & 1, C4 = S4 === (b4 && p4 & 1);
            if (p4 < y4 && (S4 = !S4), r5 = S4 ? 0 : s4 % o5 ? o5 : s4, this._lock = 1, this.render(r5 || (x4 ? 0 : W(p4 * m4)), t4, !o5)._lock = 0, this._tTime = s4, !t4 && this.parent && Dt(this, `onRepeat`), this.vars.repeatRefresh && !x4 && (this.invalidate()._lock = 1, y4 = p4), r5 && r5 !== this._time || h4 !== !this._ts || this.vars.onRepeat && !this.parent && !this._act || (o5 = this._dur, i5 = this._tDur, C4 && (this._lock = 2, r5 = S4 ? o5 : -1e-4, this.render(r5, true), this.vars.repeatRefresh && !x4 && this.invalidate()), this._lock = 0, !this._ts && !h4)) return this;
          }
        }
      ...
      for (var i5 = [], a5 = this._first; a5; ) a5._start >= r5 && (a5 instanceof Y ? t4 && i5.push(a5) : (n4 && i5.push(a5), e20 && i5.push.apply(i5, a5.getChildren(true, t4, n4)))), a5 = a5._next;
      return i5;
      ...
      for (var n4 = [], r5 = ut(e20), i5 = this._first, a5 = _(t4), o5; i5; ) i5 instanceof Y ? be(i5._targets, r5) && (a5 ? (!sn || i5._initted && i5._ts) && i5.globalTime(0) <= t4 && i5.globalTime(i5.totalDuration()) > t4 : !t4 || i5.isActive()) && n4.push(i5) : (o5 = i5.getTweensOf(r5, t4)).length && n4.push.apply(n4, o5), i5 = i5._next;
      return n4;
    }, o4.tweenTo = function(e20, t4) {
      t4 || (t4 = {});
      var n4 = this, r5 = nt(n4, e20), i5 = t4, a5 = i5.startAt, o5 = i5.onStart, s4 = i5.onStartParams, l4 = i5.immediateRender, u4, d4 = Y.to(n4, Ee({ ease: t4.ease || `none`, lazy: false, immediateRender: false, time: r5, overwrite: `auto`, duration: t4.duration || Math.abs((r5 - (a5 && `time` in a5 ? a5.time : n4._time)) / n4.timeScale()) || c, onStart: function() {
        if (n4.pause(), !u4) {
          var e21 = t4.duration || Math.abs((r5 - (a5 && `time` in a5 ? a5.time : n4._time)) / n4.timeScale());
      ...
      n4 === void 0 && (n4 = 0);
      var r5 = this._first, i5 = this.labels, a5;
      for (e20 = W(e20); r5; ) r5._start >= n4 && (r5._start += e20, r5._end += e20), r5 = r5._next;
      if (t4) for (a5 in i5) i5[a5] >= n4 && (i5[a5] += e20);
      return Ie(this);
  ...
  var an = function(e20, t4, n4, r4, i4) {
    ...
    var a5 = {}, o4;
    for (o4 in e20) a5[o4] = pn(e20[o4], i4, t4, n4, r4);
    return a5;
  };
  var on = function(e20, t4, n4, r4, i4, a5) {
    var o4, s4, c4, l4;
    if (V[e20] && (o4 = new V[e20]()).init(i4, o4.rawVars ? t4[e20] : an(t4[e20], r4, i4, a5, n4), n4, r4, a5) !== false && (n4._pt = s4 = new X(n4._pt, i4, e20, 0, 1, o4.render, o4, 0, o4.priority), n4 !== kt)) for (c4 = n4._ptLookup[n4._targets.indexOf(i4)], l4 = o4._props.length; l4--; ) c4[o4._props[l4]] = s4;
    return o4;
  };
  var sn;
  var cn;
  var ln = function e11(t4, n4, o4) {
    var l4 = t4.vars, u4 = l4.ease, d4 = l4.startAt, f4 = l4.immediateRender, p4 = l4.lazy, m4 = l4.onUpdate, h4 = l4.runBackwards, g4 = l4.yoyoEase, _4 = l4.keyframes, v4 = l4.autoRevert, y4 = t4._dur, x4 = t4._startAt, S4 = t4._targets, C4 = t4.parent, w3 = C4 && C4.data === `nested` ? C4.vars.targets : S4, T3 = t4._overwrite === `auto` && !i, E3 = t4.timeline, D3 = l4.easeReverse || g4, O3, k3, A3, j3, M3, N3, F3, I3, L3, R3, z3, B3, ee3;
    if (E3 && (!_4 || !u4) && (u4 = `none`), t4._ease = Yt(u4, r.ease), t4._rEase = D3 && (Yt(D3) || t4._ease), t4._from = !E3 && !!l4.runBackwards, t4._from && (t4.ratio = 1), !E3 || _4 && !l4.stagger) {
      if (I3 = S4[0] ? _e(S4[0]).harness : 0, B3 = I3 && l4[I3.prop], O3 = Ae(l4, ce), x4 && (x4._zTime < 0 && x4.progress(1), n4 < 0 && h4 && f4 && !v4 ? x4.render(-1, true) : x4.revert(h4 && y4 ? oe : ae), x4._lazy = 0), d4) {
        if (Fe(t4._startAt = Y.set(S4, Ee({ data: `isStart`, overwrite: false, parent: C4, immediateRender: true, lazy: !x4 && b(p4), startAt: null, delay: 0, onUpdate: m4 && function() {
        ...
        if (n4 && (f4 = false), A3 = Ee({ overwrite: false, data: `isFromStart`, lazy: f4 && !x4 && b(p4), immediateRender: f4, stagger: 0, parent: C4 }, O3), B3 && (A3[I3.prop] = B3), Fe(t4._startAt = Y.set(S4, A3)), t4._startAt._dp = 0, t4._startAt._sat = t4, n4 < 0 && (a ? t4._startAt.revert(oe) : t4._startAt.render(-1, true)), t4._zTime = n4, !f4) e11(t4._startAt, c, c);
        else if (!n4) return;
      }
      for (t4._pt = t4._ptCache = 0, p4 = y4 && b(p4) || p4 && !y4, k3 = 0; k3 < S4.length; k3++) {
        if (M3 = S4[k3], F3 = M3._gsap || ge(S4)[k3]._gsap, t4._ptLookup[k3] = R3 = {}, ue[F3.id] && le.length && xe(), z3 = w3 === S4 ? k3 : w3.indexOf(M3), I3 && (L3 = new I3()).init(M3, B3 || O3, t4, z3, w3) !== false && (t4._pt = j3 = new X(t4._pt, M3, L3.name, 0, 1, L3.render, L3, 0, L3.priority), L3._props.forEach(function(e20) {
          R3[e20] = j3;
        ...
        t4._op && t4._op[k3] && t4.kill(M3, t4._op[k3]), T3 && t4._pt && (sn = t4, P.killTweensOf(M3, R3, t4.globalTime(n4)), ee3 = !t4.parent, sn = 0), t4._pt && p4 && (ue[F3.id] = 1);
      }
      N3 && On(t4), t4._onInit && t4._onInit(t4);
    }
    t4._onUpdate = m4, t4._initted = (!t4._op || t4._pt) && !ee3, _4 && n4 <= 0 && E3.render(s, true, true);
  };
  var un = function(e20, t4, n4, r4, i4, a5, o4, s4) {
    ...
    for (f4 = c4.length; f4--; ) u4 = c4[f4], l4 = u4._pt || u4, l4.s = (r4 || r4 === 0) && !i4 ? r4 : l4.s + (r4 || 0) + a5 * l4.c, l4.c = n4 - l4.s, u4.e && (u4.e = U(n4) + G(u4.e)), u4.b && (u4.b = l4.s + G(u4.b));
  };
  var dn = function(e20, t4) {
    var n4 = e20[0] ? _e(e20[0]).harness : 0, r4 = n4 && n4.aliases, i4, a5, o4, s4;
    if (!r4) return t4;
    for (a5 in i4 = Oe({}, t4), r4) if (a5 in i4) for (s4 = r4[a5].split(`,`), o4 = s4.length; o4--; ) i4[s4[o4]] = i4[a5];
    return i4;
  };
  var fn = function(e20, t4, n4, r4) {
    var i4 = t4.ease || r4 || `power1.inOut`, a5, o4;
    if (w(t4)) o4 = n4[e20] || (n4[e20] = []), t4.forEach(function(e21, n5) {
      return o4.push({ t: n5 / (t4.length - 1) * 100, v: e21, e: i4 });
    });
    else for (a5 in t4) o4 = n4[a5] || (n4[a5] = []), a5 === `ease` || o4.push({ t: parseFloat(e20), v: t4[a5], e: i4 });
  };
  ...
  var Y = (function(r4) {
    t(o4, r4);
    function o4(t4, a5, o5, s5) {
      var l4;
      typeof a5 == `number` && (o5.duration = a5, a5 = o5, o5 = null), l4 = r4.call(this, s5 ? a5 : je(a5)) || this;
      var u4 = l4.vars, d4 = u4.duration, f4 = u4.delay, p4 = u4.immediateRender, m4 = u4.stagger, h4 = u4.overwrite, g4 = u4.keyframes, v4 = u4.defaults, x4 = u4.scrollTrigger, T3 = a5.parent || P, E3 = (w(t4) || C(t4) ? _(t4[0]) : `length` in a5) ? [t4] : ut(t4), D3, O3, k3, A3, j3, M3, N3, F3;
      if (l4._targets = E3.length ? ge(E3) : ne(`GSAP target ` + t4 + ` not found. https://gsap.com`, !n.nullTargetWarn) || [], l4._ptLookup = [], l4._overwrite = h4, g4 || m4 || S(d4) || S(f4)) {
        a5 = l4.vars;
        var I3 = a5.easeReverse || a5.yoyoEase;
        if (D3 = l4.timeline = new J({ data: `nested`, defaults: v4 || {}, targets: T3 && T3.data === `nested` ? T3.vars.targets : E3 }), D3.kill(), D3.parent = D3._dp = e(l4), D3._start = 0, m4 || S(d4) || S(f4)) {
          ...
          for (O3 = 0; O3 < A3; O3++) k3 = Ae(a5, hn), k3.stagger = 0, I3 && (k3.easeReverse = I3), F3 && Oe(k3, F3), M3 = E3[O3], k3.duration = +pn(d4, e(l4), O3, M3, E3), k3.delay = (+pn(f4, e(l4), O3, M3, E3) || 0) - l4._delay, !m4 && A3 === 1 && k3.delay && (l4._delay = f4 = k3.delay, l4._start += f4, k3.delay = 0), D3.to(M3, k3, N3 ? N3(O3, M3, E3) : 0), D3._ease = q.none;
          D3.duration() ? d4 = f4 = 0 : l4.timeline = 0;
        } else if (g4) {
          je(Ee(D3.vars.defaults, { ease: `none` })), D3._ease = Yt(g4.ease || a5.ease || `none`);
          var L3 = 0, R3, z3, B3;
      ...
      return h4 === true && !i && (sn = e(l4), P.killTweensOf(E3), sn = 0), Ke(T3, e(l4), o5), a5.reversed && l4.reverse(), a5.paused && l4.paused(true), (p4 || !d4 && !g4 && l4._start === W(T3._time) && b(p4) && ze(e(l4)) && T3.data !== `nested`) && (l4._tTime = -c, l4.render(Math.max(0, -f4) || 0)), x4 && qe(e(l4), x4), l4;
    }
    var s4 = o4.prototype;
    return s4.render = function(e20, t4, n4) {
      var r5 = this._time, i4 = this._tDur, a5 = this._dur, o5 = e20 < 0, s5 = e20 > i4 - c && !o5 ? i4 : e20 < c ? 0 : e20, l4, u4, d4, f4, p4, m4, h4, g4;
      if (!a5) Ze(this, e20, t4, n4);
        ...
        if (l4 = s5, g4 = this.timeline, this._repeat) {
          if (f4 = a5 + this._rDelay, this._repeat < -1 && o5) return this.totalTime(f4 * 100 + e20, t4, n4);
          if (l4 = W(s5 % f4), s5 === i4 ? (d4 = this._repeat, l4 = a5) : (p4 = W(s5 / f4), d4 = ~~p4, d4 && d4 === p4 ? (l4 = a5, d4--) : l4 > a5 && (l4 = a5)), m4 = this._yoyo && d4 & 1, m4 && (l4 = a5 - l4), p4 = Ve(this._tTime, f4), l4 === r5 && !n4 && this._initted && d4 === p4) return this._tTime = s5, this;
        ...
        if (!this._initted) {
          ...
          if (a5 !== this._dur) return this.render(e20, t4, n4);
        }
        if (this._rEase) {
          var _4 = l4 < r5;
          if (_4 !== this._inv) {
        ...
        } else this.ratio = h4 = this._ease(l4 / a5);
        ...
        g4 && g4.render(e20 < 0 ? e20 : g4._dur * g4._ease(l4 / this._dur), t4, n4) || this._startAt && (this._zTime = e20), this._onUpdate && !t4 && (o5 && Re(this, e20, t4, n4), Dt(this, `onUpdate`)), this._repeat && d4 !== p4 && this.vars.onRepeat && !t4 && this.parent && Dt(this, `onRepeat`), (s5 === this._tDur || !s5) && this._tTime === s5 && (o5 && !this._onUpdate && Re(this, e20, true, true), (e20 || !a5) && (s5 === this._tDur && this._ts > 0 || !s5 && this._ts < 0) && Fe(this, 1), !t4 && !(o5 && !r5) && (s5 || r5 || m4) && (Dt(this, s5 === i4 ? `onComplete` : `onReverseComplete`, true), this._prom && !(s5 < i4 && this.timeScale() > 0) && this._prom()));
      }
      return this;
    }, s4.targets = function() {
      ...
      var a5 = Math.min(this._dur, (this._dp._time - this._start) * this._ts), o5;
      return this._initted || ln(this, a5), o5 = this._ease(a5 / this._dur), un(this, e20, t4, n4, r5, o5, a5, i4) ? this.resetTo(e20, t4, n4, r5, 1) : (We(this, 0), this.parent || Ne(this._dp, this, `_first`, `_last`, this._dp._sort ? `_start` : 0), this.render(0));
  ...
  var Tn = function(e20, t4, n4, r4) {
    for (var i4 = this._pt, a5; i4; ) a5 = i4._next, i4.p === r4 && i4.modifier(e20, t4, n4), i4 = a5;
  };
  var En = function(e20) {
  ...
  var On = function(e20) {
    for (var t4 = e20._pt, n4, r4, i4, a5; t4; ) {
      for (n4 = t4._next, r4 = i4; r4 && r4.pr > t4.pr; ) r4 = r4._next;
      (t4._prev = r4 ? r4._prev : a5) ? t4._prev._next = t4 : i4 = t4, (t4._next = r4) ? r4._prev = t4 : a5 = t4, t4 = n4;
    }
    e20._pt = i4;
  };
  var X = (function() {
    function e20(e21, t5, n4, r4, i4, a5, o4, s4, c4) {
      this.t = t5, this.s = r4, this.c = i4, this.p = n4, this.r = a5 || xn, this.d = o4 || this, this.set = s4 || gn, this.pr = c4 || 0, this._next = e21, e21 && (e21._prev = this);
    }
    var t4 = e20.prototype;
  ...
  var Fn = function() {
    ...
    e20 - Mn > 2 && (Pn(`matchMediaInit`), kn.forEach(function(e21) {
      var n4 = e21.queries, r4 = e21.conditions, i4, a5, o4, s4;
      for (a5 in n4) i4 = F.matchMedia(n4[a5]).matches, i4 && (o4 = 1), i4 !== r4[a5] && (r4[a5] = i4, s4 = 1);
  ...
  var In = (function() {
    ...
    return t4.add = function(e21, t5, n4) {
      ...
      var r4 = this, i4 = function() {
        var e22 = o, i5 = r4.selector, a5;
        return e22 && e22 !== r4 && e22.data.push(r4), n4 && (r4.selector = dt(n4)), o = r4, a5 = t5.apply(r4, arguments), g(a5) && r4._r.push(a5), o = e22, r4.selector = i5, r4.isReverted = false, a5;
      };
  ...
  var Ln = (function() {
    ...
    return t4.add = function(e21, t5, n4) {
      ...
      var r4 = new In(0, n4 || this.scope), i4 = r4.conditions = {}, a5, s4, c4;
      for (s4 in o && !r4.selector && (r4.selector = o.selector), this.contexts.push(r4), t5 = r4.add(`onMatch`, t5), r4.queries = e21, e21) s4 === `all` ? c4 = 1 : (a5 = F.matchMedia(e21[s4]), a5 && (kn.indexOf(r4) < 0 && kn.push(r4), (i4[s4] = a5.matches) && (c4 = 1), a5.addListener ? a5.addListener(Fn) : a5.addEventListener(`change`, Fn)));
  ...
  var Rn = { registerPlugin: function() {
    ...
    h(e20) && (e20 = ut(e20)[0]);
    var i4 = _e(e20 || {}).get, a5 = n4 ? Te : we;
    return n4 === `native` && (n4 = ``), e20 && (t4 ? a5((V[t4] && V[t4].get || i4)(e20, t4, n4, r4)) : function(t5, n5, r5) {
      return a5((V[t5] && V[t5].get || i4)(e20, t5, n5, r5));
    });
    ...
    e20 = e20[0] || {};
    var a5 = V[t4], o4 = _e(e20), s4 = o4.harness && (o4.harness.aliases || {})[t4] || t4, c4 = a5 ? function(t5) {
      var r5 = new a5();
      kt._pt = 0, r5.init(e20, n4 ? t5 + n4 : t5, kt, 0, [e20]), r5.render(1, r5), kt._pt && wn(1, kt);
    } : o4.set(e20, s4);
    return a5 ? c4 : function(t5) {
      return c4(e20, s4, n4 ? t5 + n4 : t5, o4, 1);
    };
  }, quickTo: function(e20, t4, n4) {
    var r4, i4 = Z.to(e20, Ee((r4 = {}, r4[t4] = `+=0.1`, r4.paused = true, r4.stagger = 0, r4), n4 || {})), a5 = function(e21, n5, r5) {
      return i4.resetTo(t4, e21, n5, r5);
    };
    return a5.tween = i4, a5;
    ...
    var t4 = e20.name, n4 = e20.effect, r4 = e20.plugins, i4 = e20.defaults, a5 = e20.extendTimeline;
    ...
    }, a5 && (J.prototype[t4] = function(e21, n5, r5) {
  ...
  var Bn = function(e20, t4) {
    var n4 = e20._targets, r4, i4, a5;
    for (r4 in t4) for (i4 = n4.length; i4--; ) a5 = e20._ptLookup[i4][r4], a5 && (a5 = a5.d) && (a5._pt && (a5 = zn(a5, r4)), a5 && a5.modifier && a5.modifier(t4[r4], e20, n4[i4], r4));
  };
  ...
  var Z = Rn.registerPlugin({ name: `attr`, init: function(e20, t4, n4, r4, i4) {
    var a5, o4, s4;
    for (a5 in this.tween = n4, t4) s4 = e20.getAttribute(a5) || ``, o4 = this.add(e20, `setAttribute`, (s4 || 0) + ``, t4[a5], r4, i4, 0, 0, a5), o4.op = a5, o4.b = s4, this._props.push(a5);
  ...
  var gr = function(e20, t4, n4, r4, i4) {
    var a5 = e20._gsap;
    a5.scaleX = a5.scaleY = n4, a5.renderTransform(i4, a5);
  };
  var _r = function(e20, t4, n4, r4, i4) {
    var a5 = e20._gsap;
    a5[t4] = n4, a5.renderTransform(i4, a5);
  };
  var Q = `transform`;
  var $ = Q + `Origin`;
  var vr = function e12(t4, n4) {
    var r4 = this, i4 = this.target, a5 = i4.style, o4 = i4._gsap;
    if (t4 in Xn && a5) {
    ...
    (a5 || n4) && this.props.push(t4, n4, a5[t4]);
  };
  var yr = function(e20) {
    e20.translate && (e20.removeProperty(`translate`), e20.removeProperty(`scale`), e20.removeProperty(`rotate`));
  };
  var br = function() {
    var e20 = this.props, t4 = this.target, n4 = t4.style, r4 = t4._gsap, i4, a5;
    ...
    if (this.tfm) {
      for (a5 in this.tfm) r4[a5] = this.tfm[a5];
  ...
  var Nr = function(e20, t4, n4, r4, i4, a5) {
    var o4 = new X(e20._pt, t4, n4, 0, 1, a5 ? dr : ur);
  ...
  var Ir = function e14(t4, n4, r4, i4) {
    var a5 = parseFloat(r4) || 0, o4 = (r4 + ``).trim().substr((a5 + ``).length) || `px`, s4 = Kn.style, c4 = nr.test(n4), l4 = t4.tagName.toLowerCase() === `svg`, u4 = (l4 ? `client` : `offset`) + (c4 ? `Width` : `Height`), d4 = 100, f4 = i4 === `px`, p4 = i4 === `%`, m4, h4, g4, _4;
    if (i4 === o4 || !a5 || Pr[i4] || Pr[o4]) return a5;
    if (o4 !== `px` && !f4 && (a5 = e14(t4, n4, r4, `px`)), _4 = t4.getCTM && jr(t4), (p4 || o4 === `%`) && (Xn[n4] || ~n4.indexOf(`adius`))) return m4 = _4 ? t4.getBBox()[c4 ? `width` : `height`] : t4[u4], U(p4 ? a5 / m4 * d4 : a5 / 100 * m4);
    if (s4[c4 ? `width` : `height`] = d4 + (f4 ? o4 : i4), h4 = i4 !== `rem` && ~n4.indexOf(`adius`) || i4 === `em` && t4.appendChild && !l4 ? t4 : t4.parentNode, _4 && (h4 = (t4.ownerSVGElement || {}).parentNode), (!h4 || h4 === Un || !h4.appendChild) && (h4 = Un.body), g4 = h4._gsap, g4 && p4 && g4.width && c4 && g4.time === Vt.time && !g4.uncache) return U(a5 / g4.width * d4);
    ...
    return c4 && p4 && (g4 = _e(h4), g4.time = Vt.time, g4.width = h4[u4]), U(f4 ? m4 * a5 / d4 : m4 && a5 ? d4 / m4 * a5 : 0);
  };
  ...
  var Rr = function(e20, t4, r4, i4) {
    if (!r4 || r4 === `none`) {
      var a5 = Er(t4, e20, 1), o4 = a5 && wr(e20, a5, 1);
      o4 && o4 !== r4 ? (t4 = a5, r4 = o4) : t4 === `borderColor` && (r4 = wr(e20, `borderTopColor`));
    }
  ...
  var Vr = function(e20, t4) {
    if (t4.tween && t4.tween._time === t4.tween._dur) {
      var n4 = t4.t, r4 = n4.style, i4 = t4.u, a5 = n4._gsap, o4, s4, c4;
      ...
      s4 && (Mr(n4, Q), a5 && (a5.svg && n4.removeAttribute(`transform`), r4.scale = r4.rotate = r4.translate = `none`, Yr(n4, 1), a5.uncache = 1, yr(r4)));
    }
  };
  var Hr = { clearProps: function(e20, t4, n4, r4, i4) {
    if (i4.data !== `isFromStart`) {
      var a5 = e20._pt = new X(e20._pt, t4, n4, 0, 0, Vr);
      return a5.u = r4, a5.pr = -10, a5.tween = i4, e20._props.push(n4), 1;
    }
  } };
  var Ur = [1, 0, 0, 1, 0, 0];
  var Wr = {};
  ...
  var qr = function(e20, t4) {
    var n4 = e20._gsap || _e(e20), r4 = e20.style, i4 = Kr(e20), a5, o4, s4, c4;
    return n4.svg && e20.getAttribute(`transform`) ? (s4 = e20.transform.baseVal.consolidate().matrix, i4 = [s4.a, s4.b, s4.c, s4.d, s4.e, s4.f], i4.join(`,`) === `1,0,0,1,0,0` ? Ur : i4) : (i4 === Ur && !e20.offsetParent && e20 !== Wn && !n4.svg && (s4 = r4.display, r4.display = `block`, a5 = e20.parentNode, (!a5 || !e20.offsetParent && !e20.getBoundingClientRect().width) && (c4 = 1, o4 = e20.nextElementSibling, Wn.appendChild(e20)), i4 = Kr(e20), s4 ? r4.display = s4 : Mr(e20, `display`), c4 && (o4 ? a5.insertBefore(e20, o4) : a5 ? a5.appendChild(e20) : Wn.removeChild(e20))), t4 && i4.length > 6 ? [i4[0], i4[1], i4[4], i4[5], i4[12], i4[13]] : i4);
  };
  var Jr = function(e20, t4, n4, r4, i4, a5) {
    var o4 = e20._gsap, s4 = i4 || qr(e20, true), c4 = o4.xOrigin || 0, l4 = o4.yOrigin || 0, u4 = o4.xOffset || 0, d4 = o4.yOffset || 0, f4 = s4[0], p4 = s4[1], m4 = s4[2], h4 = s4[3], g4 = s4[4], _4 = s4[5], v4 = t4.split(` `), y4 = parseFloat(v4[0]) || 0, b4 = parseFloat(v4[1]) || 0, x4, S4, C4, w3;
    n4 ? s4 !== Ur && (S4 = f4 * h4 - p4 * m4) && (C4 = h4 / S4 * y4 + b4 * (-m4 / S4) + (m4 * _4 - h4 * g4) / S4, w3 = y4 * (-p4 / S4) + f4 / S4 * b4 - (f4 * _4 - p4 * g4) / S4, y4 = C4, b4 = w3) : (x4 = Ar(e20), y4 = x4.x + (~v4[0].indexOf(`%`) ? y4 / 100 * x4.width : y4), b4 = x4.y + (~(v4[1] || v4[0]).indexOf(`%`) ? b4 / 100 * x4.height : b4)), r4 || r4 !== false && o4.smooth ? (g4 = y4 - c4, _4 = b4 - l4, o4.xOffset = u4 + (g4 * f4 + _4 * m4) - g4, o4.yOffset = d4 + (g4 * p4 + _4 * h4) - _4) : o4.xOffset = o4.yOffset = 0, o4.xOrigin = y4, o4.yOrigin = b4, o4.smooth = !!r4, o4.origin = t4, o4.originIsAbsolute = !!n4, e20.style[$] = `0px 0px`, a5 && (Nr(a5, o4, `xOrigin`, c4, y4), Nr(a5, o4, `yOrigin`, l4, b4), Nr(a5, o4, `xOffset`, u4, o4.xOffset), Nr(a5, o4, `yOffset`, d4, o4.yOffset)), e20.setAttribute(`data-svg-origin`, y4 + ` ` + b4);
  };
  var Yr = function(e20, t4) {
    var r4 = e20._gsap || new en(e20);
    if (`x` in r4 && !t4 && !r4.uncache) return r4;
    var i4 = e20.style, a5 = r4.scaleX < 0, o4 = `px`, s4 = `deg`, c4 = getComputedStyle(e20), l4 = wr(e20, $) || `0`, u4 = d4 = f4 = h4 = g4 = _4 = v4 = y4 = b4 = 0, d4, f4, p4 = m4 = 1, m4, h4, g4, _4, v4, y4, b4, x4, S4, C4, w3, T3, E3, D3, O3, k3, A3, j3, M3, N3, P3, F3, I3, L3, R3, z3, B3, ee3;
    return r4.svg = !!(e20.getCTM && jr(e20)), c4.translate && ((c4.translate !== `none` || c4.scale !== `none` || c4.rotate !== `none`) && (i4[Q] = (c4.translate === `none` ? `` : `translate3d(` + (c4.translate + ` 0 0`).split(` `).slice(0, 3).join(`, `) + `) `) + (c4.rotate === `none` ? `` : `rotate(` + c4.rotate + `) `) + (c4.scale === `none` ? `` : `scale(` + c4.scale.split(` `).join(`,`) + `) `) + (c4[Q] === `none` ? `` : c4[Q])), i4.scale = i4.rotate = i4.translate = `none`), C4 = qr(e20, r4.svg), r4.svg && (r4.uncache ? (P3 = e20.getBBox(), l4 = r4.xOrigin - P3.x + `px ` + (r4.yOrigin - P3.y) + `px`, N3 = ``) : N3 = !t4 && e20.getAttribute(`data-svg-origin`), Jr(e20, N3 || l4, !!N3 || r4.originIsAbsolute, r4.smooth !== false, C4)), x4 = r4.xOrigin || 0, S4 = r4.yOrigin || 0, C4 !== Ur && (D3 = C4[0], O3 = C4[1], k3 = C4[2], A3 = C4[3], u4 = j3 = C4[4], d4 = M3 = C4[5], C4.length === 6 ? (p4 = Math.sqrt(D3 * D3 + O3 * O3), m4 = Math.sqrt(A3 * A3 + k3 * k3), h4 = D3 || O3 ? $n(O3, D3) * Zn : 0, v4 = k3 || A3 ? $n(k3, A3) * Zn + h4 : 0, v4 && (m4 *= Math.abs(Math.cos(v4 * Qn))), r4.svg && (u4 -= x4 - (x4 * D3 + S4 * k3), d4 -= S4 - (x4 * O3 + S4 * A3))) : (ee3 = C4[6], z3 = C4[7], I3 = C4[8], L3 = C4[9], R3 = C4[10], B3 = C4[11], u4 = C4[12], d4 = C4[13], f4 = C4[14], w3 = $n(ee3, R3), g4 = w3 * Zn, w3 && (T3 = Math.cos(-w3), E3 = Math.sin(-w3), N3 = j3 * T3 + I3 * E3, P3 = M3 * T3 + L3 * E3, F3 = ee3 * T3 + R3 * E3, I3 = j3 * -E3 + I3 * T3, L3 = M3 * -E3 + L3 * T3, R3 = ee3 * -E3 + R3 * T3, B3 = z3 * -E3 + B3 * T3, j3 = N3, M3 = P3, ee3 = F3), w3 = $n(-k3, R3), _4 = w3 * Zn, w3 && (T3 = Math.cos(-w3), E3 = Math.sin(-w3), N3 = D3 * T3 - I3 * E3, P3 = O3 * T3 - L3 * E3, F3 = k3 * T3 - R3 * E3, B3 = A3 * E3 + B3 * T3, D3 = N3, O3 = P3, k3 = F3), w3 = $n(O3, D3), h4 = w3 * Zn, w3 && (T3 = Math.cos(w3), E3 = Math.sin(w3), N3 = D3 * T3 + O3 * E3, P3 = j3 * T3 + M3 * E3, O3 = O3 * T3 - D3 * E3, M3 = M3 * T3 - j3 * E3, D3 = N3, j3 = P3), g4 && Math.abs(g4) + Math.abs(h4) > 359.9 && (g4 = h4 = 0, _4 = 180 - _4), p4 = U(Math.sqrt(D3 * D3 + O3 * O3 + k3 * k3)), m4 = U(Math.sqrt(M3 * M3 + ee3 * ee3)), w3 = $n(j3, M3), v4 = Math.abs(w3) > 2e-4 ? w3 * Zn : 0, b4 = B3 ? 1 / (B3 < 0 ? -B3 : B3) : 0), r4.svg && (N3 = e20.getAttribute(`transform`), r4.forceCSS = e20.setAttribute(`transform`, ``) || !Gr(wr(e20, Q)), N3 && e20.setAttribute(`transform`, N3))), Math.abs(v4) > 90 && Math.abs(v4) < 270 && (a5 ? (p4 *= -1, v4 += h4 <= 0 ? 180 : -180, h4 += h4 <= 0 ? 180 : -180) : (m4 *= -1, v4 += v4 <= 0 ? 180 : -180)), t4 || (t4 = r4.uncache), r4.x = u4 - ((r4.xPercent = u4 && (!t4 && r4.xPercent || (Math.round(e20.offsetWidth / 2) === Math.round(-u4) ? -50 : 0))) ? e20.offsetWidth * r4.xPercent / 100 : 0) + o4, r4.y = d4 - ((r4.yPercent = d4 && (!t4 && r4.yPercent || (Math.round(e20.offsetHeight / 2) === Math.round(-d4) ? -50 : 0))) ? e20.offsetHeight * r4.yPercent / 100 : 0) + o4, r4.z = f4 + o4, r4.scaleX = U(p4), r4.scaleY = U(m4), r4.rotation = U(h4) + s4, r4.rotationX = U(g4) + s4, r4.rotationY = U(_4) + s4, r4.skewX = v4 + s4, r4.skewY = y4 + s4, r4.transformPerspective = b4 + o4, (r4.zOrigin = parseFloat(l4.split(` `)[2]) || !t4 && r4.zOrigin || 0) && (i4[$] = Xr(l4)), r4.xOffset = r4.yOffset = 0, r4.force3D = n.force3D, r4.renderTransform = r4.svg ? ri : Sr ? ni : Qr, r4.uncache = 0, r4;
  };
  var Xr = function(e20) {
  ...
  var ni = function(e20, t4) {
    var n4 = t4 || this, r4 = n4.xPercent, i4 = n4.yPercent, a5 = n4.x, o4 = n4.y, s4 = n4.z, c4 = n4.rotation, l4 = n4.rotationY, u4 = n4.rotationX, d4 = n4.skewX, f4 = n4.skewY, p4 = n4.scaleX, m4 = n4.scaleY, h4 = n4.transformPerspective, g4 = n4.force3D, _4 = n4.target, v4 = n4.zOrigin, y4 = ``, b4 = g4 === `auto` && e20 && e20 !== 1 || g4 === true;
    if (v4 && (u4 !== $r || l4 !== $r)) {
      var x4 = parseFloat(l4) * Qn, S4 = Math.sin(x4), C4 = Math.cos(x4), w3;
      x4 = parseFloat(u4) * Qn, w3 = Math.cos(x4), a5 = Zr(_4, a5, S4 * w3 * -v4), o4 = Zr(_4, o4, -Math.sin(x4) * -v4), s4 = Zr(_4, s4, C4 * w3 * -v4 + v4);
    }
    h4 !== ei && (y4 += `perspective(` + h4 + ti), (r4 || i4) && (y4 += `translate(` + r4 + `%, ` + i4 + `%) `), (b4 || a5 !== ei || o4 !== ei || s4 !== ei) && (y4 += s4 !== ei || b4 ? `translate3d(` + a5 + `, ` + o4 + `, ` + s4 + `) ` : `translate(` + a5 + `, ` + o4 + ti), c4 !== $r && (y4 += `rotate(` + c4 + ti), l4 !== $r && (y4 += `rotateY(` + l4 + ti), u4 !== $r && (y4 += `rotateX(` + u4 + ti), (d4 !== $r || f4 !== $r) && (y4 += `skew(` + d4 + `, ` + f4 + ti), (p4 !== 1 || m4 !== 1) && (y4 += `scale(` + p4 + `, ` + m4 + ti), _4.style[Q] = y4 || `translate(0, 0)`;
  };
  var ri = function(e20, t4) {
    var n4 = t4 || this, r4 = n4.xPercent, i4 = n4.yPercent, a5 = n4.x, o4 = n4.y, s4 = n4.rotation, c4 = n4.skewX, l4 = n4.skewY, u4 = n4.scaleX, d4 = n4.scaleY, f4 = n4.target, p4 = n4.xOrigin, m4 = n4.yOrigin, h4 = n4.xOffset, g4 = n4.yOffset, _4 = n4.forceCSS, v4 = parseFloat(a5), y4 = parseFloat(o4), b4, x4, S4, C4, w3;
    s4 = parseFloat(s4), c4 = parseFloat(c4), l4 = parseFloat(l4), l4 && (l4 = parseFloat(l4), c4 += l4, s4 += l4), s4 || c4 ? (s4 *= Qn, c4 *= Qn, b4 = Math.cos(s4) * u4, x4 = Math.sin(s4) * u4, S4 = Math.sin(s4 - c4) * -d4, C4 = Math.cos(s4 - c4) * d4, c4 && (l4 *= Qn, w3 = Math.tan(c4 - l4), w3 = Math.sqrt(1 + w3 * w3), S4 *= w3, C4 *= w3, l4 && (w3 = Math.tan(l4), w3 = Math.sqrt(1 + w3 * w3), b4 *= w3, x4 *= w3)), b4 = U(b4), x4 = U(x4), S4 = U(S4), C4 = U(C4)) : (b4 = u4, C4 = d4, x4 = S4 = 0), (v4 && !~(a5 + ``).indexOf(`px`) || y4 && !~(o4 + ``).indexOf(`px`)) && (v4 = Ir(f4, `x`, a5, `px`), y4 = Ir(f4, `y`, o4, `px`)), (p4 || m4 || h4 || g4) && (v4 = U(v4 + p4 - (p4 * b4 + m4 * S4) + h4), y4 = U(y4 + m4 - (p4 * x4 + m4 * C4) + g4)), (r4 || i4) && (w3 = f4.getBBox(), v4 = U(v4 + r4 / 100 * w3.width), y4 = U(y4 + i4 / 100 * w3.height)), w3 = `matrix(` + b4 + `,` + x4 + `,` + S4 + `,` + C4 + `,` + v4 + `,` + y4 + `)`, f4.setAttribute(`transform`, w3), _4 && (f4.style[Q] = w3);
  };
  var ii = function(e20, t4, n4, r4, i4) {
    var a5 = 360, o4 = h(i4), s4 = parseFloat(i4) * (o4 && ~i4.indexOf(`rad`) ? Zn : 1) - r4, c4 = r4 + s4 + `deg`, l4, u4;
    return o4 && (l4 = i4.split(`_`)[1], l4 === `short` && (s4 %= a5, s4 !== s4 % (a5 / 2) && (s4 += s4 < 0 ? a5 : -a5)), l4 === `cw` && s4 < 0 ? s4 = (s4 + a5 * er) % a5 - ~~(s4 / a5) * a5 : l4 === `ccw` && s4 > 0 && (s4 = (s4 - a5 * er) % a5 - ~~(s4 / a5) * a5)), e20._pt = u4 = new X(e20._pt, t4, n4, r4, s4, or), u4.e = c4, u4.u = `deg`, e20._props.push(n4), u4;
  };
  ...
  var oi = function(e20, t4, n4) {
    var r4 = ai({}, n4._gsap), i4 = `perspective,force3D,transformOrigin,svgOrigin`, a5 = n4.style, o4, s4, c4, l4, u4, d4, f4, p4;
    for (s4 in r4.svg ? (c4 = n4.getAttribute(`transform`), n4.setAttribute(`transform`, ``), a5[Q] = t4, o4 = Yr(n4, 1), Mr(n4, Q), n4.setAttribute(`transform`, c4)) : (c4 = getComputedStyle(n4)[Q], a5[Q] = t4, o4 = Yr(n4, 1), a5[Q] = c4), Xn) c4 = r4[s4], l4 = o4[s4], c4 !== l4 && i4.indexOf(s4) < 0 && (f4 = G(c4), p4 = G(l4), u4 = f4 === p4 ? parseFloat(c4) : Ir(n4, s4, c4, p4), d4 = parseFloat(l4), e20._pt = new X(e20._pt, o4, s4, u4, d4 - u4, ar), e20._pt.u = p4 || 0, e20._props.push(s4));
    ai(o4, r4);
  };
  H(`padding,margin,Width,Radius`, function(e20, t4) {
    var n4 = `Top`, r4 = `Right`, i4 = `Bottom`, a5 = `Left`, o4 = (t4 < 3 ? [n4, r4, i4, a5] : [n4 + a5, n4 + r4, i4 + r4, i4 + a5]).map(function(n5) {
      return t4 < 2 ? e20 + n5 : `border` + n5 + e20;
    });
    Hr[t4 > 1 ? `border` + e20 : e20] = function(e21, t5, n5, r5, i5) {
      var a6, s4;
      if (arguments.length < 4) return a6 = o4.map(function(t6) {
        return Lr(e21, t6, n5);
      }), s4 = a6.join(` `), s4.split(a6[0]).length === 5 ? a6[0] : s4;
      a6 = (r5 + ``).split(` `), s4 = {}, o4.forEach(function(e22, t6) {
        return s4[e22] = a6[t6] = a6[t6] || a6[(t6 - 1) / 2 | 0];
      }), e21.init(t5, s4, i5);
    };
  });
  var si = { name: `css`, register: Dr, targetTest: function(e20) {
    return e20.style && e20.nodeType;
  }, init: function(e20, t4, r4, i4, a5) {
    var o4 = this._props, s4 = e20.style, c4 = r4.vars.startAt, l4, u4, d4, f4, p4, m4, g4, _4, v4, y4, b4, x4, S4, C4, w3, T3, E3;
    for (g4 in Gn || Dr(), this.styles = this.styles || xr(e20), T3 = this.styles.props, this.tween = r4, t4) if (g4 !== `autoRound` && (u4 = t4[g4], !(V[g4] && on(g4, t4, r4, i4, e20, a5)))) {
      if (p4 = typeof u4, m4 = Hr[g4], p4 === `function` && (u4 = u4.call(r4, i4, e20, a5), p4 = typeof u4), p4 === `string` && ~u4.indexOf(`random(`) && (u4 = Ct(u4)), m4) m4(this, e20, g4, u4, r4) && (w3 = 1);
      else if (g4.substr(0, 2) === `--`) l4 = (getComputedStyle(e20).getPropertyValue(g4) + ``).trim(), u4 += ``, Lt.lastIndex = 0, Lt.test(l4) || (_4 = G(l4), v4 = G(u4), v4 ? _4 !== v4 && (l4 = Ir(e20, g4, l4, v4) + v4) : _4 && (u4 += _4)), this.add(s4, `setProperty`, l4, u4, i4, a5, 0, 0, g4), o4.push(g4), T3.push(g4, 0, s4[g4]);
      else if (p4 !== `undefined`) {
        if (c4 && g4 in c4 ? (l4 = typeof c4[g4] == `function` ? c4[g4].call(r4, i4, e20, a5) : c4[g4], h(l4) && ~l4.indexOf(`random(`) && (l4 = Ct(l4)), G(l4 + ``) || l4 === `auto` || (l4 += n.units[g4] || G(Lr(e20, g4)) || ``), (l4 + ``).charAt(1) === `=` && (l4 = Lr(e20, g4))) : l4 = Lr(e20, g4), f4 = parseFloat(l4), y4 = p4 === `string` && u4.charAt(1) === `=` && u4.substr(0, 2), y4 && (u4 = u4.substr(2)), d4 = parseFloat(u4), g4 in ir && (g4 === `autoAlpha` && (f4 === 1 && Lr(e20, `visibility`) === `hidden` && d4 && (f4 = 0), T3.push(`visibility`, 0, s4.visibility), Nr(this, s4, `visibility`, f4 ? `inherit` : `hidden`, d4 ? `inherit` : `hidden`, !d4)), g4 !== `scale` && g4 !== `transform` && (g4 = ir[g4], ~g4.indexOf(`,`) && (g4 = g4.split(`,`)[0]))), b4 = g4 in Xn, b4) {
          ...
          if (x4 || (S4 = e20._gsap, S4.renderTransform && !t4.parseTransform || Yr(e20, t4.parseTransform), C4 = t4.smoothOrigin !== false && S4.smooth, x4 = this._pt = new X(this._pt, s4, Q, 0, 1, S4.renderTransform, S4, 0, -1), x4.dep = 1), g4 === `scale`) this._pt = new X(this._pt, S4, `scaleY`, S4.scaleY, (y4 ? ye(S4.scaleY, y4 + d4) : d4) - S4.scaleY || 0, ar), this._pt.u = 0, o4.push(`scaleY`, g4), g4 += `X`;
          else if (g4 === `transformOrigin`) {
            T3.push($, 0, s4[$]), u4 = Br(u4), S4.svg ? Jr(e20, u4, 0, C4, 0, this) : (v4 = parseFloat(u4.split(` `)[2]) || 0, v4 !== S4.zOrigin && Nr(this, S4, `zOrigin`, S4.zOrigin, v4), Nr(this, s4, g4, Xr(l4), Xr(u4)));
            continue;
          } else if (g4 === `svgOrigin`) {
            Jr(e20, u4, 1, C4, 0, this);
            continue;
          } else if (g4 in Wr) {
            ii(this, S4, g4, f4, y4 ? ye(f4, y4 + u4) : u4);
            continue;
          } else if (g4 === `smoothOrigin`) {
            Nr(this, S4, `smooth`, S4.smooth, u4);
            continue;
          } else if (g4 === `force3D`) {
            S4[g4] = u4;
            continue;
        ...
        if (b4 || (d4 || d4 === 0) && (f4 || f4 === 0) && !rr.test(u4) && g4 in s4) _4 = (l4 + ``).substr((f4 + ``).length), d4 || (d4 = 0), v4 = G(u4) || (g4 in n.units ? n.units[g4] : _4), _4 !== v4 && (f4 = Ir(e20, g4, l4, v4)), this._pt = new X(this._pt, b4 ? S4 : s4, g4, f4, (y4 ? ye(f4, y4 + d4) : d4) - f4, !b4 && (v4 === `px` || g4 === `zIndex`) && t4.autoRound !== false ? lr : ar), this._pt.u = v4 || 0, b4 && E3 !== u4 ? (this._pt.b = l4, this._pt.e = E3, this._pt.r = cr) : _4 !== v4 && v4 !== `%` && (this._pt.b = l4, this._pt.r = sr);
        else if (g4 in s4) Rr.call(this, e20, g4, l4, y4 ? y4 + u4 : u4);
        else if (g4 in e20) this.add(e20, g4, l4 || e20[g4], y4 ? y4 + u4 : u4, i4, a5);
  ...
  Z.utils.checkPrefix = Er, Z.core.getStyleSaver = xr, (function(e20, t4, r4, i4) {
    var a5 = H(e20 + `,` + t4 + `,` + r4, function(e21) {
      Xn[e21] = 1;
    });
    H(t4, function(e21) {
      n.units[e21] = `deg`, Wr[e21] = 1;
    }), ir[a5[13]] = e20 + `,` + t4, H(i4, function(e21) {
      var t5 = e21.split(`:`);
      ir[t5[1]] = a5[t5[0]];
    });
  ...
  var A2 = function(e20, t4) {
    var n4 = function n5(r4) {
      if (r4 || r4 === 0) {
        ...
        var a5 = f2 && f2.isPressed;
        r4 = n5.v = Math.round(r4) || (f2 && f2.iOS ? 1 : 0), e20(r4), n5.cacheID = v2.cache, a5 && x2(`ss`, r4);
  ...
  var ae2 = function(e20, t4, n4) {
    var r4 = e20, i4 = e20, a5 = b2(), o4 = a5, s4 = t4 || 50, c4 = Math.max(500, s4 * 3), l4 = function(e21, t5) {
      var c5 = b2();
      t5 || c5 - a5 > s4 ? (i4 = r4, r4 = e21, o4 = a5, a5 = c5) : n4 ? r4 += e21 : r4 = i4 + (e21 - i4) / (c5 - o4) * (a5 - o4);
    };
    return { update: l4, reset: function() {
      i4 = r4 = n4 ? 0 : r4, o4 = a5 = 0;
    }, getVelocity: function(e21) {
      var t5 = o4, s5 = i4, u4 = b2();
      return (e21 || e21 === 0) && e21 !== r4 && l4(e21), a5 === o4 || u4 - o4 > c4 ? 0 : (r4 + (n4 ? s5 : -s5)) / ((n4 ? u4 : a5) - t5) * 1e3;
    } };
  };
  ...
  var j2 = (function() {
    ...
    return d4.init = function(e21) {
      ...
      var W3, De3, Oe3, ke3, Ae3, je3, G3, K3 = this, Me3 = 0, Ne3 = 0, Pe3 = e21.passive || !x4 && e21.passive !== false, Fe3 = ie2(g4, ee2), q3 = ie2(g4, te2), Ie3 = Fe3(), Le3 = q3(), Re3 = ~h4.indexOf(`touch`) && !~h4.indexOf(`pointer`) && p2[0] === `pointerdown`, ze3 = w2(g4), J3 = g4.ownerDocument || a2, Y3 = [0, 0, 0], Be3 = [0, 0, 0], Ve3 = 0, He3 = function() {
        ...
        K3._vx.reset(), K3._vy.reset(), De3.pause(), S4 && S4(K3);
      }, Ge3 = function() {
        ...
        if (!Ue3(e22, 1)) {
          e22 = oe2(e22, x4);
          var t5 = e22.clientX, n4 = e22.clientY, r4 = t5 - K3.x, i4 = n4 - K3.y, a5 = K3.isDragging;
          K3.x = t5, K3.y = n4, (a5 || (r4 || i4) && (Math.abs(K3.startX - t5) >= d5 || Math.abs(K3.startY - n4) >= d5)) && (Oe3 || (Oe3 = a5 ? 2 : 1), a5 || (K3.isDragging = true), qe3(r4, i4));
        }
        ...
        if (!Ue3(e22, 1)) {
          ...
          var t5 = !isNaN(K3.y - K3.startY), r4 = K3.isDragging, a5 = r4 && (Math.abs(K3.x - K3.startX) > 3 || Math.abs(K3.y - K3.startY) > 3), o4 = oe2(e22);
          !a5 && t5 && (K3._vx.reset(), K3._vy.reset(), x4 && U3 && n2.delayedCall(0.08, function() {
          ...
          })), K3.isDragging = K3.isGesturing = K3.isPressed = false, S4 && r4 && !R3 && De3.restart(true), Oe3 && Ge3(), M3 && r4 && M3(K3), P3 && P3(K3, a5);
        }
      }, Ze3 = function(e22) {
        ...
        if (!Ue3(e22)) {
          var t5 = Fe3(), n4 = q3();
          Ke3((t5 - Ie3) * we3, (n4 - Le3) * we3, 1), Ie3 = t5, Le3 = n4, S4 && De3.restart(true);
        }
      }, et3 = function(e22) {
        if (!Ue3(e22)) {
          e22 = oe2(e22, x4), Se3 && (Ae3 = true);
          var t5 = (e22.deltaMode === 1 ? v4 : e22.deltaMode === 2 ? i2.innerHeight : 1) * O3;
          Ke3(e22.deltaX * t5, e22.deltaY * t5, 0), S4 && !R3 && De3.restart(true);
        }
      }, tt3 = function(e22) {
        if (!Ue3(e22)) {
          var t5 = e22.clientX, n4 = e22.clientY, r4 = t5 - K3.x, i4 = n4 - K3.y;
          K3.x = t5, K3.y = n4, ke3 = true, S4 && De3.restart(true), (r4 || i4) && qe3(r4, i4);
        }
      }, nt3 = function(e22) {
        K3.event = e22, ve3(K3);
      }, rt3 = function(e22) {
      ...
      De3 = K3._dc = n2.delayedCall(C4 || 0.25, We3).pause(), K3.deltaX = K3.deltaY = 0, K3._vx = ae2(0, 50, true), K3._vy = ae2(0, 50, true), K3.scrollX = Fe3, K3.scrollY = q3, K3.isDragging = K3.isGesturing = K3.isPressed = false, m2(this), K3.enable = function(e22) {
  ...
  var Ue2 = function(e20, t4, n4) {
    var r4 = n4.d, i4 = n4.d2, a5 = n4.a;
    return (a5 = C2(e20, `getBoundingClientRect`)) ? function() {
      return a5()[r4];
    } : function() {
  ...
  var Ge2 = function(e20, t4) {
    var n4 = t4.s, r4 = t4.d2, i4 = t4.d, a5 = t4.a;
    return Math.max(0, (n4 = `scroll` + r4) && (a5 = C2(e20, n4)) ? a5() - He2(e20)()[i4] : Be2(e20) ? (de2[n4] || F2[n4]) - Ve2(r4) : e20[n4] - e20[`offset` + r4]);
  };
  ...
  var xt2 = function(e20) {
    ...
    return n4 ? function(e21, r4, i4) {
      ...
      if (!r4) return t4(e21);
      if (r4 > 0) {
        for (e21 -= i4, a5 = 0; a5 < n4.length; a5++) if (n4[a5] >= e21) return n4[a5];
        return n4[a5 - 1];
      } else for (a5 = n4.length, e21 += i4; a5--; ) if (n4[a5] <= e21) return n4[a5];
      return n4[0];
    } : function(n5, r4, i4) {
      i4 === void 0 && (i4 = 1e-3);
      var a5 = t4(n5);
      return !r4 || Math.abs(a5 - n5) < i4 || a5 - n5 < 0 == r4 < 0 ? a5 : t4(r4 < 0 ? n5 - e20 : n5 + e20);
    };
  };
  ...
  var jt2 = function(e20, t4, n4, r4, i4, a5, o4, s4) {
    ...
    return y4 += `position:` + ((h4 || s4) && m4 ? `fixed;` : `absolute;`), (h4 || s4 || !m4) && (y4 += (r4 === te2 ? nt2 : rt2) + `:` + (a5 + parseFloat(d4)) + `px;`), o4 && (y4 += `box-sizing:border-box;text-align:left;width:` + o4.offsetWidth + `px;`), p4._isStart = _4, p4.setAttribute(`class`, `gsap-marker-` + e20 + (t4 ? ` marker-` + t4 : ``)), p4.style.cssText = y4, p4.innerText = t4 || t4 === 0 ? e20 + `-` + t4 : e20, g4.children[0] ? g4.insertBefore(p4, g4.children[0]) : g4.appendChild(p4), p4._offset = p4[`offset` + r4.op.d2], Mt2(p4, 0, r4, _4), p4;
  };
  var Mt2 = function(e20, t4, n4, r4) {
    var i4 = { display: `block` }, a5 = n4[r4 ? `os2` : `p2`], o4 = n4[r4 ? `p2` : `os2`];
    e20._isFlipped = r4, i4[n4.a + `Percent`] = r4 ? -100 : 0, i4[n4.a] = r4 ? `1px` : 0, i4[`border` + a5 + dt2] = 1, i4[`border` + o4 + dt2] = 0, i4[n4.p] = t4 + `px`, M2.set(e20, i4);
  };
  var Z2 = [];
  var Nt2 = {};
  var Pt2;
  ...
  var cn2 = function(e20, t4, n4, r4) {
    if (!e20._gsap.swappedIn) {
      for (var i4 = an2.length, a5 = t4.style, o4 = e20.style, s4; i4--; ) s4 = an2[i4], a5[s4] = n4[s4];
      a5.position = n4.position === `absolute` ? `absolute` : `relative`, n4.display === `inline` && (a5.display = `inline-block`), o4[rt2] = o4[nt2] = `auto`, a5.flexBasis = n4.flexBasis || `auto`, a5.overflow = `visible`, a5.boxSizing = `border-box`, a5[it2] = vt2(e20, ee2) + pt2, a5[at2] = vt2(e20, te2) + pt2, a5[X2] = o4[ut2] = o4[tt2] = o4[et2] = `0`, un2(r4), o4[it2] = o4[`max` + dt2] = n4[it2], o4[at2] = o4[`max` + ft2] = n4[at2], o4[X2] = n4[X2], e20.parentNode !== t4 && (e20.parentNode.insertBefore(t4, e20), t4.appendChild(e20)), e20._gsap.swappedIn = true;
    }
  };
  var ln2 = /([A-Z])/g;
  var un2 = function(e20) {
    if (e20) {
      var t4 = e20.t.style, n4 = e20.length, r4 = 0, i4, a5;
      for ((e20.t._gsap || M2.core.getCache(e20.t)).uncache = 1; r4 < n4; r4 += 2) a5 = e20[r4 + 1], i4 = e20[r4], a5 ? t4[i4] = a5 : t4[i4] && t4.removeProperty(i4.replace(ln2, `-$1`).toLowerCase());
    }
  };
  ...
  var fn2 = function(e20, t4, n4) {
    for (var r4 = [], i4 = e20.length, a5 = n4 ? 8 : 0, o4; a5 < i4; a5 += 2) o4 = e20[a5], r4.push(o4, o4 in t4 ? t4[o4] : e20[a5 + 1]);
    return r4.t = e20.t, r4;
  };
  var pn2 = { left: 0, top: 0 };
  var mn2 = function(e20, t4, n4, r4, i4, a5, o4, s4, c4, l4, u4, d4, f4, p4) {
    ...
    if (f4 && f4.seek(0), isNaN(e20) || (e20 = +e20), Ye2(e20)) f4 && (e20 = M2.utils.mapRange(f4.scrollTrigger.start, f4.scrollTrigger.end, 0, d4, e20)), o4 && Mt2(o4, n4, r4, true);
      ...
      Je2(t4) && (t4 = t4(s4));
      var v4 = (e20 || `0`).split(` `), y4, b4, x4, S4;
      _4 = ne2(t4, s4) || F2, y4 = _t2(_4) || {}, (!y4 || !y4.left && !y4.top) && mt2(_4).display === `none` && (S4 = _4.style.display, _4.style.display = `block`, y4 = _t2(_4), S4 ? _4.style.display = S4 : _4.style.removeProperty(`display`)), b4 = At2(v4[0], y4[r4.d]), x4 = At2(v4[1] || `0`, n4), e20 = y4[r4.p] - c4[r4.p] - l4 + b4 + i4 - x4, o4 && Mt2(o4, x4, r4, n4 - x4 < 20 || o4._isStart && x4 > 20), n4 -= n4 - x4;
    }
    if (p4 && (s4[p4] = e20 || -1e-3, e20 < 0 && (e20 = 0)), a5) {
      var C4 = e20 + n4, w3 = a5._isStart;
      h4 = `scroll` + r4.d2, Mt2(a5, C4, r4, w3 && C4 > 20 || !w3 && (u4 ? Math.max(F2[h4], de2[h4]) : a5.parentNode[h4]) <= C4 + 1), u4 && (c4 = _t2(o4), u4 && (a5.style[r4.op.p] = c4[r4.op.p] - r4.op.m - a5._offset + pt2));
    }
  ...
  var gn2 = function(e20, t4, n4, r4) {
    if (e20.parentNode !== t4) {
      var i4 = e20.style, a5, o4;
      if (t4 === F2) {
        for (a5 in e20._stOrig = i4.cssText, o4 = mt2(e20), o4) !+a5 && !hn2.test(a5) && o4[a5] && typeof i4[a5] == `string` && a5 !== `0` && (i4[a5] = o4[a5]);
  ...
  var _n2 = function(e20, t4, n4) {
    var r4 = t4, i4 = r4;
    return function(t5) {
      var a5 = Math.round(e20());
      return a5 !== r4 && a5 !== i4 && Math.abs(a5 - r4) > 3 && Math.abs(a5 - i4) > 3 && (t5 = a5, n4 && n4()), i4 = r4, r4 = Math.round(t5), r4;
    };
  };
  ...
  var yn2 = function(e20, t4) {
    var n4 = ie2(e20, t4), r4 = `_scroll` + t4.p2, i4 = function t5(i5, a5, o4, s4, c4) {
      var l4 = t5.tween, u4 = a5.onComplete, d4 = {};
      o4 || (o4 = n4());
      var f4 = _n2(n4, o4, function() {
        l4.kill(), t5.tween = 0;
      });
      return c4 = s4 && c4 || 0, s4 || (s4 = i5 - o4), l4 && l4.kill(), a5[r4] = i5, a5.inherit = false, a5.modifiers = d4, d4[r4] = function() {
        return f4(o4 + s4 * l4.ratio + c4 * l4.ratio * l4.ratio);
      }, a5.onUpdate = function() {
        v2.cache++, t5.tween && rn2();
      }, a5.onComplete = function() {
        t5.tween = 0, u4 && u4.call(l4);
      }, l4 = t5.tween = M2.to(e20, a5), l4;
    };
  ...
  var $2 = (function() {
    ...
    return t4.init = function(t5, n4) {
      ...
      var r4 = t5, i4 = r4.onUpdate, a5 = r4.toggleClass, o4 = r4.id, s4 = r4.onToggle, c4 = r4.onRefresh, l4 = r4.scrub, u4 = r4.trigger, d4 = r4.pin, f4 = r4.pinSpacing, p4 = r4.invalidateOnRefresh, m4 = r4.anticipatePin, h4 = r4.onScrubComplete, g4 = r4.onSnapComplete, _4 = r4.once, b4 = r4.snap, x4 = r4.pinReparent, S4 = r4.pinSpacer, w3 = r4.containerAnimation, T3 = r4.fastScrollEnd, E3 = r4.preventOverlaps, D3 = t5.horizontal || t5.containerAnimation && t5.horizontal !== false ? ee2 : te2, O3 = !l4 && l4 !== 0, k3 = ne2(t5.scroller || N2), A3 = M2.core.getCache(k3), re3 = Be2(k3), ae3 = (`pinType` in t5 ? t5.pinType : C2(k3, `pinType`) || re3 && `fixed`) === `fixed`, oe3 = [t5.onEnter, t5.onLeave, t5.onEnterBack, t5.onLeaveBack], se3 = O3 && t5.toggleActions.split(` `), ce3 = `markers` in t5 ? t5.markers : Ot2.markers, le3 = re3 ? 0 : parseFloat(mt2(k3)[`border` + D3.p2 + dt2]) || 0, j3 = this, ue3 = t5.onRefreshInit && function() {
      ...
      if (j3._startClamp = j3._endClamp = false, j3._dir = D3, m4 *= 45, j3.scroller = k3, j3.scroll = w3 ? w3.time.bind(w3) : R3, Ce3 = R3(), j3.vars = t5, n4 || (n4 = t5.animation), `refreshPriority` in t5 && (xe2 = 1, t5.refreshPriority === -9999 && (nn2 = j3)), A3.tweenScroll = A3.tweenScroll || { top: yn2(k3, te2), left: yn2(k3, ee2) }, j3.tweenTo = z3 = A3.tweenScroll[D3.p], j3.scrubDuration = function(e21) {
        ...
        if ((t6 || Math.abs(j3.getVelocity()) < 10) && !r5 && !ve2 && ge3 !== e21) {
          var i5 = (e21 - H3) / q3, a6 = n4 && !O3 ? n4.totalProgress() : i5, o5 = t6 ? 0 : (a6 - Pt3) / (G2() - he2) * 1e3 || 0, s5 = M2.utils.clamp(-i5, 1 - i5, $e2(o5 / 2) * o5 / 0.185), c5 = i5 + (b4.inertia === false ? 0 : s5), l5, u5, d5 = b4, f5 = d5.onStart, p5 = d5.onInterrupt, m5 = d5.onComplete;
          if (l5 = V3(c5, j3), Ye2(l5) || (l5 = c5), u5 = Math.max(0, Math.round(H3 + l5 * q3)), e21 <= U3 && e21 >= H3 && u5 !== e21) {
            ...
            b4.inertia === false && (s5 = l5 - i5), z3(u5, { duration: Rt3($e2(Math.max($e2(c5 - a6), $e2(l5 - a6)) * 0.185 / o5 / 0.05 || 0)), ease: b4.ease || `power3`, data: $e2(u5 - e21), onInterrupt: function() {
      ...
      }).pause()), o4 && (Nt2[o4] = j3), u4 = j3.trigger = ne2(u4 || d4 !== true && d4), Wt3 = u4 && u4._gsap && u4._gsap.stRevert, Wt3 && (Wt3 = Wt3(j3)), d4 = d4 === true ? u4 : ne2(d4), qe2(a5) && (a5 = { targets: u4, className: a5 }), d4 && (f4 === false || f4 === ut2 || (f4 = !f4 && d4.parentNode && d4.parentNode.style && mt2(d4.parentNode).display === `flex` ? false : X2), j3.pin = d4, B3 = M2.core.getCache(d4), B3.spacer ? Ie3 = B3.pinState : (S4 && (S4 = ne2(S4), S4 && !S4.nodeType && (S4 = S4.current || S4.nativeElement), B3.spacerIsNative = !!S4, S4 && (B3.spacerState = dn2(S4))), B3.spacer = Y3 = S4 || P2.createElement(`div`), Y3.classList.add(`pin-spacer`), o4 && Y3.classList.add(`pin-spacer-` + o4), B3.pinState = Ie3 = dn2(d4)), t5.force3D !== false && M2.set(d4, { force3D: true }), j3.spacer = Y3 = B3.spacer, kt3 = mt2(d4), nt3 = kt3[f4 + D3.os2], He3 = M2.getProperty(d4), Ke3 = M2.quickSetter(d4, D3.a, pt2), cn2(d4, Y3, kt3), J3 = dn2(d4)), ce3) {
      ...
      if (j3.previous = function() {
      ...
      }, j3.refresh = function(r5, i5, a6, o5) {
        if (!((_e2 || !j3.enabled) && !i5)) {
          if (d4 && r5 && Me2) {
            wt2(e20, `scrollEnd`, Bt2);
            return;
          }
          !qt2 && ue3 && ue3(j3), _e2 = j3, z3.tween && !a6 && (z3.tween.kill(), z3.tween = 0), Q3 && Q3.pause(), p4 && n4 && (n4.revert({ kill: false }).invalidate(), n4.getChildren ? n4.getChildren(true, true, false).forEach(function(e21) {
          ...
          var s5 = fe3(), l5 = pe3(), m5 = w3 ? w3.duration() : Ge2(k3, D3), h5 = q3 <= 0.01 || !q3, g5 = 0, _5 = o5 || 0, v4 = Xe2(a6) ? a6.end : t5.end, y4 = t5.endTrigger || u4, b5 = Xe2(a6) ? a6.start : t5.start || (t5.start === 0 || !u4 ? 0 : d4 ? `0 0` : `0 100%`), S5 = j3.pinnedContainer = t5.pinnedContainer && ne2(t5.pinnedContainer, j3), C4 = u4 && Math.max(0, Z2.indexOf(j3)) || 0, T4 = C4, E4, A4, oe4, se4, N3, I3, me3, he3, ve3, L3, xe3, B4, V4;
          for (ce3 && Xe2(a6) && (B4 = M2.getProperty(W3, D3.p), V4 = M2.getProperty(De3, D3.p)); T4-- > 0; ) I3 = Z2[T4], I3.end || I3.refresh(0, 1) || (_e2 = j3), me3 = I3.pin, me3 && (me3 === u4 || me3 === d4 || me3 === S5) && !I3.isReverted && (L3 || (L3 = []), L3.unshift(I3), I3.revert(true, true)), I3 !== Z2[T4] && (C4--, T4--);
          for (Je2(b5) && (b5 = b5(j3)), b5 = Pe2(b5, `start`, j3), H3 = mn2(b5, u4, s5, D3, R3(), Te3, W3, j3, l5, le3, ae3, m5, w3, j3._startClamp && `_startClamp`) || (d4 ? -1e-3 : 0), Je2(v4) && (v4 = v4(j3)), qe2(v4) && !v4.indexOf(`+=`) && (~v4.indexOf(` `) ? v4 = (qe2(b5) ? b5.split(` `)[0] : ``) + v4 : (g5 = At2(v4.substr(2), s5), v4 = qe2(b5) ? b5 : (w3 ? M2.utils.mapRange(0, w3.duration(), w3.scrollTrigger.start, w3.scrollTrigger.end, H3) : H3) + g5, y4 = u4)), v4 = Pe2(v4, `end`, j3), U3 = Math.max(H3, mn2(v4 || (y4 ? `100% 0` : m5), y4, s5, D3, R3() + g5, Ee3, De3, j3, l5, le3, ae3, m5, w3, j3._endClamp && `_endClamp`)) || -1e-3, g5 = 0, T4 = C4; T4--; ) I3 = Z2[T4] || {}, me3 = I3.pin, me3 && I3.start - I3._pinPush <= H3 && !w3 && I3.end > 0 && (E4 = I3.end - (j3._startClamp ? Math.max(0, I3.start) : I3.start), (me3 === u4 && I3.start - I3._pinPush < H3 || me3 === S5) && isNaN(b5) && (g5 += E4 * (1 - I3.progress)), me3 === d4 && (_5 += E4));
          if (H3 += g5, U3 += g5, j3._startClamp && (j3._startClamp += g5), j3._endClamp && !qt2 && (j3._endClamp = U3 || -1e-3, U3 = Math.min(U3, Ge2(k3, D3))), q3 = U3 - H3 || (H3 -= 0.01) && 1e-3, h5 && (be3 = M2.utils.clamp(0, 1, M2.utils.normalize(H3, U3, Vt3))), j3._pinPush = _5, Te3 && g5 && (E4 = {}, E4[D3.a] = `+=` + g5, S5 && (E4[D3.p] = `-=` + R3()), M2.set([Te3, Ee3], E4)), d4 && !(ke2 && j3.end >= Ge2(k3, D3))) E4 = mt2(d4), se4 = D3 === te2, oe4 = R3(), et3 = parseFloat(He3(D3.a)) + _5, !m5 && U3 > 1 && (xe3 = (re3 ? P2.scrollingElement || de2 : k3).style, xe3 = { style: xe3, value: xe3[`overflow` + D3.a.toUpperCase()] }, re3 && mt2(F2)[`overflow` + D3.a.toUpperCase()] !== `scroll` && (xe3.style[`overflow` + D3.a.toUpperCase()] = `scroll`)), cn2(d4, Y3, E4), J3 = dn2(d4), A4 = _t2(d4, true), he3 = ae3 && ie2(k3, se4 ? ee2 : te2)(), f4 ? (rt3 = [f4 + D3.os2, q3 + _5 + pt2], rt3.t = Y3, T4 = f4 === X2 ? vt2(d4, D3) + q3 + _5 : 0, T4 && (rt3.push(D3.d, T4 + pt2), Y3.style.flexBasis !== `auto` && (Y3.style.flexBasis = T4 + pt2)), un2(rt3), S5 && Z2.forEach(function(e21) {
            e21.pin === S5 && e21.vars.pinSpacing !== false && (e21._subPinOffset = true);
        ...
        if (!(w3 && !r5 && !e21)) {
          var o5 = qt2 === true ? Vt3 : j3.scroll(), c5 = e21 ? 0 : (o5 - H3) / q3, u5 = c5 < 0 ? 0 : c5 > 1 ? 1 : c5 || 0, p5 = j3.progress, h5, g5, v4, y4, S5, C4, A4, ee3;
          if (t6 && (we3 = Ce3, Ce3 = w3 ? R3() : o5, b4 && (Pt3 = Mt3, Mt3 = n4 && !O3 ? n4.totalProgress() : u5)), m4 && d4 && !_e2 && !je2 && Me2 && (!u5 && H3 < o5 + (o5 - we3) / (G2() - he2) * m4 ? u5 = 1e-4 : u5 === 1 && U3 > o5 + (o5 - we3) / (G2() - he2) * m4 && (u5 = 0.9999)), u5 !== p5 && j3.enabled) {
            if (h5 = j3.isActive = !!u5 && u5 < 1, g5 = !!p5 && p5 < 1, C4 = h5 !== g5, S5 = C4 || !!u5 != !!p5, j3.direction = u5 > p5 ? 1 : -1, j3.progress = u5, S5 && !_e2 && (v4 = u5 && !p5 ? 0 : u5 === 1 ? 1 : p5 === 1 ? 2 : 3, O3 && (y4 = !C4 && se3[v4 + 1] !== `none` && se3[v4 + 1] || se3[v4], ee3 = n4 && (y4 === `complete` || y4 === `reset` || y4 in n4))), E3 && (C4 || ee3) && (ee3 || l4 || !n4) && (Je2(E3) ? E3(j3) : j3.getTrailing(E3).forEach(function(e22) {
            ...
            b4 && !z3.tween && !_e2 && !je2 && zt3.restart(true), a5 && (C4 || _4 && u5 && (u5 < 1 || !Ae2)) && I2(a5.targets).forEach(function(e22) {
              return e22.classList[h5 || _4 ? `add` : `remove`](a5.className);
            }), i4 && !O3 && !e21 && i4(j3), S5 && !_e2 ? (O3 && (ee3 && (y4 === `complete` ? n4.pause().totalProgress(1) : y4 === `reset` ? n4.restart(true).pause() : y4 === `restart` ? n4.restart(true) : n4[y4]()), i4 && i4(j3)), (C4 || !Ae2) && (s4 && C4 && Qe2(j3, s4), oe3[v4] && Qe2(j3, oe3[v4]), _4 && (u5 === 1 ? j3.kill(false, 1) : oe3[v4] = 0), C4 || (v4 = u5 === 1 ? 1 : 3, oe3[v4] && Qe2(j3, oe3[v4]))), T3 && !h5 && Math.abs(j3.getVelocity()) > (Ye2(T3) ? T3 : 2500) && (Ze2(j3.callbackAnimation), Q3 ? Q3.progress(1) : Ze2(n4, y4 === `reverse` ? 1 : !u5, 1))) : O3 && i4 && !_e2 && i4(j3);
          }
          if (Et3) {
        ...
        if (w3) {
          var i5 = w3.scrollTrigger, a6 = w3.duration(), o5 = i5.end - i5.start;
          e21 = i5.start + o5 * e21 / a6, t6 = i5.start + o5 * t6 / a6;
        }
      ...
      if (N2 = window, P2 = document, de2 = P2.documentElement, F2 = P2.body, M2) if (I2 = M2.utils.toArray, me2 = M2.utils.clamp, Te2 = M2.core.context || Re2, Se2 = M2.core.suppressOverwrites || Re2, Ee2 = N2.history.scrollRestoration || `auto`, en2 = N2.pageYOffset || 0, M2.core.globals(`ScrollTrigger`, e20), F2) {
        ...
        var t5 = F2.hasAttribute(`style`), n4 = F2.style, r4 = n4.borderTopStyle, i4 = M2.core.Animation.prototype, a5, o4;
        for (i4.revert || Object.defineProperty(i4, "revert", { value: function() {
          return this.time(-0.01, true);
        } }), n4.borderTopStyle = `solid`, a5 = _t2(F2), te2.m = Math.round(a5.top + te2.sc()) || 0, ee2.m = Math.round(a5.left + ee2.sc()) || 0, r4 ? n4.borderTopStyle = r4 : n4.removeProperty(`border-top-style`), t5 || (F2.setAttribute(`style`, ``), F2.removeAttribute(`style`)), ge2 = setInterval(Q2, 250), M2.delayedCall(0.5, function() {
          return je2 = 0;
      ...
      qe2(e21) && (e21 = ne2(e21));
      var r4 = e21.getBoundingClientRect(), i4 = r4[n4 ? it2 : at2], a5 = t5 == null ? i4 / 2 : t5 in kt2 ? kt2[t5] * i4 : ~t5.indexOf(`%`) ? parseFloat(t5) * i4 / 100 : parseFloat(t5) || 0;
      return n4 ? (r4.left + a5) / N2.innerWidth : (r4.top + a5) / N2.innerHeight;
  ...
  $2.version = `3.15.0`, $2.saveStyles = function(e20) {
    ...
    var n4 = [], r4 = {}, i4 = t4.interval || 0.016, a5 = t4.batchMax || 1e9, o4 = function(e21, t5) {
      var n5 = [], r5 = [], o5 = M2.delayedCall(i4, function() {
        t5(n5, r5), n5 = [], r5 = [];
      }).pause();
      return function(e22) {
        n5.length || o5.restart(true), n5.push(e22.trigger), r5.push(e22), a5 <= n5.length && o5.progress(1);
      };
    }, s4;
    for (s4 in t4) r4[s4] = s4.substr(0, 2) === `on` && Je2(t4[s4]) && s4 !== `onRefreshInit` ? o4(s4, t4[s4]) : t4[s4];
    return Je2(a5) && (a5 = a5(), wt2($2, `refresh`, function() {
      return a5 = t4.batchMax();
  ...
  var Cn2 = function(e20) {
    var t4 = e20.event, n4 = e20.target, r4 = e20.axis, i4 = (t4.changedTouches ? t4.changedTouches[0] : t4).target, a5 = i4._gsap || M2.core.getCache(i4), o4 = G2(), s4;
    if (!a5._isScrollT || o4 - a5._isScrollT > 2e3) {
      ...
      a5._isScroll = i4 && i4 !== n4 && !Be2(i4) && (Sn2[(s4 = mt2(i4)).overflowY] || Sn2[s4.overflowX]), a5._isScrollT = o4;
    }
    (a5._isScroll || r4 === `x`) && (t4.stopPropagation(), t4._gsapAllow = true);
  };
  ...
  var On2 = function(e20) {
    ...
    return d4 && M2.set(d4, { y: `+=0` }), e20.ignoreCheck = function(e21) {
      ...
      if (f4.offset && E3(), !t5) re3.restart(true);
        ...
        v2.cache++;
        var r5 = _4(), i5, o5;
        n4 && (i5 = p4(), o5 = i5 + r5 * 0.05 * -e21.velocityX / 0.227, r5 *= bn2(p4, i5, o5, Ge2(c4, ee2)), O3.vars.scrollX = C4(o5)), i5 = f4(), o5 = i5 + r5 * 0.05 * -e21.velocityY / 0.227, r5 *= bn2(f4, i5, o5, Ge2(c4, te2)), O3.vars.scrollY = w3(o5), O3.invalidate().duration(r5).play(0.01), (U2 && O3.vars.scrollY >= s4 || i5 >= s4 - 1) && M2.to({}, { onUpdate: ae3, duration: r5 });
      }
      a5 && a5(e21);
    }, e20.onWheel = function() {
      O3._ts && O3.pause(), G2() - g4 > 1e3 && (y4 = 0, g4 = G2());
    }, e20.onChange = function(e21, t5, r5, i5, a6) {
      if (Jt2 !== y4 && T3(), t5 && n4 && p4(C4(i5[2] === t5 ? k3 + (e21.startX - e21.x) : p4() + t5 - i5[1])), r5) {
        f4.offset && E3();
        var o5 = a6[2] === r5, s5 = o5 ? A3 + e21.startY - e21.y : f4() + r5 - a6[1], c5 = w3(s5);
  ...
  var e19;
  var t3;
  var n3 = typeof Symbol == `function` ? /* @__PURE__ */ Symbol() : `_split`;
  var r3;
  var i3 = () => r3 || C3.register(window.gsap);
  var a3 = typeof Intl < `u` && `Segmenter` in Intl ? new Intl.Segmenter() : 0;
  var o3 = (e20) => e20 ? typeof e20 == `string` ? o3(document.querySelectorAll(e20)) : `length` in e20 ? Array.from(e20).reduce((e21, t4) => (typeof t4 == `string` ? e21.push(...o3(t4)) : e21.push(t4), e21), []) : [e20] : [];
  var s3 = (e20) => o3(e20).filter((e21) => e21 && e21.nodeType === 1);
  var c3 = [];
  var l3 = function() {
  };
  var u3 = { add: (e20) => e20() };
  var d3 = /\s+/g;
  var f3 = RegExp(`\\p{RI}\\p{RI}|\\p{Emoji}(\\p{EMod}|\\u{FE0F}\\u{20E3}?|[\\u{E0020}-\\u{E007E}]+\\u{E007F})?(\\u{200D}\\p{Emoji}(\\p{EMod}|\\u{FE0F}\\u{20E3}?|[\\u{E0020}-\\u{E007E}]+\\u{E007F})?)*|.`, `gu`);
  var p3 = { left: 0, top: 0, width: 0, height: 0 };
  var m3 = (e20, t4) => {
    for (; ++t4 < e20.length && e20[t4] === p3; ) ;
    return e20[t4] || p3;
  };
  var h3 = ({ element: e20, html: t4, ariaL: n4, ariaH: r4 }) => {
    e20.innerHTML = t4, n4 ? e20.setAttribute(`aria-label`, n4) : e20.removeAttribute(`aria-label`), r4 ? e20.setAttribute(`aria-hidden`, r4) : e20.removeAttribute(`aria-hidden`);
  };
  var g3 = (e20, t4) => {
    if (t4) {
      let n4 = new Set(e20.join(``).match(t4) || c3), r4 = e20.length, i4, a5, o4, s4;
      if (n4.size) for (; --r4 > -1; ) {
        a5 = e20[r4];
        for (o4 of n4) if (o4.startsWith(a5) && o4.length > a5.length) {
          for (i4 = 0, s4 = a5; o4.startsWith(s4 += e20[r4 + ++i4]) && s4.length < o4.length; ) ;
          if (i4 && s4.length === o4.length) {
            e20[r4] = o4, e20.splice(r4 + 1, i4);
            break;
          }
        }
      }
  ...
  var _3 = (e20) => window.getComputedStyle(e20).display === `inline` && (e20.style.display = `inline-block`);
  var v3 = (e20, t4, n4) => t4.insertBefore(typeof e20 == `string` ? document.createTextNode(e20) : e20, n4);
  var y3 = (e20, t4, n4) => {
    let r4 = t4[e20 + `sClass`] || ``, { tag: i4 = `div`, aria: a5 = `auto`, propIndex: o4 = false } = t4, s4 = e20 === `line` ? `block` : `inline-block`, c4 = r4.indexOf(`++`) > -1, l4 = (t5) => {
      let l5 = document.createElement(i4), u4 = n4.length + 1;
      return r4 && (l5.className = r4 + (c4 ? ` ` + r4 + u4 : ``)), o4 && l5.style.setProperty(`--` + e20, u4 + ``), a5 !== `none` && l5.setAttribute(`aria-hidden`, `true`), i4 !== `span` && (l5.style.position = `relative`, l5.style.display = s4), l5.textContent = t5, n4.push(l5), l5;
    };
    return c4 && (r4 = r4.replace(`++`, ``)), l4.collection = n4, l4;
  };
  var b3 = (e20, t4, n4, r4) => {
    let i4 = y3(`line`, n4, r4), a5 = window.getComputedStyle(e20).textAlign || `left`;
    return (n5, r5) => {
      let o4 = i4(``);
      for (o4.style.textAlign = a5, e20.insertBefore(o4, t4[n5]); n5 < r5; n5++) o4.appendChild(t4[n5]);
      o4.normalize();
    };
  };
  var x3 = (e20, t4, n4, r4, i4, o4, s4, l4, u4, f4) => {
    var p4;
    let m4 = Array.from(e20.childNodes), h4 = 0, { wordDelimiter: y4, reduceWhiteSpace: b4 = true, prepareText: S4 } = t4, C4 = e20.getBoundingClientRect(), w3 = C4, T3 = !b4 && window.getComputedStyle(e20).whiteSpace.substring(0, 3) === `pre`, E3 = 0, D3 = n4.collection, O3, k3, A3, j3, M3, N3, P3, F3, I3, L3, R3, z3, B3, V3, H3, U3, W3, G3;
    for (typeof y4 == `object` ? (A3 = y4.delimiter || y4, k3 = y4.replaceWith || ``) : k3 = y4 === `` ? `` : y4 || ` `, O3 = k3 !== ` `; h4 < m4.length; h4++) if (j3 = m4[h4], j3.nodeType === 3) {
      for (H3 = j3.textContent || ``, b4 ? H3 = H3.replace(d3, ` `) : T3 && (H3 = H3.replace(/\n/g, k3 + `
`)), S4 && (H3 = S4(H3, e20)), j3.textContent = H3, M3 = k3 || A3 ? H3.split(A3 || k3) : H3.match(l4) || c3, W3 = M3[M3.length - 1], F3 = O3 ? W3.slice(-1) === ` ` : !W3, W3 || M3.pop(), w3 = C4, P3 = O3 ? M3[0].charAt(0) === ` ` : !M3[0], P3 && v3(` `, e20, j3), M3[0] || M3.shift(), g3(M3, u4), o4 && f4 || (j3.textContent = ``), I3 = 1; I3 <= M3.length; I3++) if (U3 = M3[I3 - 1], !b4 && T3 && U3.charAt(0) === `
` && ((p4 = j3.previousSibling) == null || p4.remove(), v3(document.createElement(`br`), e20, j3), U3 = U3.slice(1)), !b4 && U3 === ``) v3(k3, e20, j3);
      else if (U3 === ` `) e20.insertBefore(document.createTextNode(` `), j3);
      else {
        if (O3 && U3.charAt(0) === ` ` && v3(` `, e20, j3), E3 && I3 === 1 && !P3 && D3.indexOf(E3.parentNode) > -1 ? (N3 = D3[D3.length - 1], N3.appendChild(document.createTextNode(r4 ? `` : U3))) : (N3 = n4(r4 ? `` : U3), v3(N3, e20, j3), E3 && I3 === 1 && !P3 && N3.insertBefore(E3, N3.firstChild)), r4) for (R3 = a3 ? g3([...a3.segment(U3)].map((e21) => e21.segment), u4) : U3.match(l4) || c3, G3 = 0; G3 < R3.length; G3++) N3.appendChild(R3[G3] === ` ` ? document.createTextNode(` `) : r4(R3[G3]));
        if (o4 && f4) {
          if (H3 = j3.textContent = H3.substring(U3.length + 1, H3.length), L3 = N3.getBoundingClientRect(), L3.top > w3.top && L3.left <= w3.left) {
            for (z3 = e20.cloneNode(), B3 = e20.childNodes[0]; B3 && B3 !== N3; ) V3 = B3, B3 = B3.nextSibling, z3.appendChild(V3);
            e20.parentNode.insertBefore(z3, e20), i4 && _3(z3);
          }
          w3 = L3;
        }
        (I3 < M3.length || F3) && v3(I3 >= M3.length ? ` ` : O3 && U3.slice(-1) === ` ` ? ` ` + k3 : k3, e20, j3);
      }
      e20.removeChild(j3), E3 = 0;
    } else j3.nodeType === 1 && (s4 && s4.indexOf(j3) > -1 ? (D3.indexOf(j3.previousSibling) > -1 && D3[D3.length - 1].appendChild(j3), E3 = j3) : (x3(j3, t4, n4, r4, i4, o4, s4, l4, u4, true), E3 = 0), i4 && _3(j3));
  };
  var S3 = class a4 {
    constructor(e20, t4) {
      this.isSplit = false, i3(), this.elements = s3(e20), this.chars = [], this.words = [], this.lines = [], this.masks = [], this.vars = t4, this.elements.forEach((e21) => {
        var r5;
        t4.overwrite !== false && ((r5 = e21[n3]) == null || r5._data.orig.filter(({ element: t5 }) => t5 === e21).forEach(h3)), e21[n3] = this;
      }), this._split = () => this.isSplit && this.split(this.vars);
      let r4 = [], a5, o4 = () => {
        let e21 = r4.length, t5;
        for (; e21--; ) {
          t5 = r4[e21];
          let n4 = t5.element.offsetWidth;
          if (n4 !== t5.width) {
            t5.width = n4, this._split();
            return;
          }
        }
      };
      this._data = { orig: r4, obs: typeof ResizeObserver < `u` && new ResizeObserver(() => {
        clearTimeout(a5), a5 = setTimeout(o4, 200);
      }) }, l3(this), this.split(t4);
    }
    split(e20) {
      return (this._ctx || u3).add(() => {
        this.isSplit && this.revert(), this.vars = e20 = e20 || this.vars || {};
        let { type: n4 = `chars,words,lines`, aria: r4 = `auto`, deepSlice: i4 = true, smartWrap: a5, onSplit: c4, autoSplit: l4 = false, specialChars: u4, mask: d4 } = this.vars, h4 = n4.indexOf(`lines`) > -1, g4 = n4.indexOf(`chars`) > -1, _4 = n4.indexOf(`words`) > -1, v4 = g4 && !_4 && !h4, S4 = u4 && (`push` in u4 ? RegExp(`(?:` + u4.join(`|`) + `)`, `gu`) : u4), C4 = S4 ? RegExp(S4.source + `|` + f3.source, `gu`) : f3, w3 = !!e20.ignore && s3(e20.ignore), { orig: T3, animTime: E3, obs: D3 } = this._data, O3;
        (g4 || _4 || h4) && (this.elements.forEach((t4, n5) => {
          T3[n5] = { element: t4, html: t4.innerHTML, ariaL: t4.getAttribute(`aria-label`), ariaH: t4.getAttribute(`aria-hidden`) }, r4 === `auto` ? t4.setAttribute(`aria-label`, (t4.textContent || ``).trim()) : r4 === `hidden` && t4.setAttribute(`aria-hidden`, `true`);
          let s4 = [], c5 = [], l5 = [], u5 = g4 ? y3(`char`, e20, s4) : null, d5 = y3(`word`, e20, c5), f4, E4, D4, O4;
          if (x3(t4, e20, d5, u5, v4, i4 && (h4 || v4), w3, C4, S4, false), h4) {
            let n6 = o3(t4.childNodes), r5 = b3(t4, n6, e20, l5), i5, a6 = [], s5 = 0, c6 = n6.map((e21) => e21.nodeType === 1 ? e21.getBoundingClientRect() : p3), u6 = p3, d6;
            for (f4 = 0; f4 < n6.length; f4++) i5 = n6[f4], i5.nodeType === 1 && (i5.nodeName === `BR` ? ((!f4 || n6[f4 - 1].nodeName !== `BR`) && (a6.push(i5), r5(s5, f4 + 1)), s5 = f4 + 1, u6 = m3(c6, f4)) : (d6 = c6[f4], f4 && d6.top > u6.top && d6.left < u6.left + u6.width - 1 && (r5(s5, f4), s5 = f4), u6 = d6));
            s5 < f4 && r5(s5, f4), a6.forEach((e21) => e21.parentNode?.removeChild(e21));
          }
          if (!_4) {
            for (f4 = 0; f4 < c5.length; f4++) if (E4 = c5[f4], g4 || !E4.nextSibling || E4.nextSibling.nodeType !== 3) if (a5 && !h4) {
              for (D4 = document.createElement(`span`), D4.style.whiteSpace = `nowrap`; E4.firstChild; ) D4.appendChild(E4.firstChild);
              E4.replaceWith(D4);
            } else E4.replaceWith(...E4.childNodes);
            else O4 = E4.nextSibling, O4 && O4.nodeType === 3 && (O4.textContent = (E4.textContent || ``) + (O4.textContent || ``), E4.remove());
            c5.length = 0, t4.normalize();
          }
          this.lines.push(...l5), this.words.push(...c5), this.chars.push(...s4);
        }), d4 && this[d4] && this.masks.push(...this[d4].map((e21) => {
          let t4 = e21.cloneNode();
          return e21.replaceWith(t4), t4.appendChild(e21), e21.className && (t4.className = e21.className.trim().split(` `).map((e22) => e22 + `-mask`).join(` `)), t4.style.overflow = `clip`, t4;
        }))), this.isSplit = true, t3 && h4 && l4 && t3.addEventListener(`loadingdone`, this._split), (O3 = c4 && c4(this)) && O3.totalTime && (this._data.anim = E3 ? O3.totalTime(E3) : O3), h4 && l4 && this.elements.forEach((e21, t4) => {
          T3[t4].width = e21.offsetWidth, D3 && D3.observe(e21);
        });
      }), this;
    }
    kill() {
      let { obs: e20 } = this._data;
      e20 && e20.disconnect(), t3?.removeEventListener(`loadingdone`, this._split);
    }
    revert() {
      var e20, t4;
      if (this.isSplit) {
        let { orig: n4, anim: r4 } = this._data;
        this.kill(), n4.forEach(h3), this.chars.length = this.words.length = this.lines.length = n4.length = this.masks.length = 0, this.isSplit = false, r4 && (this._data.animTime = r4.totalTime(), r4.revert()), (t4 = (e20 = this.vars).onRevert) == null || t4.call(e20, this);
      }
      return this;
    }
    static create(e20, t4) {
      return new a4(e20, t4);
    }
    static register(n4) {
      e19 = e19 || n4 || window.gsap, e19 && (o3 = e19.utils.toArray, l3 = e19.core.context || l3), !r3 && window.innerWidth > 0 && (t3 = document.fonts, r3 = true);
    }
  };
  S3.version = `3.15.0`;
  var C3 = S3;

  // public/shopify/plantilla99/assets/js/FeatureExplorerNew.astro_astro_type_script_index_0_lang.ItaQhKl5.js
  ci.registerPlugin($2, C3), document.addEventListener(`DOMContentLoaded`, () => {
    document.querySelectorAll(`[data-feature-explorer-section]`).forEach((t4) => {
      t4.querySelectorAll(`[data-feature-item]`).forEach((t5) => {
        let r4 = t5.querySelector(`[data-feature-title]`), i4 = t5.querySelector(`[data-feature-desc]`);
        !r4 || !i4 || setTimeout(() => {
          let t6 = new C3(i4, { type: `words, chars` });
          ci.set(t6.chars, { opacity: 0 }), ci.timeline({ scrollTrigger: { trigger: r4, start: `top 85%`, toggleActions: `play none none none` } }).to(t6.chars, { opacity: 1, stagger: 5e-3, duration: 0.1, ease: `power2.out` });
        }, 100);
      });
    });
  });
