...
(() => {
  ...
  // public/shopify/plantilla99/assets/js/Slider.astro_astro_type_script_index_0_lang.COD_D88F.js
  ci.registerPlugin(rt2), window.SliderHelper = class {
    constructor(e24) {
      __publicField(this, "container");
      __publicField(this, "track");
      __publicField(this, "itemCount");
      __publicField(this, "activeIndex");
      __publicField(this, "sliderWidth", 0);
      __publicField(this, "gap", 24);
      __publicField(this, "draggable", null);
      __publicField(this, "onIndexChangeCallbacks", []);
      __publicField(this, "onWidthChangeCallbacks", []);
      this.container = e24, this.track = e24.querySelector(`[data-track]`), this.itemCount = parseInt(e24.getAttribute(`data-item-count`) || `1`), this.activeIndex = parseInt(e24.getAttribute(`data-active-index`) || `0`), this.calculateWidth(), this.setupDraggable(), window.addEventListener(`resize`, () => {
        this.calculateWidth(), this.draggable && this.draggable.update();
      });
    }
    calculateWidth() {
      this.sliderWidth = this.container.getBoundingClientRect().width, this.track.style.setProperty(`--slider-width`, `${this.sliderWidth}px`);
      let e24 = window.getComputedStyle(this.track), t4 = e24.getPropertyValue(`--grid-gutter`);
      this.gap = t4 ? parseFloat(t4) || 24 : parseFloat(e24.gap) || 24, this.onWidthChangeCallbacks.forEach((e25) => e25(this.sliderWidth));
    }
    setupDraggable() {
      let e24 = this, n3 = rt2.create(this.track, { type: `x`, inertia: { resistance: 100, minDuration: 0.2, maxDuration: 1.5, overshootTolerance: 0.2 }, bounds: { get minX() {
        return -((e24.itemCount - 1) * (e24.sliderWidth + e24.gap));
      }, maxX: 0 }, onDragEnd: function() {
        let t4 = this.x, n4 = e24.sliderWidth + e24.gap, r3 = Math.round(-t4 / n4);
        r3 = Math.max(0, Math.min(r3, e24.itemCount - 1)), e24.snapToIndex(r3), e24.notifyIndexChange(r3);
      } });
      this.draggable = n3[0];
    }
    snapToIndex(t4) {
      this.activeIndex = t4;
      let n3 = -(t4 * (this.sliderWidth + this.gap));
      ci.to(this.track, { x: n3, duration: 0.7, ease: `power3.out`, overwrite: true });
    }
    onIndexChange(e24) {
      this.onIndexChangeCallbacks.push(e24);
    }
    onWidthChange(e24) {
      this.onWidthChangeCallbacks.push(e24);
    }
    notifyIndexChange(e24) {
      this.onIndexChangeCallbacks.forEach((t4) => t4(e24));
    }
  };
})();
