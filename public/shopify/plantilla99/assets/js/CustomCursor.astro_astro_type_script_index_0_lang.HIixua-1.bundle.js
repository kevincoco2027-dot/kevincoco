...
(() => {
  ...
  // public/shopify/plantilla99/assets/js/CustomCursor.astro_astro_type_script_index_0_lang.HIixua-1.js
  var t2 = () => {
    document.querySelectorAll(`[data-custom-cursor-wrapper]`).forEach((t3) => {
      let n2 = t3.parentElement;
      if (!n2 || n2._cursorInitialized) return;
      n2._cursorInitialized = true;
      let r2 = t3.querySelector(`[data-cursor]`);
      if (!r2) return;
      ci.set(r2, { xPercent: -50, yPercent: -50, scale: 0, opacity: 0 });
      let i2 = ci.quickTo(r2, `x`, { duration: 0.35, ease: `power2.out` }), a2 = ci.quickTo(r2, `y`, { duration: 0.35, ease: `power2.out` }), o2 = 0, s2 = 0, c2 = false, l2 = (e15, t4) => {
        let r3 = n2.getBoundingClientRect();
        return e15 >= r3.left && e15 <= r3.right && t4 >= r3.top && t4 <= r3.bottom;
      }, u2 = (t4) => {
        c2 || (c2 = true, n2.style.cursor = `none`, o2 = t4.clientX, s2 = t4.clientY, f2(true), ci.to(r2, { scale: 1, opacity: 1, duration: 0.3, ease: `back.out(1.7)` }));
      }, d2 = () => {
        c2 && (c2 = false, n2.style.cursor = ``, ci.to(r2, { scale: 0, opacity: 0, duration: 0.2, ease: `power2.in` }));
      }, f2 = (t4 = false) => {
        let l3 = n2.getBoundingClientRect();
        if (l3.bottom < 0 || l3.top > window.innerHeight) {
          c2 && d2();
          return;
        }
        if (!(o2 >= l3.left - 50 && o2 <= l3.right + 50 && s2 >= l3.top - 50 && s2 <= l3.bottom + 50) && c2) {
          d2();
          return;
        }
        let u3 = l3.width > 0 ? n2.offsetWidth / l3.width : 1, f3 = l3.height > 0 ? n2.offsetHeight / l3.height : 1, p3 = (o2 - l3.left) * u3, m2 = (s2 - l3.top) * f3;
        t4 ? ci.set(r2, { x: p3, y: m2 }) : (i2(p3), a2(m2));
      }, p2 = (e15) => {
        o2 = e15.clientX, s2 = e15.clientY, !c2 && l2(e15.clientX, e15.clientY) ? u2(e15) : c2 && f2();
      };
      n2.addEventListener(`mousemove`, p2), n2.addEventListener(`mouseenter`, u2), n2.addEventListener(`mouseleave`, d2), window.addEventListener(`scroll`, () => {
        c2 && f2();
      }, { passive: true }), window.addEventListener(`mousemove`, p2, { passive: true });
    });
  };
