...
(() => {
  ...
  // public/shopify/plantilla99/assets/js/AntigravityFooter.astro_astro_type_script_index_0_lang.DQIYDjYp.js
  ci.registerPlugin($2), document.addEventListener(`DOMContentLoaded`, () => {
    let t3 = document.querySelector(`[data-antigravity-footer-wrapper]`);
    if (!t3) return;
    let n3 = t3.querySelector(`[data-letter-y]`), r3 = t3.querySelector(`[data-letter-t]`), i3 = ci.timeline({ scrollTrigger: { trigger: t3, start: `top+=30% bottom`, end: `center+=30% bottom`, scrub: true, id: `AntigravityFooterAnimation` } });
    n3 && r3 && (i3.to(n3, { y: -60, ease: `power1.out` }, 0), i3.to(r3, { y: -60, ease: `power1.out` }, 0));
  });
})();
